 ...
 */let ip;const Yo=t=>ip=t,op=Symbol();function lc(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var Bs;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Bs||(Bs={}));function yv(){const t=ff(!0),e=t.run(()=>yt({}));let n=[],r=[];const s=jo({install(i){Yo(s),s._a=i,i.provide(op,s),i.config.globalProperties.$pinia=s,r.forEach(a=>n.push(a)),r=[]},use(i){return!this._a&&!_v?r.push(i):n.push(i),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return s}const ap=()=>{};function bh(t,e,n,r=ap){t.push(e);const s=()=>{const i=t.indexOf(e);i>-1&&(t.splice(i,1),r())};return!n&&pf()&&u_(s),s}function Rr(t,...e){t.slice().forEach(n=>{n(...e)})}const vv=t=>t();function uc(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,r)=>t.set(r,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const r=e[n],s=t[n];lc(s)&&lc(r)&&t.hasOwnProperty(n)&&!qe(r)&&!Fn(r)?t[n]=uc(s,r):t[n]=r}return t}const wv=Symbol();function Ev(t){return!lc(t)||!t.hasOwnProperty(wv)}const{assign:Sn}=Object;function Iv(t){return!!(qe(t)&&t.effect)}function Tv(t,e,n,r){const{state:s,actions:i,getters:a}=e,c=n.state.value[t];let l;function h(){c||(n.state.value[t]=s?s():{});const d=V_(n.state.value[t]);return Sn(d,i,Object.keys(a||{}).reduce((g,m)=>(g[m]=jo(me(()=>{Yo(n);const b=n._s.get(t);return a[m].call(b,b)})),g),{}))}return l=cp(t,h,e,n,r,!0),l}function cp(t,e,n={},r,s,i){let a;const c=Sn({actions:{}},n),l={deep:!0};let h,d,g=[],m=[],b;const P=r.state.value[t];!i&&!P&&(r.state.value[t]={}),yt({});let D;function k(_){let y;h=d=!1,typeof _=="function"?(_(r.state.value[t]),y={type:Bs.patchFunction,storeId:t,events:b}):(uc(r.state.value[t],_),y={type:Bs.patchObject,payload:_,storeId:t,events:b});const I=D=Symbol();tl().then(()=>{D===I&&(h=!0)}),d=!0,Rr(g,y,r.state.value[t])}const M=i?function(){const{state:y}=n,I=y?y():{};this.$patch(A=>{Sn(A,I)})}:ap;function F(){a.stop(),g=[],m=[],r._s.delete(t)}function Z(_,y){return function(){Yo(r);const I=Array.from(arguments),A=[],R=[];function w(Ee){A.push(Ee)}function rt(Ee){R.push(Ee)}Rr(m,{args:I,name:_,store:he,after:w,onError:rt});let Ze;try{Ze=y.apply(this&&this.$id===t?this:he,I)}catch(Ee){throw Rr(R,Ee),Ee}return Ze instanceof Promise?Ze.then(Ee=>(Rr(A,Ee),Ee)).catch(Ee=>(Rr(R,Ee),Promise.reject(Ee))):(Rr(A,Ze),Ze)}}const K={_p:r,$id:t,$onAction:bh.bind(null,m),$patch:k,$reset:M,$subscribe(_,y={}){const I=bh(g,_,y.detached,()=>A()),A=a.run(()=>Ls(()=>r.state.value[t],R=>{(y.flush==="sync"?d:h)&&_({storeId:t,type:Bs.direct,events:b},R)},Sn({},l,y)));return I},$dispose:F},he=hi(K);r._s.set(t,he);const T=(r._a&&r._a.runWithContext||vv)(()=>r._e.run(()=>(a=ff()).run(e)));for(const _ in T){const y=T[_];if(qe(y)&&!Iv(y)||Fn(y))i||(P&&Ev(y)&&(qe(y)?y.value=P[_]:uc(y,P[_])),r.state.value[t][_]=y);else if(typeof y=="function"){const I=Z(_,y);T[_]=I,c.actions[_]=y}}return Sn(he,T),Sn(be(he),T),Object.defineProperty(he,"$state",{get:()=>r.state.value[t],set:_=>{k(y=>{Sn(y,_)})}}),r._p.forEach(_=>{Sn(he,a.run(()=>_({store:he,app:r._a,pinia:r,options:c})))}),P&&i&&n.hydrate&&n.hydrate(he.$state,P),h=!0,d=!0,he}function Jo(t,e,n){let r,s;const i=typeof e=="function";typeof t=="string"?(r=t,s=i?n:e):(s=t,r=t.id);function a(c,l){const h=yy();return c=c||(h?Qt(op,null):null),c&&Yo(c),c=ip,c._s.has(r)||(i?cp(r,e,s,c):Tv(r,s,c)),c._s.get(r)}return a.$id=r,a}function Av(t){return typeof t=="object"&&t!==null}function Rh(t,e){return t=Av(t)?t:Object.create(null),new Proxy(t,{get(n,r,s){return r==="key"?Reflect.get(n,r,s):Reflect.get(n,r,s)||Reflect.get(e,r,s)}})}function bv(t,e){return e.reduce((n,r)=>n==null?void 0:n[r],t)}function Rv(t,e,n){return e.slice(0,-1).reduce((r,s)=>/^(__proto__)$/.test(s)?{}:r[s]=r[s]||{},t)[e[e.length-1]]=n,t}function Sv(t,e){return e.reduce((n,r)=>{const s=r.split(".");return Rv(n,s,bv(t,s))},{})}function Cv(t,e){return n=>{var r;try{const{storage:s=localStorage,beforeRestore:i=void 0,afterRestore:a=void 0,serializer:c={serialize:JSON.stringify,deserialize:JSON.parse},key:l=e.$id,paths:h=null,debug:d=!1}=n;return{storage:s,beforeRestore:i,afterRestore:a,serializer:c,key:((r=t.key)!=null?r:g=>g)(typeof l=="string"?l:l(e.$id)),paths:h,debug:d}}catch(s){return n.debug&&console.error("[pinia-plugin-persistedstate]",s),null}}}function Sh(t,{storage:e,serializer:n,key:r,debug:s}){try{const i=e==null?void 0:e.getItem(r);i&&t.$patch(n==null?void 0:n.deserialize(i))}catch(i){s&&console.error("[pinia-plugin-persistedstate]",i)}}function Ch(t,{storage:e,serializer:n,key:r,paths:s,debug:i}){try{const a=Array.isArray(s)?Sv(t,s):t;e.setItem(r,n.serialize(a))}catch(a){i&&console.error("[pinia-plugin-persistedstate]",a)}}function Pv(t={}){return e=>{const{auto:n=!1}=t,{options:{persist:r=n},store:s,pinia:i}=e;if(!r)return;if(!(s.$id in i.state.value)){const c=i._s.get(s.$id.replace("__hot:",""));c&&Promise.resolve().then(()=>c.$persist());return}const a=(Array.isArray(r)?r.map(c=>Rh(c,t)):[Rh(r,t)]).map(Cv(t,s)).filter(Boolean);s.$persist=()=>{a.forEach(c=>{Ch(s.$state,c)})},s.$hydrate=({runHooks:c=!0}={})=>{a.forEach(l=>{const{beforeRestore:h,afterRestore:d}=l;c&&(h==null||h(e)),Sh(s,l),c&&(d==null||d(e))})},a.forEach(c=>{const{beforeRestore:l,afterRestore:h}=c;l==null||l(e),Sh(s,c),h==null||h(e),s.$subscribe((d,g)=>{Ch(g,c)},{detached:!0})})}}const kv="/webscraper_tl/icon.svg",Dv="MiniCrawler",Nv="0.3",Ph={appName:Dv,version:Nv};/*!
  ...
  */const Sr=typeof window<"u";function Ov(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const Ne=Object.assign;function Ma(t,e){const n={};for(const r in e){const s=e[r];n[r]=$t(s)?s.map(t):t(s)}return n}const $s=()=>{},$t=Array.isArray,xv=/\/$/,Vv=t=>t.replace(xv,"");function La(t,e,n="/"){let r,s={},i="",a="";const c=e.indexOf("#");let l=e.indexOf("?");return c<l&&c>=0&&(l=-1),l>-1&&(r=e.slice(0,l),i=e.slice(l+1,c>-1?c:e.length),s=t(i)),c>-1&&(r=r||e.slice(0,c),a=e.slice(c,e.length)),r=Uv(r??e,n),{fullPath:r+(i&&"?")+i+a,path:r,query:s,hash:a}}function Mv(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function kh(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function Lv(t,e,n){const r=e.matched.length-1,s=n.matched.length-1;return r>-1&&r===s&&Wr(e.matched[r],n.matched[s])&&lp(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Wr(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function lp(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!Fv(t[n],e[n]))return!1;return!0}function Fv(t,e){return $t(t)?Dh(t,e):$t(e)?Dh(e,t):t===e}function Dh(t,e){return $t(e)?t.length===e.length&&t.every((n,r)=>n===e[r]):t.length===1&&t[0]===e}function Uv(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),r=t.split("/"),s=r[r.length-1];(s===".."||s===".")&&r.push("");let i=n.length-1,a,c;for(a=0;a<r.length;a++)if(c=r[a],c!==".")if(c==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+r.slice(a-(a===r.length?1:0)).join("/")}var ti;(function(t){t.pop="pop",t.push="push"})(ti||(ti={}));var js;(function(t){t.back="back",t.forward="forward",t.unknown=""})(js||(js={}));function Bv(t){if(!t)if(Sr){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),Vv(t)}const $v=/^[^#]+#/;function jv(t,e){return t.replace($v,"#")+e}function qv(t,e){const n=document.documentElement.getBoundingClientRect(),r=t.getBoundingClientRect();return{behavior:e.behavior,left:r.left-n.left-(e.left||0),top:r.top-n.top-(e.top||0)}}const Xo=()=>({left:window.pageXOffset,top:window.pageYOffset});function zv(t){let e;if("el"in t){const n=t.el,r=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;e=qv(s,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function Nh(t,e){return(history.state?history.state.position-e:-1)+t}const hc=new Map;function Hv(t,e){hc.set(t,e)}function Kv(t){const e=hc.get(t);return hc.delete(t),e}let Wv=()=>location.protocol+"//"+location.host;function up(t,e){const{pathname:n,search:r,hash:s}=e,i=t.indexOf("#");if(i>-1){let c=s.includes(t.slice(i))?t.slice(i).length:1,l=s.slice(c);return l[0]!=="/"&&(l="/"+l),kh(l,"")}return kh(n,t)+r+s}function Gv(t,e,n,r){let s=[],i=[],a=null;const c=({state:m})=>{const b=up(t,location),P=n.value,D=e.value;let k=0;if(m){if(n.value=b,e.value=m,a&&a===P){a=null;return}k=D?m.position-D.position:0}else r(b);s.forEach(M=>{M(n.value,P,{delta:k,type:ti.pop,direction:k?k>0?js.forward:js.back:js.unknown})})};function l(){a=n.value}function h(m){s.push(m);const b=()=>{const P=s.indexOf(m);P>-1&&s.splice(P,1)};return i.push(b),b}function d(){const{history:m}=window;m.state&&m.replaceState(Ne({},m.state,{scroll:Xo()}),"")}function g(){for(const m of i)m();i=[],window.removeEventListener("popstate",c),window.removeEventListener("beforeunload",d)}return window.addEventListener("popstate",c),window.addEventListener("beforeunload",d,{passive:!0}),{pauseListeners:l,listen:h,destroy:g}}function Oh(t,e,n,r=!1,s=!1){return{back:t,current:e,forward:n,replaced:r,position:window.history.length,scroll:s?Xo():null}}function Qv(t){const{history:e,location:n}=window,r={value:up(t,n)},s={value:e.state};s.value||i(r.value,{back:null,current:r.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(l,h,d){const g=t.indexOf("#"),m=g>-1?(n.host&&document.querySelector("base")?t:t.slice(g))+l:Wv()+t+l;try{e[d?"replaceState":"pushState"](h,"",m),s.value=h}catch(b){console.error(b),n[d?"replace":"assign"](m)}}function a(l,h){const d=Ne({},e.state,Oh(s.value.back,l,s.value.forward,!0),h,{position:s.value.position});i(l,d,!0),r.value=l}function c(l,h){const d=Ne({},s.value,e.state,{forward:l,scroll:Xo()});i(d.current,d,!0);const g=Ne({},Oh(r.value,l,null),{position:d.position+1},h);i(l,g,!1),r.value=l}return{location:r,state:s,push:c,replace:a}}function Yv(t){t=Bv(t);const e=Qv(t),n=Gv(t,e.state,e.location,e.replace);function r(i,a=!0){a||n.pauseListeners(),history.go(i)}const s=Ne({location:"",base:t,go:r,createHref:jv.bind(null,t)},e,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>e.state.value}),s}function Jv(t){return typeof t=="string"||t&&typeof t=="object"}function hp(t){return typeof t=="string"||typeof t=="symbol"}const bn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},dp=Symbol("");var xh;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(xh||(xh={}));function Gr(t,e){return Ne(new Error,{type:t,[dp]:!0},e)}function sn(t,e){return t instanceof Error&&dp in t&&(e==null||!!(t.type&e))}const Vh="[^/]+?",Xv={sensitive:!1,strict:!1,start:!0,end:!0},Zv=/[.+*?^${}()[\]/\\]/g;function e0(t,e){const n=Ne({},Xv,e),r=[];let s=n.start?"^":"";const i=[];for(const h of t){const d=h.length?[]:[90];n.strict&&!h.length&&(s+="/");for(let g=0;g<h.length;g++){const m=h[g];let b=40+(n.sensitive?.25:0);if(m.type===0)g||(s+="/"),s+=m.value.replace(Zv,"\\$&"),b+=40;else if(m.type===1){const{value:P,repeatable:D,optional:k,regexp:M}=m;i.push({name:P,repeatable:D,optional:k});const F=M||Vh;if(F!==Vh){b+=10;try{new RegExp(`(${F})`)}catch(K){throw new Error(`Invalid custom RegExp for param "${P}" (${F}): `+K.message)}}let Z=D?`((?:${F})(?:/(?:${F}))*)`:`(${F})`;g||(Z=k&&h.length<2?`(?:/${Z})`:"/"+Z),k&&(Z+="?"),s+=Z,b+=20,k&&(b+=-8),D&&(b+=-20),F===".*"&&(b+=-50)}d.push(b)}r.push(d)}if(n.strict&&n.end){const h=r.length-1;r[h][r[h].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&(s+="(?:/|$)");const a=new RegExp(s,n.sensitive?"":"i");function c(h){const d=h.match(a),g={};if(!d)return null;for(let m=1;m<d.length;m++){const b=d[m]||"",P=i[m-1];g[P.name]=b&&P.repeatable?b.split("/"):b}return g}function l(h){let d="",g=!1;for(const m of t){(!g||!d.endsWith("/"))&&(d+="/"),g=!1;for(const b of m)if(b.type===0)d+=b.value;else if(b.type===1){const{value:P,repeatable:D,optional:k}=b,M=P in h?h[P]:"";if($t(M)&&!D)throw new Error(`Provided param "${P}" is an array but it is not repeatable (* or + modifiers)`);const F=$t(M)?M.join("/"):M;if(!F)if(k)m.length<2&&(d.endsWith("/")?d=d.slice(0,-1):g=!0);else throw new Error(`Missing required param "${P}"`);d+=F}}return d||"/"}return{re:a,score:r,keys:i,parse:c,stringify:l}}function t0(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=e[n]-t[n];if(r)return r;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function n0(t,e){let n=0;const r=t.score,s=e.score;for(;n<r.length&&n<s.length;){const i=t0(r[n],s[n]);if(i)return i;n++}if(Math.abs(s.length-r.length)===1){if(Mh(r))return 1;if(Mh(s))return-1}return s.length-r.length}function Mh(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const r0={type:0,value:""},s0=/[a-zA-Z0-9_]/;function i0(t){if(!t)return[[]];if(t==="/")return[[r0]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(b){throw new Error(`ERR (${n})/"${h}": ${b}`)}let n=0,r=n;const s=[];let i;function a(){i&&s.push(i),i=[]}let c=0,l,h="",d="";function g(){h&&(n===0?i.push({type:0,value:h}):n===1||n===2||n===3?(i.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${h}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:h,regexp:d,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),h="")}function m(){h+=l}for(;c<t.length;){if(l=t[c++],l==="\\"&&n!==2){r=n,n=4;continue}switch(n){case 0:l==="/"?(h&&g(),a()):l===":"?(g(),n=1):m();break;case 4:m(),n=r;break;case 1:l==="("?n=2:s0.test(l)?m():(g(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&c--);break;case 2:l===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+l:n=3:d+=l;break;case 3:g(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&c--,d="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${h}"`),g(),a(),s}function o0(t,e,n){const r=e0(i0(t.path),n),s=Ne(r,{record:t,parent:e,children:[],alias:[]});return e&&!s.record.aliasOf==!e.record.aliasOf&&e.children.push(s),s}function a0(t,e){const n=[],r=new Map;e=Uh({strict:!1,end:!0,sensitive:!1},e);function s(d){return r.get(d)}function i(d,g,m){const b=!m,P=c0(d);P.aliasOf=m&&m.record;const D=Uh(e,d),k=[P];if("alias"in d){const Z=typeof d.alias=="string"?[d.alias]:d.alias;for(const K of Z)k.push(Ne({},P,{components:m?m.record.components:P.components,path:K,aliasOf:m?m.record:P}))}let M,F;for(const Z of k){const{path:K}=Z;if(g&&K[0]!=="/"){const he=g.record.path,ge=he[he.length-1]==="/"?"":"/";Z.path=g.record.path+(K&&ge+K)}if(M=o0(Z,g,D),m?m.alias.push(M):(F=F||M,F!==M&&F.alias.push(M),b&&d.name&&!Fh(M)&&a(d.name)),P.children){const he=P.children;for(let ge=0;ge<he.length;ge++)i(he[ge],M,m&&m.children[ge])}m=m||M,(M.record.components&&Object.keys(M.record.components).length||M.record.name||M.record.redirect)&&l(M)}return F?()=>{a(F)}:$s}function a(d){if(hp(d)){const g=r.get(d);g&&(r.delete(d),n.splice(n.indexOf(g),1),g.children.forEach(a),g.alias.forEach(a))}else{const g=n.indexOf(d);g>-1&&(n.splice(g,1),d.record.name&&r.delete(d.record.name),d.children.forEach(a),d.alias.forEach(a))}}function c(){return n}function l(d){let g=0;for(;g<n.length&&n0(d,n[g])>=0&&(d.record.path!==n[g].record.path||!fp(d,n[g]));)g++;n.splice(g,0,d),d.record.name&&!Fh(d)&&r.set(d.record.name,d)}function h(d,g){let m,b={},P,D;if("name"in d&&d.name){if(m=r.get(d.name),!m)throw Gr(1,{location:d});D=m.record.name,b=Ne(Lh(g.params,m.keys.filter(F=>!F.optional).map(F=>F.name)),d.params&&Lh(d.params,m.keys.map(F=>F.name))),P=m.stringify(b)}else if("path"in d)P=d.path,m=n.find(F=>F.re.test(P)),m&&(b=m.parse(P),D=m.record.name);else{if(m=g.name?r.get(g.name):n.find(F=>F.re.test(g.path)),!m)throw Gr(1,{location:d,currentLocation:g});D=m.record.name,b=Ne({},g.params,d.params),P=m.stringify(b)}const k=[];let M=m;for(;M;)k.unshift(M.record),M=M.parent;return{name:D,path:P,params:b,matched:k,meta:u0(k)}}return t.forEach(d=>i(d)),{addRoute:i,resolve:h,removeRoute:a,getRoutes:c,getRecordMatcher:s}}function Lh(t,e){const n={};for(const r of e)r in t&&(n[r]=t[r]);return n}function c0(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:l0(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function l0(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const r in t.components)e[r]=typeof n=="object"?n[r]:n;return e}function Fh(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function u0(t){return t.reduce((e,n)=>Ne(e,n.meta),{})}function Uh(t,e){const n={};for(const r in t)n[r]=r in e?e[r]:t[r];return n}function fp(t,e){return e.children.some(n=>n===t||fp(t,n))}const pp=/#/g,h0=/&/g,d0=/\//g,f0=/=/g,p0=/\?/g,gp=/\+/g,g0=/%5B/g,m0=/%5D/g,mp=/%5E/g,_0=/%60/g,_p=/%7B/g,y0=/%7C/g,yp=/%7D/g,v0=/%20/g;function cl(t){return encodeURI(""+t).replace(y0,"|").replace(g0,"[").replace(m0,"]")}function w0(t){return cl(t).replace(_p,"{").replace(yp,"}").replace(mp,"^")}function dc(t){return cl(t).replace(gp,"%2B").replace(v0,"+").replace(pp,"%23").replace(h0,"%26").replace(_0,"`").replace(_p,"{").replace(yp,"}").replace(mp,"^")}function E0(t){return dc(t).replace(f0,"%3D")}function I0(t){return cl(t).replace(pp,"%23").replace(p0,"%3F")}function T0(t){return t==null?"":I0(t).replace(d0,"%2F")}function bo(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function A0(t){const e={};if(t===""||t==="?")return e;const r=(t[0]==="?"?t.slice(1):t).split("&");for(let s=0;s<r.length;++s){const i=r[s].replace(gp," "),a=i.indexOf("="),c=bo(a<0?i:i.slice(0,a)),l=a<0?null:bo(i.slice(a+1));if(c in e){let h=e[c];$t(h)||(h=e[c]=[h]),h.push(l)}else e[c]=l}return e}function Bh(t){let e="";for(let n in t){const r=t[n];if(n=E0(n),r==null){r!==void 0&&(e+=(e.length?"&":"")+n);continue}($t(r)?r.map(i=>i&&dc(i)):[r&&dc(r)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function b0(t){const e={};for(const n in t){const r=t[n];r!==void 0&&(e[n]=$t(r)?r.map(s=>s==null?null:""+s):r==null?r:""+r)}return e}const R0=Symbol(""),$h=Symbol(""),ll=Symbol(""),vp=Symbol(""),fc=Symbol("");function ks(){let t=[];function e(r){return t.push(r),()=>{const s=t.indexOf(r);s>-1&&t.splice(s,1)}}function n(){t=[]}return{add:e,list:()=>t.slice(),reset:n}}function Pn(t,e,n,r,s){const i=r&&(r.enterCallbacks[s]=r.enterCallbacks[s]||[]);return()=>new Promise((a,c)=>{const l=g=>{g===!1?c(Gr(4,{from:n,to:e})):g instanceof Error?c(g):Jv(g)?c(Gr(2,{from:e,to:g})):(i&&r.enterCallbacks[s]===i&&typeof g=="function"&&i.push(g),a())},h=t.call(r&&r.instances[s],e,n,l);let d=Promise.resolve(h);t.length<3&&(d=d.then(l)),d.catch(g=>c(g))})}function Fa(t,e,n,r){const s=[];for(const i of t)for(const a in i.components){let c=i.components[a];if(!(e!=="beforeRouteEnter"&&!i.instances[a]))if(S0(c)){const h=(c.__vccOpts||c)[e];h&&s.push(Pn(h,n,r,i,a))}else{let l=c();s.push(()=>l.then(h=>{if(!h)return Promise.reject(new Error(`Couldn't resolve component "${a}" at "${i.path}"`));const d=Ov(h)?h.default:h;i.components[a]=d;const m=(d.__vccOpts||d)[e];return m&&Pn(m,n,r,i,a)()}))}}return s}function S0(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function jh(t){const e=Qt(ll),n=Qt(vp),r=me(()=>e.resolve(Oe(t.to))),s=me(()=>{const{matched:l}=r.value,{length:h}=l,d=l[h-1],g=n.matched;if(!d||!g.length)return-1;const m=g.findIndex(Wr.bind(null,d));if(m>-1)return m;const b=qh(l[h-2]);return h>1&&qh(d)===b&&g[g.length-1].path!==b?g.findIndex(Wr.bind(null,l[h-2])):m}),i=me(()=>s.value>-1&&k0(n.params,r.value.params)),a=me(()=>s.value>-1&&s.value===n.matched.length-1&&lp(n.params,r.value.params));function c(l={}){return P0(l)?e[Oe(t.replace)?"replace":"push"](Oe(t.to)).catch($s):Promise.resolve()}return{route:r,href:me(()=>r.value.href),isActive:i,isExactActive:a,navigate:c}}const C0=He({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:jh,setup(t,{slots:e}){const n=hi(jh(t)),{options:r}=Qt(ll),s=me(()=>({[zh(t.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[zh(t.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&e.default(n);return t.custom?i:rp("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},i)}}}),co=C0;function P0(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function k0(t,e){for(const n in e){const r=e[n],s=t[n];if(typeof r=="string"){if(r!==s)return!1}else if(!$t(s)||s.length!==r.length||r.some((i,a)=>i!==s[a]))return!1}return!0}function qh(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const zh=(t,e,n)=>t??e??n,D0=He({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const r=Qt(fc),s=me(()=>t.route||r.value),i=Qt($h,0),a=me(()=>{let h=Oe(i);const{matched:d}=s.value;let g;for(;(g=d[h])&&!g.components;)h++;return h}),c=me(()=>s.value.matched[a.value]);ro($h,me(()=>a.value+1)),ro(R0,c),ro(fc,s);const l=yt();return Ls(()=>[l.value,c.value,t.name],([h,d,g],[m,b,P])=>{d&&(d.instances[g]=h,b&&b!==d&&h&&h===m&&(d.leaveGuards.size||(d.leaveGuards=b.leaveGuards),d.updateGuards.size||(d.updateGuards=b.updateGuards))),h&&d&&(!b||!Wr(d,b)||!m)&&(d.enterCallbacks[g]||[]).forEach(D=>D(h))},{flush:"post"}),()=>{const h=s.value,d=t.name,g=c.value,m=g&&g.components[d];if(!m)return Hh(n.default,{Component:m,route:h});const b=g.props[d],P=b?b===!0?h.params:typeof b=="function"?b(h):b:null,k=rp(m,Ne({},P,e,{onVnodeUnmounted:M=>{M.component.isUnmounted&&(g.instances[d]=null)},ref:l}));return Hh(n.default,{Component:k,route:h})||k}}});function Hh(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const wp=D0;function N0(t){const e=a0(t.routes,t),n=t.parseQuery||A0,r=t.stringifyQuery||Bh,s=t.history,i=ks(),a=ks(),c=ks(),l=N_(bn);let h=bn;Sr&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Ma.bind(null,x=>""+x),g=Ma.bind(null,T0),m=Ma.bind(null,bo);function b(x,G){let H,ee;return hp(x)?(H=e.getRecordMatcher(x),ee=G):ee=x,e.addRoute(ee,H)}function P(x){const G=e.getRecordMatcher(x);G&&e.removeRoute(G)}function D(){return e.getRoutes().map(x=>x.record)}function k(x){return!!e.getRecordMatcher(x)}function M(x,G){if(G=Ne({},G||l.value),typeof x=="string"){const C=La(n,x,G.path),O=e.resolve({path:C.path},G),V=s.createHref(C.fullPath);return Ne(C,O,{params:m(O.params),hash:bo(C.hash),redirectedFrom:void 0,href:V})}let H;if("path"in x)H=Ne({},x,{path:La(n,x.path,G.path).path});else{const C=Ne({},x.params);for(const O in C)C[O]==null&&delete C[O];H=Ne({},x,{params:g(C)}),G.params=g(G.params)}const ee=e.resolve(H,G),ye=x.hash||"";ee.params=d(m(ee.params));const v=Mv(r,Ne({},x,{hash:w0(ye),path:ee.path})),E=s.createHref(v);return Ne({fullPath:v,hash:ye,query:r===Bh?b0(x.query):x.query||{}},ee,{redirectedFrom:void 0,href:E})}function F(x){return typeof x=="string"?La(n,x,l.value.path):Ne({},x)}function Z(x,G){if(h!==x)return Gr(8,{from:G,to:x})}function K(x){return T(x)}function he(x){return K(Ne(F(x),{replace:!0}))}function ge(x){const G=x.matched[x.matched.length-1];if(G&&G.redirect){const{redirect:H}=G;let ee=typeof H=="function"?H(x):H;return typeof ee=="string"&&(ee=ee.includes("?")||ee.includes("#")?ee=F(ee):{path:ee},ee.params={}),Ne({query:x.query,hash:x.hash,params:"path"in ee?{}:x.params},ee)}}function T(x,G){const H=h=M(x),ee=l.value,ye=x.state,v=x.force,E=x.replace===!0,C=ge(H);if(C)return T(Ne(F(C),{state:typeof C=="object"?Ne({},ye,C.state):ye,force:v,replace:E}),G||H);const O=H;O.redirectedFrom=G;let V;return!v&&Lv(r,ee,H)&&(V=Gr(16,{to:O,from:ee}),Nt(ee,ee,!0,!1)),(V?Promise.resolve(V):I(O,ee)).catch(L=>sn(L)?sn(L,2)?L:xt(L):_e(L,O,ee)).then(L=>{if(L){if(sn(L,2))return T(Ne({replace:E},F(L.to),{state:typeof L.to=="object"?Ne({},ye,L.to.state):ye,force:v}),G||O)}else L=R(O,ee,!0,E,ye);return A(O,ee,L),L})}function _(x,G){const H=Z(x,G);return H?Promise.reject(H):Promise.resolve()}function y(x){const G=wn.values().next().value;return G&&typeof G.runWithContext=="function"?G.runWithContext(x):x()}function I(x,G){let H;const[ee,ye,v]=O0(x,G);H=Fa(ee.reverse(),"beforeRouteLeave",x,G);for(const C of ee)C.leaveGuards.forEach(O=>{H.push(Pn(O,x,G))});const E=_.bind(null,x,G);return H.push(E),et(H).then(()=>{H=[];for(const C of i.list())H.push(Pn(C,x,G));return H.push(E),et(H)}).then(()=>{H=Fa(ye,"beforeRouteUpdate",x,G);for(const C of ye)C.updateGuards.forEach(O=>{H.push(Pn(O,x,G))});return H.push(E),et(H)}).then(()=>{H=[];for(const C of v)if(C.beforeEnter)if($t(C.beforeEnter))for(const O of C.beforeEnter)H.push(Pn(O,x,G));else H.push(Pn(C.beforeEnter,x,G));return H.push(E),et(H)}).then(()=>(x.matched.forEach(C=>C.enterCallbacks={}),H=Fa(v,"beforeRouteEnter",x,G),H.push(E),et(H))).then(()=>{H=[];for(const C of a.list())H.push(Pn(C,x,G));return H.push(E),et(H)}).catch(C=>sn(C,8)?C:Promise.reject(C))}function A(x,G,H){c.list().forEach(ee=>y(()=>ee(x,G,H)))}function R(x,G,H,ee,ye){const v=Z(x,G);if(v)return v;const E=G===bn,C=Sr?history.state:{};H&&(ee||E?s.replace(x.fullPath,Ne({scroll:E&&C&&C.scroll},ye)):s.push(x.fullPath,ye)),l.value=x,Nt(x,G,H,E),xt()}let w;function rt(){w||(w=s.listen((x,G,H)=>{if(!qt.listening)return;const ee=M(x),ye=ge(ee);if(ye){T(Ne(ye,{replace:!0}),ee).catch($s);return}h=ee;const v=l.value;Sr&&Hv(Nh(v.fullPath,H.delta),Xo()),I(ee,v).catch(E=>sn(E,12)?E:sn(E,2)?(T(E.to,ee).then(C=>{sn(C,20)&&!H.delta&&H.type===ti.pop&&s.go(-1,!1)}).catch($s),Promise.reject()):(H.delta&&s.go(-H.delta,!1),_e(E,ee,v))).then(E=>{E=E||R(ee,v,!1),E&&(H.delta&&!sn(E,8)?s.go(-H.delta,!1):H.type===ti.pop&&sn(E,20)&&s.go(-1,!1)),A(ee,v,E)}).catch($s)}))}let Ze=ks(),Ee=ks(),Ie;function _e(x,G,H){xt(x);const ee=Ee.list();return ee.length?ee.forEach(ye=>ye(x,G,H)):console.error(x),Promise.reject(x)}function Pt(){return Ie&&l.value!==bn?Promise.resolve():new Promise((x,G)=>{Ze.add([x,G])})}function xt(x){return Ie||(Ie=!x,rt(),Ze.list().forEach(([G,H])=>x?H(x):G()),Ze.reset()),x}function Nt(x,G,H,ee){const{scrollBehavior:ye}=t;if(!Sr||!ye)return Promise.resolve();const v=!H&&Kv(Nh(x.fullPath,0))||(ee||!H)&&history.state&&history.state.scroll||null;return tl().then(()=>ye(x,G,v)).then(E=>E&&zv(E)).catch(E=>_e(E,x,G))}const Ue=x=>s.go(x);let Be;const wn=new Set,qt={currentRoute:l,listening:!0,addRoute:b,removeRoute:P,hasRoute:k,getRoutes:D,resolve:M,options:t,push:K,replace:he,go:Ue,back:()=>Ue(-1),forward:()=>Ue(1),beforeEach:i.add,beforeResolve:a.add,afterEach:c.add,onError:Ee.add,isReady:Pt,install(x){const G=this;x.component("RouterLink",co),x.component("RouterView",wp),x.config.globalProperties.$router=G,Object.defineProperty(x.config.globalProperties,"$route",{enumerable:!0,get:()=>Oe(l)}),Sr&&!Be&&l.value===bn&&(Be=!0,K(s.location).catch(ye=>{}));const H={};for(const ye in bn)Object.defineProperty(H,ye,{get:()=>l.value[ye],enumerable:!0});x.provide(ll,G),x.provide(vp,bf(H)),x.provide(fc,l);const ee=x.unmount;wn.add(x),x.unmount=function(){wn.delete(x),wn.size<1&&(h=bn,w&&w(),w=null,l.value=bn,Be=!1,Ie=!1),ee()}}};function et(x){return x.reduce((G,H)=>G.then(()=>y(H)),Promise.resolve())}return qt}function O0(t,e){const n=[],r=[],s=[],i=Math.max(e.matched.length,t.matched.length);for(let a=0;a<i;a++){const c=e.matched[a];c&&(t.matched.find(h=>Wr(h,c))?r.push(c):n.push(c));const l=t.matched[a];l&&(e.matched.find(h=>Wr(h,l))||s.push(l))}return[n,r,s]}const x0=t=>(di("data-v-2bb0cbed"),t=t(),fi(),t),V0={class:"headerClass"},M0={class:"headerNav"},L0={class:"headerIconTitle"},F0=x0(()=>Q("img",{src:kv,type:"image/svg+xml",alt:"icon"},null,-1)),U0={class:"appView"},B0=He({__name:"App",setup(t){return(e,n)=>(ce(),De(Ye,null,[Q("header",V0,[Q("nav",M0,[Ce(Oe(co),{to:"/"},{default:to(()=>[oo("HOME")]),_:1}),Ce(Oe(co),{to:"/about"},{default:to(()=>[oo("ABOUT")]),_:1}),Ce(Oe(co),{to:"/contact"},{default:to(()=>[oo("CONTACT")]),_:1})]),Q("div",L0,[F0,Q("p",null,wt(Oe(Ph).appName)+" v"+wt(Oe(Ph).version),1)])]),Q("div",U0,[Ce(Oe(wp))])],64))}});const Xe=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},$0=Xe(B0,[["__scopeId","data-v-2bb0cbed"]]),j0="modulepreload",q0=function(t){return"/webscraper_tl/"+t},Kh={},Wh=function(e,n,r){if(!n||n.length===0)return e();const s=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=q0(i),i in Kh)return;Kh[i]=!0;const a=i.endsWith(".css"),c=a?'[rel="stylesheet"]':"";if(!!r)for(let d=s.length-1;d>=0;d--){const g=s[d];if(g.href===i&&(!a||g.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${c}`))return;const h=document.createElement("link");if(h.rel=a?"stylesheet":j0,a||(h.as="script",h.crossOrigin=""),h.href=i,document.head.appendChild(h),a)return new Promise((d,g)=>{h.addEventListener("load",d),h.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e()).catch(i=>{const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=i,window.dispatchEvent(a),!a.defaultPrevented)throw i})},z0={},H0={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512"},K0=Q("g",null,[Q("path",{d:`M449.803,62.197C408.443,20.807,353.85-0.037,299.646-0.006C245.428-0.037,190.85,20.807,149.49,62.197
    ...
    c0.846-0.17,1.17,0.261,1.198,1.015L371.896,281.107z`})],-1),Sw=[Rw];function Cw(t,e){return ce(),De("svg",bw,Sw)}const Pw=Xe(Aw,[["render",Cw]]),kw=He({__name:"NewsButton",props:{width:{type:Number,default:20},height:{type:Number,default:20},iconColor:{type:String,default:Pe.gray2}},emits:["click"],setup(t,{emit:e}){const n=t,r=e;return(s,i)=>(ce(),Ct(Pw,{class:"newsButton",onClick:i[0]||(i[0]=a=>r("click")),width:n.width,height:n.height,fill:n.iconColor},null,8,["width","height","fill"]))}}),Dw={},Nw={version:"1.1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 512 512","xml:space":"preserve"},Ow=Q("g",null,[Q("path",{class:"st0",d:`M268.149,12.153c-7.179,0-14.309,0.309-21.374,0.926l4.905,56.561h0.016
		...
		C511.984,121.313,402.84,12.161,268.149,12.153z`}),Q("path",{class:"st0",d:`M113.041,151.425c3.054-4.532,6.335-8.941,9.794-13.237l-44.144-35.707
		c-4.466,5.522-8.722,11.23-12.717,17.167l47.052,31.777H113.041z`}),Q("path",{class:"st0",d:`M193.762,84.314c9.079-3.938,18.532-7.17,28.292-9.648L208.12,19.607c-12.766,3.232-25.11,7.472-36.966,12.62
		l22.609,52.078V84.314z`}),Q("path",{class:"st0",d:`M167.353,98.412l-30.664-47.807c-10.996,7.041-21.374,14.95-31.054,23.615l37.86,42.318
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lt(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Gw(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(lt())}function Qw(){var t;const e=(t=Zo())===null||t===void 0?void 0:t.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function Yw(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Jw(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Xw(){const t=lt();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function Zw(){return!Qw()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function eE(){try{return typeof indexedDB=="object"}catch{return!1}}function tE(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var i;e(((i=s.error)===null||i===void 0?void 0:i.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const as=tI;function kp(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:_c,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw $n.create("bad-app-name",{appName:String(s)});if(n||(n=Rp()),!n)throw $n.create("no-options");const i=Co.get(s);if(i){if(So(n,i.options)&&So(r,i.config))return i;throw $n.create("duplicate-app",{appName:s})}const a=new dE(s);for(const l of yc.values())a.addComponent(l);const c=new iI(n,r,a);return Co.set(s,c),c}function Dp(t=_c){const e=Co.get(t);if(!e&&t===_c&&Rp())return kp();if(!e)throw $n.create("no-app",{appName:t});return e}function jn(t,e,n){var r;let s=(r=nI[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),a=e.match(/\s|\//);if(i||a){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&a&&c.push("and"),a&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),gr.warn(c.join(" "));return}Qr(new pr(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`);for(let p=0;p<o.length;p++){if(F(o[p]))continue;var f=A(o[p]);const S=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const N=u[S]||[];u[S]=N,N.push(f)}T(u,function(p){return p.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Rs(o,u,f){return f&&f.internalChannelParams&&f.internalChannelParams[o]||u}function Du(o){this.Aa=0,this.i=[],this.j=new ys,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Rs("failFast",!1,o),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Rs("baseRetryDelayMs",5e3,o),this.cb=Rs("retryDelaySeedMs",1e4,o),this.Wa=Rs("forwardChannelMaxRetries",2,o),this.wa=Rs("forwardChannelRequestTimeoutMs",2e4,o),this.pa=o&&o.xmlHttpFactory||void 0,this.Xa=o&&o.Tb||void 0,this.Ca=o&&o.useFetchStreams||!1,this.L=void 0,this.J=o&&o.supportsCrossDomainXhr||!1,this.K="",this.h=new du(o&&o.concurrentRequestLimit),this.Da=new zm,this.P=o&&o.fastHandshake||!1,this.O=o&&o.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=o&&o.Rb||!1,o&&o.xa&&this.j.xa(),o&&o.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&o&&o.detectBufferingProxy||!1,this.ja=void 0,o&&o.longPollingTimeout&&0<o.longPollingTimeout&&(this.ja=o.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=Du.prototype,t.la=8,t.G=1,t.connect=function(o,u,f,p){It(0),this.W=o,this.H=u||{},f&&p!==void 0&&(this.H.OSID=f,this.H.OAID=p),this.F=this.X,this.I=Bu(this,null,this.W),Li(this)};function Sa(o){if(Nu(o),o.G==3){var u=o.U++,f=nn(o.I);if(Le(f,"SID",o.K),Le(f,"RID",u),Le(f,"TYPE","terminate"),Ss(o,f),u=new En(o,o.j,u),u.L=2,u.v=Oi(nn(f)),f=!1,c.navigator&&c.navigator.sendBeacon)try{f=c.navigator.sendBeacon(u.v.toString(),"")}catch{}!f&&c.Image&&(new Image().src=u.v,f=!0),f||(u.g=$u(u.j,null),u.g.ea(u.v)),u.F=Date.now(),ki(u)}Uu(o)}function Mi(o){o.g&&(Pa(o),o.g.cancel(),o.g=null)}function Nu(o){Mi(o),o.u&&(c.clearTimeout(o.u),o.u=null),Fi(o),o.h.cancel(),o.s&&(typeof o.s=="number"&&c.clearTimeout(o.s),o.s=null)}function Li(o){if(!fu(o.h)&&!o.s){o.s=!0;var u=o.Ga;Ie||xt(),_e||(Ie(),_e=!0),Pt.add(u,o),o.B=0}}function Qm(o,u){return pu(o.h)>=o.h.j-(o.s?1:0)?!1:o.s?(o.i=u.D.concat(o.i),!0):o.G==1||o.G==2||o.B>=(o.Va?0:o.Wa)?!1:(o.s=_s(m(o.Ga,o,u),Fu(o,o.B)),o.B++,!0)}t.Ga=function(o){if(this.s)if(this.s=null,this.G==1){if(!o){this.U=Math.floor(1e5*Math.random()),o=this.U++;const S=new En(this,this.j,o);let N=this.o;if(this.S&&(N?(N=_(N),I(N,this.S)):N=this.S),this.m!==null||this.O||(S.H=N,N=null),this.P)e:{for(var u=0,f=0;f<this.i.length;f++){t:{var p=this.i[f];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(u+=p,4096<u){u=f;break e}if(u===4096||f===this.i.length-1){u=f+1;break e}}u=1e3}else u=1e3;u=xu(this,S,u),f=nn(this.I),Le(f,"RID",o),Le(f,"CVER",22),this.D&&Le(f,"X-HTTP-Session-Id",this.D),Ss(this,f),N&&(this.O?u="headers="+encodeURIComponent(String(bu(N)))+"&"+u:this.m&&Ra(f,this.m,N)),ba(this.h,S),this.Ua&&Le(f,"TYPE","init"),this.P?(Le(f,"$req",u),Le(f,"SID","null"),S.T=!0,Ea(S,f,null)):Ea(S,f,u),this.G=2}}else this.G==3&&(o?Ou(this,o):this.i.length==0||fu(this.h)||Ou(this))};function Ou(o,u){var f;u?f=u.l:f=o.U++;const p=nn(o.I);Le(p,"SID",o.K),Le(p,"RID",f),Le(p,"AID",o.T),Ss(o,p),o.m&&o.o&&Ra(p,o.m,o.o),f=new En(o,o.j,f,o.B+1),o.m===null&&(f.H=o.o),u&&(o.i=u.D.concat(o.i)),u=xu(o,f,1e3),f.I=Math.round(.5*o.wa)+Math.round(.5*o.wa*Math.random()),ba(o.h,f),Ea(f,p,u)}function Ss(o,u){o.H&&ge(o.H,function(f,p){Le(u,p,f)}),o.l&&_u({},function(f,p){Le(u,p,f)})}function xu(o,u,f){f=Math.min(o.i.length,f);var p=o.l?m(o.l.Na,o.l,o):null;e:{var S=o.i;let N=-1;for(;;){const q=["count="+f];N==-1?0<f?(N=S[0].g,q.push("ofs="+N)):N=0:q.push("ofs="+N);let xe=!0;for(let st=0;st<f;st++){let Se=S[st].g;const ht=S[st].map;if(Se-=N,0>Se)N=Math.max(0,S[st].g-100),xe=!1;else try{Hm(ht,q,"req"+Se+"_")}catch{p&&p(ht)}}if(xe){p=q.join("&");break e}}}return o=o.i.splice(0,f),u.D=o,p}function Vu(o){if(!o.g&&!o.u){o.Y=1;var u=o.Fa;Ie||xt(),_e||(Ie(),_e=!0),Pt.add(u,o),o.v=0}}function Ca(o){return o.g||o.u||3<=o.v?!1:(o.Y++,o.u=_s(m(o.Fa,o),Fu(o,o.v)),o.v++,!0)}t.Fa=function(){if(this.u=null,Mu(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var o=2*this.R;this.j.info("BP detection timer enabled: "+o),this.A=_s(m(this.ab,this),o)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,It(10),Mi(this),Mu(this))};function Pa(o){o.A!=null&&(c.clearTimeout(o.A),o.A=null)}function Mu(o){o.g=new En(o,o.j,"rpc",o.Y),o.m===null&&(o.g.H=o.o),o.g.O=0;var u=nn(o.qa);Le(u,"RID","rpc"),Le(u,"SID",o.K),Le(u,"AID",o.T),Le(u,"CI",o.F?"0":"1"),!o.F&&o.ja&&Le(u,"TO",o.ja),Le(u,"TYPE","xmlhttp"),Ss(o,u),o.m&&o.o&&Ra(u,o.m,o.o),o.L&&(o.g.I=o.L);var f=o.g;o=o.ia,f.L=1,f.v=Oi(nn(u)),f.m=null,f.P=!0,lu(f,o)}t.Za=function(){this.C!=null&&(this.C=null,Mi(this),Ca(this),It(19))};function Fi(o){o.C!=null&&(c.clearTimeout(o.C),o.C=null)}function Lu(o,u){var f=null;if(o.g==u){Fi(o),Pa(o),o.g=null;var p=2}else if(Aa(o.h,u))f=u.D,gu(o.h,u),p=1;else return;if(o.G!=0){if(u.o)if(p==1){f=u.m?u.m.length:0,u=Date.now()-u.F;var S=o.B;p=Si(),ae(p,new iu(p,f)),Li(o)}else Vu(o);else if(S=u.s,S==3||S==0&&0<u.X||!(p==1&&Qm(o,u)||p==2&&Ca(o)))switch(f&&0<f.length&&(u=o.h,u.i=u.i.concat(f)),S){case 1:Zn(o,5);break;case 4:Zn(o,10);break;case 3:Zn(o,6);break;default:Zn(o,2)}}}function Fu(o,u){let f=o.Ta+Math.floor(Math.random()*o.cb);return o.isActive()||(f*=2),f*u}function Zn(o,u){if(o.j.info("Error code "+u),u==2){var f=m(o.fb,o),p=o.Xa;const S=!p;p=new Xn(p||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Di(p,"https"),Oi(p),S?jm(p.toString(),f):qm(p.toString(),f)}else It(2);o.G=0,o.l&&o.l.sa(u),Uu(o),Nu(o)}t.fb=function(o){o?(this.j.info("Successfully pinged google.com"),It(2)):(this.j.info("Failed to ping google.com"),It(1))};function Uu(o){if(o.G=0,o.ka=[],o.l){const u=mu(o.h);(u.length!=0||o.i.length!=0)&&(k(o.ka,u),k(o.ka,o.i),o.h.i.length=0,D(o.i),o.i.length=0),o.l.ra()}}function Bu(o,u,f){var p=f instanceof Xn?nn(f):new Xn(f);if(p.g!="")u&&(p.g=u+"."+p.g),Ni(p,p.s);else{var S=c.location;p=S.protocol,u=u?u+"."+S.hostname:S.hostname,S=+S.port;var N=new Xn(null);p&&Di(N,p),u&&(N.g=u),S&&Ni(N,S),f&&(N.l=f),p=N}return f=o.D,u=o.ya,f&&u&&Le(p,f,u),Le(p,"VER",o.la),Ss(o,p),p}function $u(o,u,f){if(u&&!o.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=o.Ca&&!o.pa?new je(new Ts({eb:f})):new je(o.pa),u.Ha(o.J),u}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function ju(){}t=ju.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Ui(){}Ui.prototype.g=function(o,u){return new kt(o,u)};function kt(o,u){le.call(this),this.g=new Du(u),this.l=o,this.h=u&&u.messageUrlParams||null,o=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(o?o["X-WebChannel-Content-Type"]=u.messageContentType:o={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(o?o["X-WebChannel-Client-Profile"]=u.va:o={"X-WebChannel-Client-Profile":u.va}),this.g.S=o,(o=u&&u.Sb)&&!F(o)&&(this.g.m=o),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!F(u)&&(this.g.D=u,o=this.h,o!==null&&u in o&&(o=this.h,u in o&&delete o[u])),this.j=new Tr(this)}P(kt,le),kt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},kt.prototype.close=function(){Sa(this.g)},kt.prototype.o=function(o){var u=this.g;if(typeof o=="string"){var f={};f.__data__=o,o=f}else this.u&&(f={},f.__data__=bt(o),o=f);u.i.push(new Nm(u.Ya++,o)),u.G==3&&Li(u)},kt.prototype.N=function(){this.g.l=null,delete this.j,Sa(this.g),delete this.g,kt.aa.N.call(this)};function qu(o){_a.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var u=o.__sm__;if(u){e:{for(const f in u){o=f;break e}o=void 0}(this.i=o)&&(o=this.i,u=u!==null&&o in u?u[o]:void 0),this.data=u}else this.data=o}P(qu,_a);function zu(){ya.call(this),this.status=1}P(zu,ya);function Tr(o){this.g=o}P(Tr,ju),Tr.prototype.ua=function(){ae(this.g,"a")},Tr.prototype.ta=function(o){ae(this.g,new qu(o))},Tr.prototype.sa=function(o){ae(this.g,new zu)},Tr.prototype.ra=function(){ae(this.g,"b")},Ui.prototype.createWebChannel=Ui.prototype.g,kt.prototype.send=kt.prototype.o,kt.prototype.open=kt.prototype.m,kt.prototype.close=kt.prototype.close,Bp=function(){return new Ui},Up=function(){return Si()},Fp=Yn,vc={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Ci.NO_ERROR=0,Ci.TIMEOUT=8,Ci.HTTP_ERROR=6,lo=Ci,ou.COMPLETE="complete",Lp=ou,tu.EventType=gs,gs.OPEN="a",gs.CLOSE="b",gs.ERROR="c",gs.MESSAGE="d",le.prototype.listen=le.prototype.K,xs=tu,Mp=Ts,je.prototype.listenOnce=je.prototype.L,je.prototype.getLastError=je.prototype.Ka,je.prototype.getLastErrorCode=je.prototype.Ba,je.prototype.getStatus=je.prototype.Z,je.prototype.getResponseJson=je.prototype.Oa,je.prototype.getResponseText=je.prototype.oa,je.prototype.send=je.prototype.ea,je.prototype.setWithCredentials=je.prototype.Ha,Vp=je}).apply(typeof Wi<"u"?Wi:typeof self<"u"?self:typeof window<"u"?window:{});const sd="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mr=new ul("@firebase/firestore");function Ds(){return mr.logLevel}function X(t,...e){if(mr.logLevel<=ve.DEBUG){const n=e.map(fl);mr.debug(`Firestore (${cs}): ${t}`,...n)}}function pn(t,...e){if(mr.logLevel<=ve.ERROR){const n=e.map(fl);mr.error(`Firestore (${cs}): ${t}`,...n)}}function Yr(t,...e){if(mr.logLevel<=ve.WARN){const n=e.map(fl);mr.warn(`Firestore (${cs}): ${t}`,...n)}}function fl(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $p{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class _I{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(pt.UNAUTHENTICATED))}shutdown(){}}class yI{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class vI{constructor(e){this.t=e,this.currentUser=pt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let r=this.i;const s=l=>this.i!==r?(r=this.i,n(l)):Promise.resolve();let i=new ur;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new ur,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const l=i;e.enqueueRetryable(async()=>{await l.promise,await s(this.currentUser)})},c=l=>{X("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),a()};this.t.onInit(l=>c(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?c(l):(X("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new ur)}},0),a()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(X("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Qe(typeof r.accessToken=="string"),new $p(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return Qe(e===null||typeof e=="string"),new pt(e)}}class wI{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=pt.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class EI{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new wI(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(pt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class II{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class TI{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,n){const r=i=>{i.error!=null&&X("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.R;return this.R=i.token,X("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?n(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{X("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?s(i):X("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(Qe(typeof n.token=="string"),this.R=n.token,new II(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pl(t){if(t.code!==$.FAILED_PRECONDITION||t.message!==kI)throw t;X("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gl{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.ie(r),this.se=r=>n.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}gl.oe=-1;function ea(t){return t==null}function Po(t){return t===0&&1/t==-1/0}function OI(t){return typeof t=="number"&&Number.isInteger(t)&&!Po(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{constructor(e){this.value=e}static empty(){return new Wt({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let r=0;r<e.length-1;++r)if(n=(n.mapValue.fields||{})[e.get(r)],!za(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=qs(n)}setAll(e){let n=_t.emptyPath(),r={},s=[];e.forEach((a,c)=>{if(!n.isImmediateParentOf(c)){const l=this.getFieldsMap(n);this.applyChanges(l,r,s),r={},s=[],n=c.popLast()}a?r[c.lastSegment()]=qs(a):s.push(c.lastSegment())});const i=this.getFieldsMap(n);this.applyChanges(i,r,s)}delete(e){const n=this.field(e.popLast());za(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return en(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=n.mapValue.fields[e.get(r)];za(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},n.mapValue.fields[e.get(r)]=s),n=s}return n.mapValue.fields}applyChanges(e,n,r){_i(n,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new Wt(qs(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ng(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Po(e)?"-0":e}}function rg(t){return{integerValue:""+t}}function nT(t,e){return OI(e)?rg(e):ng(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ra{constructor(){this._=void 0}}function rT(t,e,n){return t instanceof bc?function(s,i){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&ml(i)&&(i=_l(i)),i&&(a.fields.__previous_value__=i),{mapValue:a}}(n,e):t instanceof No?sg(t,e):t instanceof Oo?ig(t,e):function(s,i){const a=iT(s,i),c=gd(a)+gd(s.Pe);return Ec(a)&&Ec(s.Pe)?rg(c):ng(s.serializer,c)}(t,e)}function sT(t,e,n){return t instanceof No?sg(t,e):t instanceof Oo?ig(t,e):n}function iT(t,e){return t instanceof Rc?function(r){return Ec(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class bc extends ra{}class No extends ra{constructor(e){super(),this.elements=e}}function sg(t,e){const n=og(e);for(const r of t.elements)n.some(s=>en(s,r))||n.push(r);return{arrayValue:{values:n}}}class Oo extends ra{constructor(e){super(),this.elements=e}}function ig(t,e){let n=og(e);for(const r of t.elements)n=n.filter(s=>!en(s,r));return{arrayValue:{values:n}}}class Rc extends ra{constructor(e,n){super(),this.serializer=e,this.Pe=n}}function gd(t){return We(t.integerValue||t.doubleValue)}function og(t){return yl(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}function oT(t,e){return t.field.isEqual(e.field)&&function(r,s){return r instanceof No&&s instanceof No||r instanceof Oo&&s instanceof Oo?Jr(r.elements,s.elements,en):r instanceof Rc&&s instanceof Rc?en(r.Pe,s.Pe):r instanceof bc&&s instanceof bc}(t.transform,e.transform)}class hr{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new hr}static exists(e){return new hr(void 0,e)}static updateTime(e){return new hr(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function uo(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class El{}function ag(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new cT(t.key,hr.none()):new Il(t.key,t.data,hr.none());{const n=t.data,r=Wt.empty();let s=new at(_t.comparator);for(let i of e.fields)if(!s.has(i)){let a=n.field(i);a===null&&i.length>1&&(i=i.popLast(),a=n.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new sa(t.key,r,new Vn(s.toArray()),hr.none())}}function aT(t,e,n){t instanceof Il?function(s,i,a){const c=s.value.clone(),l=_d(s.fieldTransforms,i,a.transformResults);c.setAll(l),i.convertToFoundDocument(a.version,c).setHasCommittedMutations()}(t,e,n):t instanceof sa?function(s,i,a){if(!uo(s.precondition,i))return void i.convertToUnknownDocument(a.version);const c=_d(s.fieldTransforms,i,a.transformResults),l=i.data;l.setAll(cg(s)),l.setAll(c),i.convertToFoundDocument(a.version,l).setHasCommittedMutations()}(t,e,n):function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,n)}function Ks(t,e,n,r){return t instanceof Il?function(i,a,c,l){if(!uo(i.precondition,a))return c;const h=i.value.clone(),d=yd(i.fieldTransforms,l,a);return h.setAll(d),a.convertToFoundDocument(a.version,h).setHasLocalMutations(),null}(t,e,n,r):t instanceof sa?function(i,a,c,l){if(!uo(i.precondition,a))return c;const h=yd(i.fieldTransforms,l,a),d=a.data;return d.setAll(cg(i)),d.setAll(h),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(g=>g.field))}(t,e,n,r):function(i,a,c){return uo(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c}(t,e,n)}function md(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&Jr(r,s,(i,a)=>oT(i,a))}(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class Il extends El{constructor(e,n,r,s=[]){super(),this.key=e,this.value=n,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class sa extends El{constructor(e,n,r,s,i=[]){super(),this.key=e,this.data=n,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function cg(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const r=t.data.field(n);e.set(n,r)}}),e}function _d(t,e,n){const r=new Map;Qe(t.length===n.length);for(let s=0;s<n.length;s++){const i=t[s],a=i.transform,c=e.data.field(i.field);r.set(i.field,sT(a,c,n[s]))}return r}function yd(t,e,n){const r=new Map;for(const s of t){const i=s.transform,a=n.data.field(s.field);r.set(s.field,rT(i,a,e))}return r}class cT extends El{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ia{constructor(e,n,r,s,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const s=new Map;return s.set(e,yi.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new ia(ue.min(),s,new ze(ke),Wn(),Ae())}}class yi{constructor(e,n,r,s,i){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new yi(r,n,Ae(),Ae(),Ae())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CT{constructor(e){this.ct=e}}function PT(t){const e=TT({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?Do(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class NT{constructor(){this.changes=new us(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,gt.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const r=this.changes.get(n);return r!==void 0?B.resolve(r):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Al{constructor(){this.Pr=new at(tt.Ir),this.Tr=new at(tt.Er)}isEmpty(){return this.Pr.isEmpty()}addReference(e,n){const r=new tt(e,n);this.Pr=this.Pr.add(r),this.Tr=this.Tr.add(r)}dr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Ar(new tt(e,n))}Rr(e,n){e.forEach(r=>this.removeReference(r,n))}Vr(e){const n=new se(new $e([])),r=new tt(n,e),s=new tt(n,e+1),i=[];return this.Tr.forEachInRange([r,s],a=>{this.Ar(a),i.push(a.key)}),i}mr(){this.Pr.forEach(e=>this.Ar(e))}Ar(e){this.Pr=this.Pr.delete(e),this.Tr=this.Tr.delete(e)}gr(e){const n=new se(new $e([])),r=new tt(n,e),s=new tt(n,e+1);let i=Ae();return this.Tr.forEachInRange([r,s],a=>{i=i.add(a.key)}),i}containsKey(e){const n=new tt(e,0),r=this.Pr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class tt{constructor(e,n){this.key=e,this.pr=n}static Ir(e,n){return se.comparator(e.key,n.key)||ke(e.pr,n.pr)}static Er(e,n){return ke(e.pr,n.pr)||se.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $T{constructor(e,n){this.Br={},this.overlays={},this.kr=new gl(0),this.qr=!1,this.qr=!0,this.referenceDelegate=e(this),this.Qr=new BT(this),this.indexManager=new kT,this.remoteDocumentCache=function(s){return new FT(s)}(r=>this.referenceDelegate.Kr(r)),this.serializer=new CT(n),this.$r=new VT(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.qr=!1,Promise.resolve()}get started(){return this.qr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let n=this.overlays[e.toKey()];return n||(n=new MT,this.overlays[e.toKey()]=n),n}getMutationQueue(e,n){let r=this.Br[e.toKey()];return r||(r=new LT(n,this.referenceDelegate),this.Br[e.toKey()]=r),r}getTargetCache(){return this.Qr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.$r}runTransaction(e,n,r){X("MemoryPersistence","Starting transaction:",e);const s=new jT(this.kr.next());return this.referenceDelegate.Ur(),r(s).next(i=>this.referenceDelegate.Wr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Gr(e,n){return B.or(Object.values(this.Br).map(r=>()=>r.containsKey(e,n)))}}class jT extends DI{constructor(e){super(),this.currentSequenceNumber=e}}class bl{constructor(e){this.persistence=e,this.zr=new Al,this.jr=null}static Hr(e){return new bl(e)}get Jr(){if(this.jr)return this.jr;throw de()}addReference(e,n,r){return this.zr.addReference(r,n),this.Jr.delete(r.toString()),B.resolve()}removeReference(e,n,r){return this.zr.removeReference(r,n),this.Jr.add(r.toString()),B.resolve()}markPotentiallyOrphaned(e,n){return this.Jr.add(n.toString()),B.resolve()}removeTarget(e,n){this.zr.Vr(n.targetId).forEach(s=>this.Jr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,n.targetId).next(s=>{s.forEach(i=>this.Jr.add(i.toString()))}).next(()=>r.removeTargetData(e,n))}Ur(){this.jr=new Set}Wr(e){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return B.forEach(this.Jr,r=>{const s=se.fromPath(r);return this.Yr(e,s).next(i=>{i||n.removeEntry(s,ue.min())})}).next(()=>(this.jr=null,n.apply(e)))}updateLimboDocument(e,n){return this.Yr(e,n).next(r=>{r?this.Jr.delete(n.toString()):this.Jr.add(n.toString())})}Kr(e){return 0}Yr(e,n){return B.or([()=>B.resolve(this.zr.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(e,n),()=>this.persistence.Gr(e,n)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zT{constructor(){this.$i=!1,this.Ui=!1,this.Wi=100,this.Gi=function(){return Zw()?8:NI(lt())>0?6:4}()}initialize(e,n){this.zi=e,this.indexManager=n,this.$i=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.ji(e,n).next(a=>{i.result=a}).next(()=>{if(!i.result)return this.Hi(e,n,s,r).next(a=>{i.result=a})}).next(()=>{if(i.result)return;const a=new qT;return this.Ji(e,n,a).next(c=>{if(i.result=c,this.Ui)return this.Yi(e,n,a,c.size)})}).next(()=>i.result)}Yi(e,n,r,s){return r.documentReadCount<this.Wi?(Ds()<=ve.DEBUG&&X("QueryEngine","SDK will not create cache indexes for query:",Cr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Wi,"documents"),B.resolve()):(Ds()<=ve.DEBUG&&X("QueryEngine","Query:",Cr(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Gi*s?(Ds()<=ve.DEBUG&&X("QueryEngine","The SDK decides to create cache indexes for query:",Cr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Yt(n))):B.resolve())}ji(e,n){if(pd(n))return B.resolve(null);let r=Yt(n);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Do(n,null,"F"),r=Yt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const a=Ae(...i);return this.zi.getDocuments(e,a).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const h=this.Zi(n,c);return this.Xi(n,h,a,l.readTime)?this.ji(e,Do(n,null,"F")):this.es(e,h,n,l)}))})))}Hi(e,n,r,s){return pd(n)||s.isEqual(ue.min())?B.resolve(null):this.zi.getDocuments(e,r).next(i=>{const a=this.Zi(n,i);return this.Xi(n,a,r,s)?B.resolve(null):(Ds()<=ve.DEBUG&&X("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Cr(n)),this.es(e,a,n,SI(s,-1)).next(c=>c))})}Zi(e,n){let r=new at(Zp(e));return n.forEach((s,i)=>{na(e,i)&&(r=r.add(i))}),r}Xi(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Ji(e,n,r){return Ds()<=ve.DEBUG&&X("QueryEngine","Using full collection scan to execute query:",Cr(n)),this.zi.getDocumentsMatchingQuery(e,n,Hn.min(),r)}es(e,n,r,s){return this.zi.getDocumentsMatchingQuery(e,r,s).next(i=>(n.forEach(a=>{i=i.insert(a.key,a)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yi=null;function Ka(){return Yi===null?Yi=function(){return 268435456+Math.round(2147483648*Math.random())}():Yi++,"0x"+Yi.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ft="WebChannelConnection";class tA extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const r=n.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.wo=r+"://"+n.host,this.So=`projects/${s}/databases/${i}`,this.bo=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Do(){return!1}Co(n,r,s,i,a){const c=Ka(),l=this.vo(n,r.toUriEncodedString());X("RestConnection",`Sending RPC '${n}' ${c}:`,l,s);const h={"google-cloud-resource-prefix":this.So,"x-goog-request-params":this.bo};return this.Fo(h,i,a),this.Mo(n,l,h,s).then(d=>(X("RestConnection",`Received RPC '${n}' ${c}: `,d),d),d=>{throw Yr("RestConnection",`RPC '${n}' ${c} failed with error: `,d,"url: ",l,"request:",s),d})}xo(n,r,s,i,a,c){return this.Co(n,r,s,i,a)}Fo(n,r,s){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+cs}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,a)=>n[a]=i),s&&s.headers.forEach((i,a)=>n[a]=i)}vo(n,r){const s=ZT[n];return`${this.wo}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Mo(e,n,r,s){const i=Ka();return new Promise((a,c)=>{const l=new Vp;l.setWithCredentials(!0),l.listenOnce(Lp.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case lo.NO_ERROR:const d=l.getResponseJson();X(ft,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(d)),a(d);break;case lo.TIMEOUT:X(ft,`RPC '${e}' ${i} timed out`),c(new J($.DEADLINE_EXCEEDED,"Request time out"));break;case lo.HTTP_ERROR:const g=l.getStatus();if(X(ft,`RPC '${e}' ${i} failed with status:`,g,"response text:",l.getResponseText()),g>0){let m=l.getResponseJson();Array.isArray(m)&&(m=m[0]);const b=m==null?void 0:m.error;if(b&&b.status&&b.message){const P=function(k){const M=k.toLowerCase().replace(/_/g,"-");return Object.values($).indexOf(M)>=0?M:$.UNKNOWN}(b.status);c(new J(P,b.message))}else c(new J($.UNKNOWN,"Server responded with status "+l.getStatus()))}else c(new J($.UNAVAILABLE,"Connection failed."));break;default:de()}}finally{X(ft,`RPC '${e}' ${i} completed.`)}});const h=JSON.stringify(s);X(ft,`RPC '${e}' ${i} sending request:`,s),l.send(n,"POST",h,r,15)})}Oo(e,n,r){const s=Ka(),i=[this.wo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Bp(),c=Up(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(l.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(l.xmlHttpFactory=new Mp({})),this.Fo(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const d=i.join("");X(ft,`Creating RPC '${e}' stream ${s}: ${d}`,l);const g=a.createWebChannel(d,l);let m=!1,b=!1;const P=new eA({lo:k=>{b?X(ft,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(m||(X(ft,`Opening RPC '${e}' stream ${s} transport.`),g.open(),m=!0),X(ft,`RPC '${e}' stream ${s} sending:`,k),g.send(k))},ho:()=>g.close()}),D=(k,M,F)=>{k.listen(M,Z=>{try{F(Z)}catch(K){setTimeout(()=>{throw K},0)}})};return D(g,xs.EventType.OPEN,()=>{b||(X(ft,`RPC '${e}' stream ${s} transport opened.`),P.mo())}),D(g,xs.EventType.CLOSE,()=>{b||(b=!0,X(ft,`RPC '${e}' stream ${s} transport closed`),P.po())}),D(g,xs.EventType.ERROR,k=>{b||(b=!0,Yr(ft,`RPC '${e}' stream ${s} transport errored:`,k),P.po(new J($.UNAVAILABLE,"The operation could not be completed")))}),D(g,xs.EventType.MESSAGE,k=>{var M;if(!b){const F=k.data[0];Qe(!!F);const Z=F,K=Z.error||((M=Z[0])===null||M===void 0?void 0:M.error);if(K){X(ft,`RPC '${e}' stream ${s} received error:`,K);const he=K.status;let ge=function(y){const I=Ke[y];if(I!==void 0)return lg(I)}(he),T=K.message;ge===void 0&&(ge=$.INTERNAL,T="Unknown error status: "+he+" with message "+K.message),b=!0,P.po(new J(ge,T)),g.close()}else X(ft,`RPC '${e}' stream ${s} received:`,F),P.yo(F)}}),D(c,Fp.STAT_EVENT,k=>{k.stat===vc.PROXY?X(ft,`RPC '${e}' stream ${s} detected buffering proxy`):k.stat===vc.NOPROXY&&X(ft,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{P.fo()},0),P}}function Wa(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oa(t){return new yT(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sA extends class{}{constructor(e,n,r,s){super(),this.authCredentials=e,this.appCheckCredentials=n,this.connection=r,this.serializer=s,this.m_=!1}f_(){if(this.m_)throw new J($.FAILED_PRECONDITION,"The client has already been terminated.")}Co(e,n,r,s){return this.f_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,a])=>this.connection.Co(e,Pc(n,r),s,i,a)).catch(i=>{throw i.name==="FirebaseError"?(i.code===$.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new J($.UNKNOWN,i.toString())})}xo(e,n,r,s,i){return this.f_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([a,c])=>this.connection.xo(e,Pc(n,r),s,a,c,i)).catch(a=>{throw a.name==="FirebaseError"?(a.code===$.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),a):new J($.UNKNOWN,a.toString())})}terminate(){this.m_=!0,this.connection.terminate()}}class iA{constructor(e,n){this.asyncQueue=e,this.onlineStateHandler=n,this.state="Unknown",this.g_=0,this.p_=null,this.y_=!0}w_(){this.g_===0&&(this.S_("Unknown"),this.p_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.p_=null,this.b_("Backend didn't respond within 10 seconds."),this.S_("Offline"),Promise.resolve())))}D_(e){this.state==="Online"?this.S_("Unknown"):(this.g_++,this.g_>=1&&(this.C_(),this.b_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.S_("Offline")))}set(e){this.C_(),this.g_=0,e==="Online"&&(this.y_=!1),this.S_(e)}S_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}b_(e){const n=`Could not reach Cloud Firestore backend. ${e}
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.y_?(pn(n),this.y_=!1):X("OnlineStateTracker",n)}C_(){this.p_!==null&&(this.p_.cancel(),this.p_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oA{constructor(e,n,r,s,i){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.v_=[],this.F_=new Map,this.M_=new Set,this.x_=[],this.O_=i,this.O_.io(a=>{r.enqueueAndForget(async()=>{wi(this)&&(X("RemoteStore","Restarting streams for network reachability change."),await async function(l){const h=Re(l);h.M_.add(4),await vi(h),h.N_.set("Unknown"),h.M_.delete(4),await aa(h)}(this))})}),this.N_=new iA(r,s)}}async function aa(t){if(wi(t))for(const e of t.x_)await e(!0)}async function vi(t){for(const e of t.x_)await e(!1)}function Tg(t,e){const n=Re(t);n.F_.has(e.targetId)||(n.F_.set(e.targetId,e),kl(n)?Pl(n):hs(n).Xo()&&Cl(n,e))}function Sl(t,e){const n=Re(t),r=hs(n);n.F_.delete(e),r.Xo()&&Ag(n,e),n.F_.size===0&&(r.Xo()?r.n_():wi(n)&&n.N_.set("Unknown"))}function Cl(t,e){if(t.L_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(ue.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}hs(t).P_(e)}function Ag(t,e){t.L_.xe(e),hs(t).I_(e)}function Pl(t){t.L_=new pT({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>t.F_.get(e)||null,tt:()=>t.datastore.serializer.databaseId}),hs(t).start(),t.N_.w_()}function kl(t){return wi(t)&&!hs(t).Zo()&&t.F_.size>0}function wi(t){return Re(t).M_.size===0}function bg(t){t.L_=void 0}async function aA(t){t.N_.set("Online")}async function cA(t){t.F_.forEach((e,n)=>{Cl(t,e)})}async function lA(t,e){bg(t),kl(t)?(t.N_.D_(e),Pl(t)):t.N_.set("Unknown")}async function uA(t,e,n){if(t.N_.set("Online"),e instanceof hg&&e.state===2&&e.cause)try{await async function(s,i){const a=i.cause;for(const c of i.targetIds)s.F_.has(c)&&(await s.remoteSyncer.rejectListen(c,a),s.F_.delete(c),s.L_.removeTarget(c))}(t,e)}catch(r){X("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Cd(t,r)}else if(e instanceof ho?t.L_.Ke(e):e instanceof ug?t.L_.He(e):t.L_.We(e),!n.isEqual(ue.min()))try{const r=await Eg(t.localStore);n.compareTo(r)>=0&&await function(i,a){const c=i.L_.rt(a);return c.targetChanges.forEach((l,h)=>{if(l.resumeToken.approximateByteSize()>0){const d=i.F_.get(h);d&&i.F_.set(h,d.withResumeToken(l.resumeToken,a))}}),c.targetMismatches.forEach((l,h)=>{const d=i.F_.get(l);if(!d)return;i.F_.set(l,d.withResumeToken(Et.EMPTY_BYTE_STRING,d.snapshotVersion)),Ag(i,l);const g=new Mn(d.target,l,h,d.sequenceNumber);Cl(i,g)}),i.remoteSyncer.applyRemoteEvent(c)}(t,n)}catch(r){X("RemoteStore","Failed to raise snapshot:",r),await Cd(t,r)}}async function Cd(t,e,n){if(!mi(e))throw e;t.M_.add(1),await vi(t),t.N_.set("Offline"),n||(n=()=>Eg(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{X("RemoteStore","Retrying IndexedDB access"),await n(),t.M_.delete(1),await aa(t)})}async function Pd(t,e){const n=Re(t);n.asyncQueue.verifyOperationInProgress(),X("RemoteStore","RemoteStore received new credentials");const r=wi(n);n.M_.add(3),await vi(n),r&&n.N_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.M_.delete(3),await aa(n)}async function hA(t,e){const n=Re(t);e?(n.M_.delete(2),await aa(n)):e||(n.M_.add(2),await vi(n),n.N_.set("Unknown"))}function hs(t){return t.B_||(t.B_=function(n,r,s){const i=Re(n);return i.f_(),new rA(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{Po:aA.bind(null,t),To:cA.bind(null,t),Ao:lA.bind(null,t),h_:uA.bind(null,t)}),t.x_.push(async e=>{e?(t.B_.t_(),kl(t)?Pl(t):t.N_.set("Unknown")):(await t.B_.stop(),bg(t))})),t.B_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dA{constructor(){this.K_=void 0,this.U_=[]}W_(){return this.U_.some(e=>e.G_())}}class fA{constructor(){this.queries=new us(e=>Xp(e),ta),this.onlineState="Unknown",this.z_=new Set}}async function pA(t,e){const n=Re(t);let r=3;const s=e.query;let i=n.queries.get(s);i?!i.W_()&&e.G_()&&(r=2):(i=new dA,r=e.G_()?0:1);try{switch(r){case 0:i.K_=await n.onListen(s,!0);break;case 1:i.K_=await n.onListen(s,!1);break;case 2:await n.onFirstRemoteStoreListen(s)}}catch(a){const c=Rg(a,`Initialization of query '${Cr(e.query)}' failed`);return void e.onError(c)}n.queries.set(s,i),i.U_.push(e),e.j_(n.onlineState),i.K_&&e.H_(i.K_)&&Nl(n)}async function gA(t,e){const n=Re(t),r=e.query;let s=3;const i=n.queries.get(r);if(i){const a=i.U_.indexOf(e);a>=0&&(i.U_.splice(a,1),i.U_.length===0?s=e.G_()?0:1:!i.W_()&&e.G_()&&(s=2))}switch(s){case 0:return n.queries.delete(r),n.onUnlisten(r,!0);case 1:return n.queries.delete(r),n.onUnlisten(r,!1);case 2:return n.onLastRemoteStoreUnlisten(r);default:return}}function mA(t,e){const n=Re(t);let r=!1;for(const s of e){const i=s.query,a=n.queries.get(i);if(a){for(const c of a.U_)c.H_(s)&&(r=!0);a.K_=s}}r&&Nl(n)}function _A(t,e,n){const r=Re(t),s=r.queries.get(e);if(s)for(const i of s.U_)i.onError(n);r.queries.delete(e)}function Nl(t){t.z_.forEach(e=>{e.next()})}var Dc,Dd;(Dd=Dc||(Dc={})).J_="default",Dd.Cache="cache";class yA{constructor(e,n,r){this.query=e,this.Y_=n,this.Z_=!1,this.X_=null,this.onlineState="Unknown",this.options=r||{}}H_(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new ts(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.Z_?this.ea(e)&&(this.Y_.next(e),n=!0):this.ta(e,this.onlineState)&&(this.na(e),n=!0),this.X_=e,n}onError(e){this.Y_.error(e)}j_(e){this.onlineState=e;let n=!1;return this.X_&&!this.Z_&&this.ta(this.X_,e)&&(this.na(this.X_),n=!0),n}ta(e,n){if(!e.fromCache||!this.G_())return!0;const r=n!=="Offline";return(!this.options.ra||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}ea(e){if(e.docChanges.length>0)return!0;const n=this.X_&&this.X_.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}na(e){e=ts.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Z_=!0,this.Y_.next(e)}G_(){return this.options.source!==Dc.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sg{constructor(e){this.key=e}}class Cg{constructor(e){this.key=e}}class vA{constructor(e,n){this.query=e,this.la=n,this.ha=null,this.hasCachedResults=!1,this.current=!1,this.Pa=Ae(),this.mutatedKeys=Ae(),this.Ia=Zp(e),this.Ta=new Mr(this.Ia)}get Ea(){return this.la}da(e,n){const r=n?n.Aa:new kd,s=n?n.Ta:this.Ta;let i=n?n.mutatedKeys:this.mutatedKeys,a=s,c=!1;const l=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,h=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((d,g)=>{const m=s.get(d),b=na(this.query,g)?g:null,P=!!m&&this.mutatedKeys.has(m.key),D=!!b&&(b.hasLocalMutations||this.mutatedKeys.has(b.key)&&b.hasCommittedMutations);let k=!1;m&&b?m.data.isEqual(b.data)?P!==D&&(r.track({type:3,doc:b}),k=!0):this.Ra(m,b)||(r.track({type:2,doc:b}),k=!0,(l&&this.Ia(b,l)>0||h&&this.Ia(b,h)<0)&&(c=!0)):!m&&b?(r.track({type:0,doc:b}),k=!0):m&&!b&&(r.track({type:1,doc:m}),k=!0,(l||h)&&(c=!0)),k&&(b?(a=a.add(b),i=D?i.add(d):i.delete(d)):(a=a.delete(d),i=i.delete(d)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const d=this.query.limitType==="F"?a.last():a.first();a=a.delete(d.key),i=i.delete(d.key),r.track({type:1,doc:d})}return{Ta:a,Aa:r,Xi:c,mutatedKeys:i}}Ra(e,n){return e.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(e,n,r,s){const i=this.Ta;this.Ta=e.Ta,this.mutatedKeys=e.mutatedKeys;const a=e.Aa.Q_();a.sort((d,g)=>function(b,P){const D=k=>{switch(k){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return de()}};return D(b)-D(P)}(d.type,g.type)||this.Ia(d.doc,g.doc)),this.Va(r),s=s!=null&&s;const c=n&&!s?this.ma():[],l=this.Pa.size===0&&this.current&&!s?1:0,h=l!==this.ha;return this.ha=l,a.length!==0||h?{snapshot:new ts(this.query,e.Ta,i,a,e.mutatedKeys,l===0,h,!1,!!r&&r.resumeToken.approximateByteSize()>0),fa:c}:{fa:c}}j_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ta:this.Ta,Aa:new kd,mutatedKeys:this.mutatedKeys,Xi:!1},!1)):{fa:[]}}ga(e){return!this.la.has(e)&&!!this.Ta.has(e)&&!this.Ta.get(e).hasLocalMutations}Va(e){e&&(e.addedDocuments.forEach(n=>this.la=this.la.add(n)),e.modifiedDocuments.forEach(n=>{}),e.removedDocuments.forEach(n=>this.la=this.la.delete(n)),this.current=e.current)}ma(){if(!this.current)return[];const e=this.Pa;this.Pa=Ae(),this.Ta.forEach(r=>{this.ga(r.key)&&(this.Pa=this.Pa.add(r.key))});const n=[];return e.forEach(r=>{this.Pa.has(r)||n.push(new Cg(r))}),this.Pa.forEach(r=>{e.has(r)||n.push(new Sg(r))}),n}pa(e){this.la=e.hs,this.Pa=Ae();const n=this.da(e.documents);return this.applyChanges(n,!0)}ya(){return ts.fromInitialDocuments(this.query,this.Ta,this.mutatedKeys,this.ha===0,this.hasCachedResults)}}class wA{constructor(e,n,r){this.query=e,this.targetId=n,this.view=r}}class EA{constructor(e){this.key=e,this.wa=!1}}class IA{constructor(e,n,r,s,i,a){this.localStore=e,this.remoteStore=n,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.Sa={},this.ba=new us(c=>Xp(c),ta),this.Da=new Map,this.Ca=new Set,this.va=new ze(se.comparator),this.Fa=new Map,this.Ma=new Al,this.xa={},this.Oa=new Map,this.Na=es.Ln(),this.onlineState="Unknown",this.La=void 0}get isPrimaryClient(){return this.La===!0}}async function TA(t,e,n=!0){const r=Og(t);let s;const i=r.ba.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.ya()):s=await Pg(r,e,n,!0),s}async function AA(t,e){const n=Og(t);await Pg(n,e,!0,!1)}async function Pg(t,e,n,r){const s=await QT(t.localStore,Yt(e)),i=s.targetId,a=n?t.sharedClientState.addLocalQueryTarget(i):"not-current";let c;return r&&(c=await bA(t,e,i,a==="current",s.resumeToken)),t.isPrimaryClient&&n&&Tg(t.remoteStore,s),c}async function bA(t,e,n,r,s){t.Ba=(g,m,b)=>async function(D,k,M,F){let Z=k.view.da(M);Z.Xi&&(Z=await bd(D.localStore,k.query,!1).then(({documents:T})=>k.view.da(T,Z)));const K=F&&F.targetChanges.get(k.targetId),he=F&&F.targetMismatches.get(k.targetId)!=null,ge=k.view.applyChanges(Z,D.isPrimaryClient,K,he);return Od(D,k.targetId,ge.fa),ge.snapshot}(t,g,m,b);const i=await bd(t.localStore,e,!0),a=new vA(e,i.hs),c=a.da(i.documents),l=yi.createSynthesizedTargetChangeForCurrentChange(n,r&&t.onlineState!=="Offline",s),h=a.applyChanges(c,t.isPrimaryClient,l);Od(t,n,h.fa);const d=new wA(e,n,a);return t.ba.set(e,d),t.Da.has(n)?t.Da.get(n).push(e):t.Da.set(n,[e]),h.snapshot}async function RA(t,e,n){const r=Re(t),s=r.ba.get(e),i=r.Da.get(s.targetId);if(i.length>1)return r.Da.set(s.targetId,i.filter(a=>!ta(a,e))),void r.ba.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await kc(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),n&&Sl(r.remoteStore,s.targetId),Nc(r,s.targetId)}).catch(pl)):(Nc(r,s.targetId),await kc(r.localStore,s.targetId,!0))}async function SA(t,e){const n=Re(t),r=n.ba.get(e),s=n.Da.get(r.targetId);n.isPrimaryClient&&s.length===1&&(n.sharedClientState.removeLocalQueryTarget(r.targetId),Sl(n.remoteStore,r.targetId))}async function kg(t,e){const n=Re(t);try{const r=await WT(n.localStore,e);e.targetChanges.forEach((s,i)=>{const a=n.Fa.get(i);a&&(Qe(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1),s.addedDocuments.size>0?a.wa=!0:s.modifiedDocuments.size>0?Qe(a.wa):s.removedDocuments.size>0&&(Qe(a.wa),a.wa=!1))}),await Ng(n,r,e)}catch(r){await pl(r)}}function Nd(t,e,n){const r=Re(t);if(r.isPrimaryClient&&n===0||!r.isPrimaryClient&&n===1){const s=[];r.ba.forEach((i,a)=>{const c=a.view.j_(e);c.snapshot&&s.push(c.snapshot)}),function(a,c){const l=Re(a);l.onlineState=c;let h=!1;l.queries.forEach((d,g)=>{for(const m of g.U_)m.j_(c)&&(h=!0)}),h&&Nl(l)}(r.eventManager,e),s.length&&r.Sa.h_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function CA(t,e,n){const r=Re(t);r.sharedClientState.updateQueryState(e,"rejected",n);const s=r.Fa.get(e),i=s&&s.key;if(i){let a=new ze(se.comparator);a=a.insert(i,gt.newNoDocument(i,ue.min()));const c=Ae().add(i),l=new ia(ue.min(),new Map,new ze(ke),a,c);await kg(r,l),r.va=r.va.remove(i),r.Fa.delete(e),Ol(r)}else await kc(r.localStore,e,!1).then(()=>Nc(r,e,n)).catch(pl)}function Nc(t,e,n=null){t.sharedClientState.removeLocalQueryTarget(e);for(const r of t.Da.get(e))t.ba.delete(r),n&&t.Sa.ka(r,n);t.Da.delete(e),t.isPrimaryClient&&t.Ma.Vr(e).forEach(r=>{t.Ma.containsKey(r)||Dg(t,r)})}function Dg(t,e){t.Ca.delete(e.path.canonicalString());const n=t.va.get(e);n!==null&&(Sl(t.remoteStore,n),t.va=t.va.remove(e),t.Fa.delete(n),Ol(t))}function Od(t,e,n){for(const r of n)r instanceof Sg?(t.Ma.addReference(r.key,e),PA(t,r)):r instanceof Cg?(X("SyncEngine","Document no longer in limbo: "+r.key),t.Ma.removeReference(r.key,e),t.Ma.containsKey(r.key)||Dg(t,r.key)):de()}function PA(t,e){const n=e.key,r=n.path.canonicalString();t.va.get(n)||t.Ca.has(r)||(X("SyncEngine","New document in limbo: "+n),t.Ca.add(r),Ol(t))}function Ol(t){for(;t.Ca.size>0&&t.va.size<t.maxConcurrentLimboResolutions;){const e=t.Ca.values().next().value;t.Ca.delete(e);const n=new se($e.fromString(e)),r=t.Na.next();t.Fa.set(r,new EA(n)),t.va=t.va.insert(n,r),Tg(t.remoteStore,new Mn(Yt(Yp(n.path)),r,"TargetPurposeLimboResolution",gl.oe))}}async function Ng(t,e,n){const r=Re(t),s=[],i=[],a=[];r.ba.isEmpty()||(r.ba.forEach((c,l)=>{a.push(r.Ba(l,e,n).then(h=>{if((h||n)&&r.isPrimaryClient){const d=h&&!h.fromCache;r.sharedClientState.updateQueryState(l.targetId,d?"current":"not-current")}if(h){s.push(h);const d=Rl.Ki(l.targetId,h);i.push(d)}}))}),await Promise.all(a),r.Sa.h_(s),await async function(l,h){const d=Re(l);try{await d.persistence.runTransaction("notifyLocalViewChanges","readwrite",g=>B.forEach(h,m=>B.forEach(m.qi,b=>d.persistence.referenceDelegate.addReference(g,m.targetId,b)).next(()=>B.forEach(m.Qi,b=>d.persistence.referenceDelegate.removeReference(g,m.targetId,b)))))}catch(g){if(!mi(g))throw g;X("LocalStore","Failed to update sequence numbers: "+g)}for(const g of h){const m=g.targetId;if(!g.fromCache){const b=d.ns.get(m),P=b.snapshotVersion,D=b.withLastLimboFreeSnapshotVersion(P);d.ns=d.ns.insert(m,D)}}}(r.localStore,i))}async function kA(t,e){const n=Re(t);if(!n.currentUser.isEqual(e)){X("SyncEngine","User change. New user:",e.toKey());const r=await wg(n.localStore,e);n.currentUser=e,function(i,a){i.Oa.forEach(c=>{c.forEach(l=>{l.reject(new J($.CANCELLED,a))})}),i.Oa.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Ng(n,r.us)}}function DA(t,e){const n=Re(t),r=n.Fa.get(e);if(r&&r.wa)return Ae().add(r.key);{let s=Ae();const i=n.Da.get(e);if(!i)return s;for(const a of i){const c=n.ba.get(a);s=s.unionWith(c.view.Ea)}return s}}function Og(t){const e=Re(t);return e.remoteStore.remoteSyncer.applyRemoteEvent=kg.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=DA.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=CA.bind(null,e),e.Sa.h_=mA.bind(null,e.eventManager),e.Sa.ka=_A.bind(null,e.eventManager),e}class xd{constructor(){this.synchronizeTabs=!1}async initialize(e){this.serializer=oa(e.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(e),this.persistence=this.createPersistence(e),await this.persistence.start(),this.localStore=this.createLocalStore(e),this.gcScheduler=this.createGarbageCollectionScheduler(e,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(e,this.localStore)}createGarbageCollectionScheduler(e,n){return null}createIndexBackfillerScheduler(e,n){return null}createLocalStore(e){return KT(this.persistence,new zT,e.initialUser,this.serializer)}createPersistence(e){return new $T(bl.Hr,this.serializer)}createSharedClientState(e){return new JT}async terminate(){var e,n;(e=this.gcScheduler)===null||e===void 0||e.stop(),(n=this.indexBackfillerScheduler)===null||n===void 0||n.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class NA{async initialize(e,n){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>Nd(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=kA.bind(null,this.syncEngine),await hA(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new fA}()}createDatastore(e){const n=oa(e.databaseInfo.databaseId),r=function(i){return new tA(i)}(e.databaseInfo);return function(i,a,c,l){return new sA(i,a,c,l)}(e.authCredentials,e.appCheckCredentials,r,n)}createRemoteStore(e){return function(r,s,i,a,c){return new oA(r,s,i,a,c)}(this.localStore,this.datastore,e.asyncQueue,n=>Nd(this.syncEngine,n,0),function(){return Sd.D()?new Sd:new XT}())}createSyncEngine(e,n){return function(s,i,a,c,l,h,d){const g=new IA(s,i,a,c,l,h);return d&&(g.La=!0),g}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,n)}async terminate(){var e;await async function(r){const s=Re(r);X("RemoteStore","RemoteStore shutting down."),s.M_.add(5),await vi(s),s.O_.shutdown(),s.N_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fd{constructor(e){var n,r;if(e.host===void 0){if(e.ssl!==void 0)throw new J($.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=(n=e.ssl)===null||n===void 0||n;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=41943040;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<1048576)throw new J($.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}$A("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=xg((r=e.experimentalLongPollingOptions)!==null&&r!==void 0?r:{}),function(i){if(i.timeoutSeconds!==void 0){if(isNaN(i.timeoutSeconds))throw new J($.INVALID_ARGUMENT,`invalid long polling timeout: ${i.timeoutSeconds} (must not be NaN)`);if(i.timeoutSeconds<5)throw new J($.INVALID_ARGUMENT,`invalid long polling timeout: ${i.timeoutSeconds} (minimum allowed value is 5)`);if(i.timeoutSeconds>30)throw new J($.INVALID_ARGUMENT,`invalid long polling timeout: ${i.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(r,s){return r.timeoutSeconds===s.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class xl{constructor(e,n,r,s){this._authCredentials=e,this._appCheckCredentials=n,this._databaseId=r,this._app=s,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Fd({}),this._settingsFrozen=!1}get app(){if(!this._app)throw new J($.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!==void 0}_setSettings(e){if(this._settingsFrozen)throw new J($.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Fd(e),e.credentials!==void 0&&(this._authCredentials=function(r){if(!r)return new _I;switch(r.type){case"firstParty":return new EI(r.sessionIndex||"0",r.iamToken||null,r.authTokenFactory||null);case"provider":return r.client;default:throw new J($.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(n){const r=Md.get(n);r&&(X("ComponentProvider","Removing Datastore"),Md.delete(n),r.terminate())}(this),Promise.resolve()}}function qA(t,e,n,r={}){var s;const i=(t=Oc(t,xl))._getSettings(),a=`${e}:${n}`;if(i.host!=="firestore.googleapis.com"&&i.host!==a&&Yr("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),t._setSettings(Object.assign(Object.assign({},i),{host:a,ssl:!1})),r.mockUserToken){let c,l;if(typeof r.mockUserToken=="string")c=r.mockUserToken,l=pt.MOCK_USER;else{c=Ww(r.mockUserToken,(s=t._app)===null||s===void 0?void 0:s.options.projectId);const h=r.mockUserToken.sub||r.mockUserToken.user_id;if(!h)throw new J($.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");l=new pt(h)}t._authCredentials=new yI(new $p(c,l))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zA{constructor(){this.iu=Promise.resolve(),this.su=[],this.ou=!1,this._u=[],this.au=null,this.uu=!1,this.cu=!1,this.lu=[],this.Yo=new Ig(this,"async_queue_retry"),this.hu=()=>{const n=Wa();n&&X("AsyncQueue","Visibility state changed to "+n.visibilityState),this.Yo.Wo()};const e=Wa();e&&typeof e.addEventListener=="function"&&e.addEventListener("visibilitychange",this.hu)}get isShuttingDown(){return this.ou}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.Pu(),this.Iu(e)}enterRestrictedMode(e){if(!this.ou){this.ou=!0,this.cu=e||!1;const n=Wa();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this.hu)}}enqueue(e){if(this.Pu(),this.ou)return new Promise(()=>{});const n=new ur;return this.Iu(()=>this.ou&&this.cu?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.su.push(e),this.Tu()))}async Tu(){if(this.su.length!==0){try{await this.su[0](),this.su.shift(),this.Yo.reset()}catch(e){if(!mi(e))throw e;X("AsyncQueue","Operation failed with retryable error: "+e)}this.su.length>0&&this.Yo.$o(()=>this.Tu())}}Iu(e){const n=this.iu.then(()=>(this.uu=!0,e().catch(r=>{this.au=r,this.uu=!1;const s=function(a){let c=a.message||"";return a.stack&&(c=a.stack.includes(a.message)?a.stack:a.message+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ns{constructor(e){this._byteString=e}static fromBase64String(e){try{return new ns(Et.fromBase64String(e))}catch(n){throw new J($.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new ns(Et.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lg{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new J($.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new _t(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function y1(t,e=!1){const n=Zt(t),r=await n.getIdToken(e),s=Gl(r);oe(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,a=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:Ws(Qa(s.auth_time)),issuedAtTime:Ws(Qa(s.iat)),expirationTime:Ws(Qa(s.exp)),signInProvider:a||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function Qa(t){return Number(t)*1e3}function Gl(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return po("JWT malformed, contained fewer than 3 sections"),null;try{const s=Ap(n);return s?JSON.parse(s):(po("Failed to decode base64 JWT payload"),null)}catch(s){return po("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function jd(t){const e=Gl(t);return oe(e,"internal-error"),oe(typeof e.exp<"u","internal-error"),oe(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hd(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(tm(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Zg(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(rm(e))return"Blackberry";if(sm(e))return"Webos";if(Ql(e))return"Safari";if((e.includes("chrome/")||em(e))&&!e.includes("edge/"))return"Chrome";if(nm(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Zg(t=lt()){return/firefox\//i.test(t)}function Ql(t=lt()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function em(t=lt()){return/crios\//i.test(t)}function tm(t=lt()){return/iemobile/i.test(t)}function nm(t=lt()){return/android/i.test(t)}function rm(t=lt()){return/blackberry/i.test(t)}function sm(t=lt()){return/webos/i.test(t)}function ua(t=lt()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function b1(t=lt()){var e;return ua(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function R1(){return Xw()&&document.documentMode===10}function im(t=lt()){return ua(t)||nm(t)||sm(t)||rm(t)||/windows phone/i.test(t)||tm(t)}function S1(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L1(t,e){const n=dl(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(So(i,e??{}))return s;gn(s,"already-initialized")}return n.initialize({options:e})}function F1(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(un);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function U1(t,e,n){const r=ha(t);oe(r._canInitEmulator,r,"emulator-config-failed"),oe(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!!(n!=null&&n.disableWarnings),i=am(e),{host:a,port:c}=B1(e),l=c===null?"":`:${c}`;r.config.emulator={url:`${i}//${a}${l}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||$1()}function am(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function B1(t){const e=am(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Wd(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:Wd(a)}}}function Wd(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function $1(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function q1(t,e){return Gg(t,"POST","/v1/accounts:signUp",la(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _b="pendingRedirect",mo=new Map;class yb extends vm{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=mo.get(this.auth._key());if(!e){try{const r=await vb(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}mo.set(this.auth._key(),e)}return this.bypassAuthState||mo.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function vb(t,e){const n=Ib(e),r=Eb(t);if(!await r._isAvailable())return!1;const s=await r._get(n)==="true";return await r._remove(n),s}function wb(t,e){mo.set(t._key(),e)}function Eb(t){return un(t._redirectPersistence)}function Ib(t){return go(_b,t.config.apiKey,t.name)}async function Tb(t,e,n=!1){if(an(t.app))return Promise.reject(qn(t));const r=ha(t),s=db(r,e),a=await new yb(r,s,n).execute();return a&&!n&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ab=10*60*1e3;class bb{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(n=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!Rb(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){var r;if(e.error&&!wm(e)){const s=((r=e.error.code)===null||r===void 0?void 0:r.split("auth/")[1])||"internal-error";n.onError(Jt(this.auth,s))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const r=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=Ab&&this.cachedEventUids.clear(),this.cachedEventUids.has(Jd(e))}saveEventToCache(e){this.cachedEventUids.add(Jd(e)),this.lastProcessedEventTime=Date.now()}}function Jd(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function wm({type:t,error:e}){return t==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function Rb(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return wm(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sR=5*60,iR=Sp("authIdTokenMaxAge")||sR;let rf=null;const oR=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>iR)return;const s=n==null?void 0:n.token;rf!==s&&(rf=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function aR(t=Dp()){const e=dl(t,"auth");if(e.isInitialized())return e.getImmediate();const n=L1(t,{popupRedirectResolver:eR,persistence:[hb,Z1,pm]}),r=Sp("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const a=oR(i.toString());Q1(n,a,()=>a(n.currentUser)),G1(n,c=>a(c))}}const s=bp("auth");return s&&U1(n,`http://${s}`),n}function cR(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}O1({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=Jt("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",cR().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});rR("Browser");const lR={apiKey:"AIzaSyBMX5fhRGBNhKpf11lnHhVi018b5Zavkv8",authDomain:"ws-db-11235813.firebaseapp.com",projectId:"ws-db-11235813",storageBucket:"ws-db-11235813.appspot.com",messagingSenderId:"318238552225",appId:"1:318238552225:web:a5eae1ca149d3137dbc0e0"},Em=kp(lR),jc=HA(Em),uR=aR(Em);z1(uR).then(()=>{console.log("Signed in anonymously")}).catch(t=>{console.error("Error signing in anonymously:",t)});const Ai=Jo("tlData",()=>{const t=yt({}),e=yt({name:"default",url:"noUrl",weight:-1,color:3,isShow:!1,valid:!0}),n=yt(0),r=async()=>{if(!(Math.floor(Date.now()/1e3)<n.value+3600*24)){m();try{const D=Mc(xc(jc,"siteData"),Lc("no"));(await Fc(D)).forEach(M=>{const F=M.data();F.id in t.value?(t.value[F.id].valid=!0,t.value[F.id].name=F.name,t.value[F.id].url=F.url):t.value[F.id]={name:F.name,url:F.url,weight:Object.keys(t.value).length,color:0,isShow:!0,valid:!0}}),b()}catch(D){console.error("Error fetching documents: ",D)}}},s=async()=>{t.value={};try{const P=Mc(xc(jc,"siteData"),Lc("no"));(await Fc(P)).forEach(k=>{const M=k.data();t.value[M.id]={name:M.name,url:M.url,weight:Object.keys(t.value).length,color:0,isShow:!0,valid:!0}})}catch(P){console.error("Error fetching documents: ",P)}},i=me(()=>{let P=[];for(const k of Object.values(t.value))P.push(k.weight);return new Set(P).size!=P.length}),a=me(()=>{let P=[];for(const[D,k]of Object.entries(t.value))P.push({id:D,weight:k.weight});return P.sort((D,k)=>D.weight-k.weight),P.map(D=>D.id)}),c=me(()=>{let P=[];for(const[D,k]of Object.entries(t.value))k.isShow!=!1&&P.push({id:D,weight:k.weight});return P.sort((D,k)=>D.weight-k.weight),P.map(D=>D.id)});function l(P,D){t.value[P].color=D}function h(P,D){t.value[P].weight=D}function d(P){const D=t.value[P].weight;if(D>0){const k=D-1,M=Object.keys(t.value).find(F=>t.value[F].weight==k);console.log("upWeight"),console.log(D,P),console.log(k,M),t.value[P].weight=k,t.value[M].weight=D}}function g(P){const D=t.value[P].weight;if(D<Object.keys(t.value).length-1){const k=D+1,M=Object.keys(t.value).find(F=>t.value[F].weight==k);t.value[P].weight=k,t.value[M].weight=D}}function m(){for(const P of Object.values(t.value))P.valid=!1}function b(){for(const[D,k]of Object.entries(t.value))k.valid||delete t.value[D];let P=[];for(const[D,k]of Object.entries(t.value))P.push({id:D,weight:k.weight});P.sort((D,k)=>D.weight-k.weight);for(const[D,k]of P.entries())t.value[k.id].weight=D}return{tlData:t,defaultTlData:e,sortedIds:a,sortedIdsFiltered:c,loadSiteList:r,setColor:l,setWeight:h,upWeight:d,downWeight:g,resetSiteList:s,invalidSiteList:i}},{persist:!0}),hR={},dR={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 512 512"},fR=Q("g",null,[Q("path",{class:"st0",d:`M487.932,243.768L255.999,0L24.076,243.768c-21.787,22.886-20.874,59.088,2.013,80.865
		...
		C508.806,302.855,509.698,266.654,487.932,243.768z`})],-1),pR=[fR];function gR(t,e){return ce(),De("svg",dR,pR)}const mR=Xe(hR,[["render",gR]]),_R=He({__name:"UpArrowButton",props:{width:{type:Number,default:20},height:{type:Number,default:20},iconColor:{type:String,default:Pe.gray2}},emits:["click"],setup(t,{emit:e}){const n=t,r=e;return(s,i)=>(ce(),Ct(mR,{class:"upArrowButton",onClick:i[0]||(i[0]=a=>r("click")),width:n.width,height:n.height,fill:t.iconColor},null,8,["width","height","fill"]))}}),yR={},vR={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 512 512"},wR=Q("g",null,[Q("path",{class:"st0",d:`M485.919,187.372c-22.905-21.787-59.106-20.893-80.883,2.011l-91.82,96.511V57.202
		...
		C509.696,245.352,508.801,209.128,485.919,187.372z`})],-1),ER=[wR];function IR(t,e){return ce(),De("svg",vR,ER)}const TR=Xe(yR,[["render",IR]]),AR=He({__name:"DownArrowButton",props:{width:{type:Number,default:20},height:{type:Number,default:20},iconColor:{type:String,default:Pe.gray2}},emits:["click"],setup(t,{emit:e}){const n=t,r=e;return(s,i)=>(ce(),Ct(TR,{class:"downArrowButton",onClick:i[0]||(i[0]=a=>r("click")),width:n.width,height:n.height,fill:t.iconColor},null,8,["width","height","fill"]))}}),bR={class:"buttons"},RR=He({__name:"TlTitleBlock",props:{tlSiteId:{type:String,required:!0}},setup(t){const e=t,n=Ai();function r(){n.upWeight(e.tlSiteId)}function s(){n.downWeight(e.tlSiteId)}const i=me(()=>({"--ttb-bg-color":Pe.green1}));return(a,c)=>(ce(),De("div",{class:"tlTitleBlock",style:vt(i.value)},[Q("p",null,wt(Oe(n).tlData[e.tlSiteId].weight+1)+" "+wt(Oe(n).tlData[e.tlSiteId].name),1),Q("div",bR,[Gt(Q("input",{type:"checkbox","onUpdate:modelValue":c[0]||(c[0]=l=>Oe(n).tlData[e.tlSiteId].isShow=l)},null,512),[[uv,Oe(n).tlData[e.tlSiteId].isShow]]),Ce(_R,{onClick:r,fill:"white",height:15}),Ce(AR,{onClick:s,fill:"white",height:15})])],4))}});const SR=Xe(RR,[["__scopeId","data-v-c2859ba2"]]),Im=Jo("appState",()=>{const t=yt("0.2"),e=yt(!1),n=yt(!1),r=yt(!1);return{appVersion:t,useSearch:e,useMenu:n,useNews:r}},{persist:!0}),CR=new Date,pa=Jo("searchConditionStore",()=>{const t=yt([]);function e(c,l,h,d){t.value.push({word:c,year:l,month:h,day:d,color:0})}t.value.length==0&&s();function n(c,l){c>=0&&c<t.value.length&&(t.value[c]=l)}function r(c){c>=0&&c<t.value.length&&t.value.splice(c)}function s(){t.value.push({word:"",year:CR.getFullYear(),month:"-",day:"-",color:0})}function i(){t.value.length>1&&t.value.pop()}const a=me(()=>t.value.length);return{searchCondition:t,newCondition:e,setCondition:n,rmCondition:r,pushCondition:s,popCondition:i,size:a}},{persist:!0}),ga=Jo("wsScrapedData",()=>{const t=yt({}),e=yt({}),n=yt({}),r=async(i,a=!1)=>{i in n.value||(n.value[i]=0);const c=Math.floor(Date.now()/1e3);if(!(!a&&c<n.value[i]+60*30)){e.value[i]=!0;try{const l=Mc(xc(jc,i),Lc("epoch","desc"),r1(30)),h=await Fc(l);let d=[];h.forEach(g=>{d.push(g.data())}),t.value[i]=d,e.value[i]=!1,n.value[i]=Math.floor(Date.now()/1e3),console.log("Load DB: ",i)}catch(l){console.error("Error fetching documents: ",l)}}},s=me(()=>{let i=[];for(const a of Object.values(t.value))i=[...i,...a];return i.sort((a,c)=>c.epoch-a.epoch)});return{scrapedData:t,loadingStatus:e,lastLoadTime:n,loadDatabase:r,allArticles:s}},{persist:!0}),PR=t=>(di("data-v-e766670d"),t=t(),fi(),t),kR={class:"searchArea"},DR={class:"serchCfgArea"},NR=PR(()=>Q("label",{for:"noWindow"},"窓数",-1)),OR=["value"],xR={class:"newsArea"},VR={class:"menuArea"},MR={class:"tlList"},LR={class:"reloadArea"},FR=He({__name:"CfgTabBar",setup(t){const e=Im(),n=Ai(),r=pa(),s=ga(),i=me(()=>e.useSearch?Pe.green1:Pe.gray2),a=me(()=>e.useMenu?Pe.green1:Pe.gray2),c=me(()=>e.useNews?Pe.green1:Pe.gray2),l=yt(0);l.value=r.size;function h(){e.useSearch=!e.useSearch}function d(){if(l.value>r.size){const k=l.value-r.size;for(let M=0;M<k;M++)r.pushCondition()}else if(l.value<r.size){const k=r.size-l.value;for(let M=0;M<k;M++)r.popCondition()}}function g(){e.useNews=!e.useNews}function m(){e.useMenu=!e.useMenu,n.invalidSiteList&&n.resetSiteList()}function b(){window.confirm("データをリセットしますか？")&&n.resetSiteList()}function P(){for(const[k,M]of Object.entries(n.tlData))M.isShow&&(console.log("reload: ",k),s.loadDatabase(k,!0))}const D=me(()=>({"--width":e.useMenu?"280px":"60px"}));return(k,M)=>(ce(),De("div",{class:"cfgTabBar",style:vt(D.value)},[Q("div",kR,[Ce(Ep,{width:50,height:50,fill:i.value,onClick:h},null,8,["fill"]),Gt(Q("div",DR,[NR,Gt(Q("select",{name:"noWindow","onUpdate:modelValue":M[0]||(M[0]=F=>l.value=F),onChange:d},[(ce(),De(Ye,null,dn(3,F=>Q("option",{value:F},wt(F),9,OR)),64))],544),[[ao,l.value]])],512),[[Ao,Oe(e).useSearch]])]),Q("div",xR,[Ce(kw,{width:50,height:50,fill:c.value,onClick:g},null,8,["fill"])]),Q("div",VR,[Ce(Tw,{width:50,height:50,fill:a.value,onClick:m},null,8,["fill"]),Gt(Q("div",MR,[(ce(!0),De(Ye,null,dn(Oe(n).sortedIds,F=>(ce(),Ct(SR,{"tl-site-id":F},null,8,["tl-site-id"]))),256)),Q("input",{type:"button",value:"reset",onClick:b})],512),[[Ao,Oe(e).useMenu]])]),Q("div",LR,[Ce(Lw,{width:50,height:50,fill:Oe(Pe).gray2,onClick:P},null,8,["fill"])])],4))}});const UR=Xe(FR,[["__scopeId","data-v-e766670d"]]),BR=He({__name:"TLTitleBar",props:{tlTitle:{type:String,required:!0},isLoading:{type:Boolean,default:!1},style:{type:Object,default:{"--tl-background-color":Pe.blue1}}},setup(t){const e=t;return(n,r)=>(ce(),De("div",{class:"tlTitleBar",style:vt(t.style)},[Q("p",null,wt(e.tlTitle),1)],4))}});const Tm=Xe(BR,[["__scopeId","data-v-a547faeb"]]),$R=He({__name:"ItemTitleBar",props:{itemTitle:{type:String,required:!0}},setup(t){const e=me(()=>({"--it-background-color":Pe.gray3}));return(n,r)=>(ce(),De("div",{class:"itemTitleBar",style:vt(e.value)},[Q("p",null,wt(t.itemTitle),1)],4))}});const jR=Xe($R,[["__scopeId","data-v-393697e8"]]),qR={class:"iStr"},zR=He({__name:"ItemBox",props:{itemString:{type:String,required:!0},isNewer:{type:Boolean,default:!1}},setup(t){const e=t;return me(()=>({"--bg-color":Pe.yellow3})),(n,r)=>(ce(),De("div",{class:ss(t.isNewer?"itemBoxNew":"itemBox")},[Q("p",qR,wt(e.itemString),1)],2))}});const HR=Xe(zR,[["__scopeId","data-v-69639804"]]),KR={class:"articleItem"},WR=["href"],GR=He({__name:"ArticleItemNoButton",props:{articleDescription:{type:String,required:!0},articleSource:{type:String,required:!0},articleUrl:{type:String,required:!0},articleEpoch:{type:Number,required:!0},tlTitle:{type:String,default:""},showBar:{type:Boolean,default:!1}},setup(t){const e=t,n=me(()=>{const i=new Date(0);return i.setSeconds(e.articleEpoch.valueOf()),i}),r=me(()=>{const i=new Date,a=new Date(0);return a.setSeconds(e.articleEpoch.valueOf()),i.getDate()==a.getDate()&&i.getMonth()==a.getMonth()&&i.getFullYear()==a.getFullYear()}),s=me(()=>({"--bg-color":Pe.yellow3}));return(i,a)=>(ce(),De("div",KR,[e.showBar?(ce(),Ct(jR,{key:0,"item-title":e.articleSource},null,8,["item-title"])):ep("",!0),Ce(HR,{"item-string":e.articleDescription,"is-newer":r.value,style:vt(s.value)},null,8,["item-string","is-newer","style"]),Q("div",{class:ss(r.value?"itemFooterNew":"itemFooter"),style:vt(s.value)},[Q("a",{href:e.articleUrl},"ページリンク",8,WR),Q("p",null,wt(n.value.getFullYear())+"年"+wt(n.value.getMonth()+1)+"月"+wt(n.value.getDate())+"日",1)],6)]))}});const Am=Xe(GR,[["__scopeId","data-v-d494b502"]]),QR=t=>(di("data-v-f6f18b56"),t=t(),fi(),t),YR={class:"tlItemList"},JR={key:0,class:"loadingMsg"},XR=QR(()=>Q("div",{class:"tlFooter"},null,-1)),ZR=He({__name:"Timeline",props:{tlSiteId:{type:String,required:!0},tlTitle:{type:String,default:""},showBar:{type:Boolean,default:!1}},setup(t){const e=t,n=Ai(),r=ga(),s=me(()=>e.tlSiteId in n.tlData?n.tlData[e.tlSiteId]:n.defaultTlData),i=me(()=>e.tlTitle==""?s.value.name:e.tlTitle),a=[Pe.blue1,Pe.red1,Pe.yellow1,Pe.green1,Pe.gray1],c=me(()=>e.tlSiteId=="all"?r.allArticles:r.scrapedData[e.tlSiteId]);jf(()=>{e.tlSiteId!="all"&&s.value.isShow?r.loadDatabase(e.tlSiteId):console.log("Not load DB: ",e.tlSiteId)});const l=me(()=>({"--tl-background-color":a[s.value.color%a.length]}));return(h,d)=>(ce(),De("div",{class:"timeline",style:vt(l.value)},[Ce(Tm,{"tl-title":i.value,style:vt(l.value)},null,8,["tl-title","style"]),Q("div",YR,[Oe(r).loadingStatus[e.tlSiteId]?(ce(),De("p",JR,"--読み込み中--")):ep("",!0),(ce(!0),De(Ye,null,dn(c.value,g=>(ce(),Ct(Am,{"article-source":g.org,"article-description":g.title,"article-url":g.url,"article-epoch":g.epoch,"tl-title":s.value.name,"show-bar":e.showBar},null,8,["article-source","article-description","article-url","article-epoch","tl-title","show-bar"]))),256))]),XR],4))}});const sf=Xe(ZR,[["__scopeId","data-v-f6f18b56"]]),eS={},tS={version:"1.1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 512 512","xml:space":"preserve"},nS=Q("g",null,[Q("polygon",{points:"511.998,70.682 441.315,0 256.002,185.313 70.685,0 0.002,70.692 185.316,256.006 0.002,441.318 70.69,512 256.002,326.688 441.315,512 511.998,441.318 326.684,256.006"})],-1),rS=[nS];function sS(t,e){return ce(),De("svg",tS,rS)}const iS=Xe(eS,[["render",sS]]),oS=He({__name:"XButton",props:{width:{type:Number,default:20},height:{type:Number,default:20},iconColor:{type:String,default:Pe.gray2}},emits:["click"],setup(t,{emit:e}){const n=t,r=e;return(s,i)=>(ce(),Ct(iS,{class:"xButton",onClick:i[0]||(i[0]=a=>r("click")),width:n.width,height:n.height,fill:n.iconColor},null,8,["width","height","fill"]))}}),fs=t=>(di("data-v-013d163b"),t=t(),fi(),t),aS={class:"textArea"},cS=["onKeydown"],lS={class:"dateArea"},uS=fs(()=>Q("option",{key:"noSelct"},"-",-1)),hS=fs(()=>Q("p",null,"年",-1)),dS=fs(()=>Q("option",{key:"noSelct"},"-",-1)),fS=fs(()=>Q("p",null,"月",-1)),pS=fs(()=>Q("option",{key:"noSelct"},"-",-1)),gS=fs(()=>Q("p",null,"日",-1)),mS=He({__name:"SearchForm",props:{styles:{type:Object,default:{"--tl-background-color":Pe.blue1}},scIdx:{type:Number,require:!0}},setup(t){const e=t,n=pa(),r=yt(n.searchCondition[e.scIdx]),s=[2023,2024],i=me(()=>r.value.month=="-"||r.value.year=="-"?0:new Date(r.value.year,r.value.month,0).getDate());function a(){n.setCondition(e.scIdx,r.value)}function c(){r.value.day="-",r.value.month="-"}return(l,h)=>(ce(),De("div",{class:"searchForm",style:vt(e.styles)},[Q("div",aS,[Gt(Q("input",{ty:"",pe:"search","onUpdate:modelValue":h[0]||(h[0]=d=>r.value.word=d),placeholder:"Enter text",size:"25",onKeydown:dv(a,["enter"])},null,40,cS),[[lv,r.value.word]]),Ce(Ep,{onClick:a,height:12,width:12,"icon-color":"white"})]),Q("div",lS,[Gt(Q("select",{name:"year",id:"selctMonth","onUpdate:modelValue":h[1]||(h[1]=d=>r.value.year=d)},[uS,(ce(),De(Ye,null,dn(s,d=>Q("option",{key:d},wt(d),1)),64))],512),[[ao,r.value.year]]),hS,Gt(Q("select",{name:"month",id:"selctMonth","onUpdate:modelValue":h[2]||(h[2]=d=>r.value.month=d)},[dS,(ce(),De(Ye,null,dn(12,d=>Q("option",{key:d},wt(d),1)),64))],512),[[ao,r.value.month]]),fS,Gt(Q("select",{name:"day",id:"selectDay","onUpdate:modelValue":h[3]||(h[3]=d=>r.value.day=d)},[pS,(ce(!0),De(Ye,null,dn(i.value,d=>(ce(),De("option",{key:d},wt(d),1))),128))],512),[[ao,r.value.day]]),gS,Ce(oS,{onClick:c,height:12,width:12,"icon-color":"white"})])],4))}});const _S=Xe(mS,[["__scopeId","data-v-013d163b"]]),yS=t=>(di("data-v-144026ff"),t=t(),fi(),t),vS={class:"tlItemList"},wS=yS(()=>Q("div",{class:"tlFooter"},null,-1)),ES=He({__name:"SearchedTimeline",props:{searchCondIdx:{type:Number,default:0}},setup(t){const e=t,n=pa(),r=ga(),s=me(()=>"検索: "+n.searchCondition[e.searchCondIdx].word),i=me(()=>{let l=r.allArticles;const h=n.searchCondition[e.searchCondIdx];if(l=l.filter(d=>d.title.indexOf(h.word)>=0),h.day!="-"&&h.month!="-"&&h.year!="-"){const d=new Date(h.year,h.month-1,h.day).getTime()/1e3,g=d+60*60*24;l=l.filter(m=>d<=m.epoch&&m.epoch<g)}return l.sort((d,g)=>g.epoch-d.epoch),l}),a=[Pe.blue1,Pe.red1,Pe.yellow1,Pe.green1,Pe.gray1],c=me(()=>({"--tl-background-color":a[3]}));return(l,h)=>(ce(),De("div",{class:"timeline",style:vt(c.value)},[Ce(Tm,{"tl-title":s.value,style:vt(c.value),"is-loading":!1},null,8,["tl-title","style"]),Ce(_S,{style:vt(c.value),"sc-idx":e.searchCondIdx},null,8,["style","sc-idx"]),Q("div",vS,[(ce(!0),De(Ye,null,dn(i.value,d=>(ce(),Ct(Am,{"article-source":d.org,"article-description":d.title,"article-url":d.url,"article-epoch":d.epoch,"tl-title":d.org,"show-bar":!0},null,8,["article-source","article-description","article-url","article-epoch","tl-title"]))),256))]),wS],4))}});const IS=Xe(ES,[["__scopeId","data-v-144026ff"]]),TS={class:"sideArea"},AS={class:"newsArea"},bS={class:"searchArea"},RS={class:"tlArea"},SS=He({__name:"WSAppView",setup(t){const e=Im(),n=Ai(),r=pa();let s=new Date;s=new Date(s.getFullYear(),s.getMonth(),s.getDate());const i=me(()=>!e.useSearch);$f(()=>{n.loadSiteList()});const a=me(()=>({"--bg-color":Pe.gray2}));return(c,l)=>(ce(),De("div",{class:"wsapp",style:vt(a.value)},[Q("div",TS,[Q("div",{class:ss({cfgArea:!0,borderClass:i.value})},[Ce(UR)],2),Gt(Q("div",AS,[Ce(sf,{"tl-site-id":"all","tl-title":"新着情報","last-epoch":Oe(s).getTime()/1e3,"show-bar":!0},null,8,["last-epoch"])],512),[[Ao,Oe(e).useNews]]),Gt(Q("div",bS,[(ce(!0),De(Ye,null,dn(Oe(r).size,h=>(ce(),Ct(IS,{"search-cond-idx":h.valueOf()-1},null,8,["search-cond-idx"]))),256))],512),[[Ao,Oe(e).useSearch]])]),Q("div",RS,[(ce(!0),De(Ye,null,dn(Oe(n).sortedIdsFiltered,h=>(ce(),Ct(sf,{"tl-site-id":h},null,8,["tl-site-id"]))),256))])],4))}});const CS=Xe(SS,[["__scopeId","data-v-bceeeea9"]]),PS={class:"sample"},kS=He({__name:"SampleView",setup(t){const e=Ai(),n=ga();return(r,s)=>(ce(),De("div",PS,[Q("p",null,wt(Oe(e).tlData.micJoho),1),Q("p",null,wt(Oe(n).lastLoadTime),1)]))}});const DS=Xe(kS,[["__scopeId","data-v-3090ffbd"]]),NS=N0({history:Yv("/webscraper_tl/"),routes:[{path:"/",name:"app",component:CS},{path:"/sample",name:"sample",component:DS},{path:"/about",name:"about",component:()=>Wh(()=>import("./AboutView-f7029ba3.js"),["assets/AboutView-f7029ba3.js","assets/AboutView-08887120.css"])},{path:"/contact",name:"contact",component:()=>Wh(()=>import("./ContactView-3af0e33e.js"),["assets/ContactView-3af0e33e.js","assets/ContactView-65b7ef47.css"])}]}),Zl=gv($0),bm=yv();bm.use(Pv());Zl.use(bm);Zl.use(NS);Zl.mount("#app");export{Ph as A,Ye as F,Q as a,Oe as b,De as c,He as d,oo as e,Ny as f,ce as o,dn as r,wt as t,Ai as u};
