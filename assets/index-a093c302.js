 ...
 */let ip;const Xo=t=>ip=t,op=Symbol();function lc(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var Bs;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Bs||(Bs={}));function yv(){const t=ff(!0),e=t.run(()=>vt({}));let n=[],r=[];const s=$o({install(i){Xo(s),s._a=i,i.provide(op,s),i.config.globalProperties.$pinia=s,r.forEach(a=>n.push(a)),r=[]},use(i){return!this._a&&!_v?r.push(i):n.push(i),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return s}const ap=()=>{};function Rh(t,e,n,r=ap){t.push(e);const s=()=>{const i=t.indexOf(e);i>-1&&(t.splice(i,1),r())};return!n&&pf()&&u_(s),s}function Rr(t,...e){t.slice().forEach(n=>{n(...e)})}const vv=t=>t();function uc(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,r)=>t.set(r,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const r=e[n],s=t[n];lc(s)&&lc(r)&&t.hasOwnProperty(n)&&!He(r)&&!Un(r)?t[n]=uc(s,r):t[n]=r}return t}const Ev=Symbol();function Iv(t){return!lc(t)||!t.hasOwnProperty(Ev)}const{assign:Sn}=Object;function Tv(t){return!!(He(t)&&t.effect)}function wv(t,e,n,r){const{state:s,actions:i,getters:a}=e,c=n.state.value[t];let l;function h(){c||(n.state.value[t]=s?s():{});const d=V_(n.state.value[t]);return Sn(d,i,Object.keys(a||{}).reduce((m,g)=>(m[g]=$o(ge(()=>{Xo(n);const b=n._s.get(t);return a[g].call(b,b)})),m),{}))}return l=cp(t,h,e,n,r,!0),l}function cp(t,e,n={},r,s,i){let a;const c=Sn({actions:{}},n),l={deep:!0};let h,d,m=[],g=[],b;const P=r.state.value[t];!i&&!P&&(r.state.value[t]={}),vt({});let N;function k(_){let y;h=d=!1,typeof _=="function"?(_(r.state.value[t]),y={type:Bs.patchFunction,storeId:t,events:b}):(uc(r.state.value[t],_),y={type:Bs.patchObject,payload:_,storeId:t,events:b});const T=N=Symbol();nl().then(()=>{N===T&&(h=!0)}),d=!0,Rr(m,y,r.state.value[t])}const F=i?function(){const{state:y}=n,T=y?y():{};this.$patch(A=>{Sn(A,T)})}:ap;function M(){a.stop(),m=[],g=[],r._s.delete(t)}function Q(_,y){return function(){Xo(r);const T=Array.from(arguments),A=[],R=[];function E(Ie){A.push(Ie)}function rt(Ie){R.push(Ie)}Rr(g,{args:T,name:_,store:he,after:E,onError:rt});let Ze;try{Ze=y.apply(this&&this.$id===t?this:he,T)}catch(Ie){throw Rr(R,Ie),Ie}return Ze instanceof Promise?Ze.then(Ie=>(Rr(A,Ie),Ie)).catch(Ie=>(Rr(R,Ie),Promise.reject(Ie))):(Rr(A,Ze),Ze)}}const z={_p:r,$id:t,$onAction:Rh.bind(null,g),$patch:k,$reset:F,$subscribe(_,y={}){const T=Rh(m,_,y.detached,()=>A()),A=a.run(()=>Ls(()=>r.state.value[t],R=>{(y.flush==="sync"?d:h)&&_({storeId:t,type:Bs.direct,events:b},R)},Sn({},l,y)));return T},$dispose:M},he=hi(z);r._s.set(t,he);const w=(r._a&&r._a.runWithContext||vv)(()=>r._e.run(()=>(a=ff()).run(e)));for(const _ in w){const y=w[_];if(He(y)&&!Tv(y)||Un(y))i||(P&&Iv(y)&&(He(y)?y.value=P[_]:uc(y,P[_])),r.state.value[t][_]=y);else if(typeof y=="function"){const T=Q(_,y);w[_]=T,c.actions[_]=y}}return Sn(he,w),Sn(be(he),w),Object.defineProperty(he,"$state",{get:()=>r.state.value[t],set:_=>{k(y=>{Sn(y,_)})}}),r._p.forEach(_=>{Sn(he,a.run(()=>_({store:he,app:r._a,pinia:r,options:c})))}),P&&i&&n.hydrate&&n.hydrate(he.$state,P),h=!0,d=!0,he}function Yo(t,e,n){let r,s;const i=typeof e=="function";typeof t=="string"?(r=t,s=i?n:e):(s=t,r=t.id);function a(c,l){const h=yy();return c=c||(h?Qt(op,null):null),c&&Xo(c),c=ip,c._s.has(r)||(i?cp(r,e,s,c):wv(r,s,c)),c._s.get(r)}return a.$id=r,a}function Av(t){return typeof t=="object"&&t!==null}function Sh(t,e){return t=Av(t)?t:Object.create(null),new Proxy(t,{get(n,r,s){return r==="key"?Reflect.get(n,r,s):Reflect.get(n,r,s)||Reflect.get(e,r,s)}})}function bv(t,e){return e.reduce((n,r)=>n==null?void 0:n[r],t)}function Rv(t,e,n){return e.slice(0,-1).reduce((r,s)=>/^(__proto__)$/.test(s)?{}:r[s]=r[s]||{},t)[e[e.length-1]]=n,t}function Sv(t,e){return e.reduce((n,r)=>{const s=r.split(".");return Rv(n,s,bv(t,s))},{})}function Cv(t,e){return n=>{var r;try{const{storage:s=localStorage,beforeRestore:i=void 0,afterRestore:a=void 0,serializer:c={serialize:JSON.stringify,deserialize:JSON.parse},key:l=e.$id,paths:h=null,debug:d=!1}=n;return{storage:s,beforeRestore:i,afterRestore:a,serializer:c,key:((r=t.key)!=null?r:m=>m)(typeof l=="string"?l:l(e.$id)),paths:h,debug:d}}catch(s){return n.debug&&console.error("[pinia-plugin-persistedstate]",s),null}}}function Ch(t,{storage:e,serializer:n,key:r,debug:s}){try{const i=e==null?void 0:e.getItem(r);i&&t.$patch(n==null?void 0:n.deserialize(i))}catch(i){s&&console.error("[pinia-plugin-persistedstate]",i)}}function Ph(t,{storage:e,serializer:n,key:r,paths:s,debug:i}){try{const a=Array.isArray(s)?Sv(t,s):t;e.setItem(r,n.serialize(a))}catch(a){i&&console.error("[pinia-plugin-persistedstate]",a)}}function Pv(t={}){return e=>{const{auto:n=!1}=t,{options:{persist:r=n},store:s,pinia:i}=e;if(!r)return;if(!(s.$id in i.state.value)){const c=i._s.get(s.$id.replace("__hot:",""));c&&Promise.resolve().then(()=>c.$persist());return}const a=(Array.isArray(r)?r.map(c=>Sh(c,t)):[Sh(r,t)]).map(Cv(t,s)).filter(Boolean);s.$persist=()=>{a.forEach(c=>{Ph(s.$state,c)})},s.$hydrate=({runHooks:c=!0}={})=>{a.forEach(l=>{const{beforeRestore:h,afterRestore:d}=l;c&&(h==null||h(e)),Ch(s,l),c&&(d==null||d(e))})},a.forEach(c=>{const{beforeRestore:l,afterRestore:h}=c;l==null||l(e),Ch(s,c),h==null||h(e),s.$subscribe((d,m)=>{Ph(m,c)},{detached:!0})})}}const Nv="/webscraper_tl/icon.svg",Ov="MiniCrawler",kv="0.4",hc={appName:Ov,version:kv};/*!
  ...
  */const Sr=typeof window<"u";function Dv(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const ke=Object.assign;function Ma(t,e){const n={};for(const r in e){const s=e[r];n[r]=jt(s)?s.map(t):t(s)}return n}const js=()=>{},jt=Array.isArray,xv=/\/$/,Vv=t=>t.replace(xv,"");function La(t,e,n="/"){let r,s={},i="",a="";const c=e.indexOf("#");let l=e.indexOf("?");return c<l&&c>=0&&(l=-1),l>-1&&(r=e.slice(0,l),i=e.slice(l+1,c>-1?c:e.length),s=t(i)),c>-1&&(r=r||e.slice(0,c),a=e.slice(c,e.length)),r=Fv(r??e,n),{fullPath:r+(i&&"?")+i+a,path:r,query:s,hash:a}}function Mv(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Nh(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function Lv(t,e,n){const r=e.matched.length-1,s=n.matched.length-1;return r>-1&&r===s&&Kr(e.matched[r],n.matched[s])&&lp(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Kr(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function lp(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!Uv(t[n],e[n]))return!1;return!0}function Uv(t,e){return jt(t)?Oh(t,e):jt(e)?Oh(e,t):t===e}function Oh(t,e){return jt(e)?t.length===e.length&&t.every((n,r)=>n===e[r]):t.length===1&&t[0]===e}function Fv(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),r=t.split("/"),s=r[r.length-1];(s===".."||s===".")&&r.push("");let i=n.length-1,a,c;for(a=0;a<r.length;a++)if(c=r[a],c!==".")if(c==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+r.slice(a-(a===r.length?1:0)).join("/")}var ti;(function(t){t.pop="pop",t.push="push"})(ti||(ti={}));var $s;(function(t){t.back="back",t.forward="forward",t.unknown=""})($s||($s={}));function Bv(t){if(!t)if(Sr){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),Vv(t)}const jv=/^[^#]+#/;function $v(t,e){return t.replace(jv,"#")+e}function Hv(t,e){const n=document.documentElement.getBoundingClientRect(),r=t.getBoundingClientRect();return{behavior:e.behavior,left:r.left-n.left-(e.left||0),top:r.top-n.top-(e.top||0)}}const Jo=()=>({left:window.pageXOffset,top:window.pageYOffset});function qv(t){let e;if("el"in t){const n=t.el,r=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;e=Hv(s,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function kh(t,e){return(history.state?history.state.position-e:-1)+t}const dc=new Map;function Gv(t,e){dc.set(t,e)}function zv(t){const e=dc.get(t);return dc.delete(t),e}let Kv=()=>location.protocol+"//"+location.host;function up(t,e){const{pathname:n,search:r,hash:s}=e,i=t.indexOf("#");if(i>-1){let c=s.includes(t.slice(i))?t.slice(i).length:1,l=s.slice(c);return l[0]!=="/"&&(l="/"+l),Nh(l,"")}return Nh(n,t)+r+s}function Wv(t,e,n,r){let s=[],i=[],a=null;const c=({state:g})=>{const b=up(t,location),P=n.value,N=e.value;let k=0;if(g){if(n.value=b,e.value=g,a&&a===P){a=null;return}k=N?g.position-N.position:0}else r(b);s.forEach(F=>{F(n.value,P,{delta:k,type:ti.pop,direction:k?k>0?$s.forward:$s.back:$s.unknown})})};function l(){a=n.value}function h(g){s.push(g);const b=()=>{const P=s.indexOf(g);P>-1&&s.splice(P,1)};return i.push(b),b}function d(){const{history:g}=window;g.state&&g.replaceState(ke({},g.state,{scroll:Jo()}),"")}function m(){for(const g of i)g();i=[],window.removeEventListener("popstate",c),window.removeEventListener("beforeunload",d)}return window.addEventListener("popstate",c),window.addEventListener("beforeunload",d,{passive:!0}),{pauseListeners:l,listen:h,destroy:m}}function Dh(t,e,n,r=!1,s=!1){return{back:t,current:e,forward:n,replaced:r,position:window.history.length,scroll:s?Jo():null}}function Qv(t){const{history:e,location:n}=window,r={value:up(t,n)},s={value:e.state};s.value||i(r.value,{back:null,current:r.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(l,h,d){const m=t.indexOf("#"),g=m>-1?(n.host&&document.querySelector("base")?t:t.slice(m))+l:Kv()+t+l;try{e[d?"replaceState":"pushState"](h,"",g),s.value=h}catch(b){console.error(b),n[d?"replace":"assign"](g)}}function a(l,h){const d=ke({},e.state,Dh(s.value.back,l,s.value.forward,!0),h,{position:s.value.position});i(l,d,!0),r.value=l}function c(l,h){const d=ke({},s.value,e.state,{forward:l,scroll:Jo()});i(d.current,d,!0);const m=ke({},Dh(r.value,l,null),{position:d.position+1},h);i(l,m,!1),r.value=l}return{location:r,state:s,push:c,replace:a}}function Xv(t){t=Bv(t);const e=Qv(t),n=Wv(t,e.state,e.location,e.replace);function r(i,a=!0){a||n.pauseListeners(),history.go(i)}const s=ke({location:"",base:t,go:r,createHref:$v.bind(null,t)},e,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>e.state.value}),s}function Yv(t){return typeof t=="string"||t&&typeof t=="object"}function hp(t){return typeof t=="string"||typeof t=="symbol"}const bn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},dp=Symbol("");var xh;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(xh||(xh={}));function Wr(t,e){return ke(new Error,{type:t,[dp]:!0},e)}function sn(t,e){return t instanceof Error&&dp in t&&(e==null||!!(t.type&e))}const Vh="[^/]+?",Jv={sensitive:!1,strict:!1,start:!0,end:!0},Zv=/[.+*?^${}()[\]/\\]/g;function eE(t,e){const n=ke({},Jv,e),r=[];let s=n.start?"^":"";const i=[];for(const h of t){const d=h.length?[]:[90];n.strict&&!h.length&&(s+="/");for(let m=0;m<h.length;m++){const g=h[m];let b=40+(n.sensitive?.25:0);if(g.type===0)m||(s+="/"),s+=g.value.replace(Zv,"\\$&"),b+=40;else if(g.type===1){const{value:P,repeatable:N,optional:k,regexp:F}=g;i.push({name:P,repeatable:N,optional:k});const M=F||Vh;if(M!==Vh){b+=10;try{new RegExp(`(${M})`)}catch(z){throw new Error(`Invalid custom RegExp for param "${P}" (${M}): `+z.message)}}let Q=N?`((?:${M})(?:/(?:${M}))*)`:`(${M})`;m||(Q=k&&h.length<2?`(?:/${Q})`:"/"+Q),k&&(Q+="?"),s+=Q,b+=20,k&&(b+=-8),N&&(b+=-20),M===".*"&&(b+=-50)}d.push(b)}r.push(d)}if(n.strict&&n.end){const h=r.length-1;r[h][r[h].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&(s+="(?:/|$)");const a=new RegExp(s,n.sensitive?"":"i");function c(h){const d=h.match(a),m={};if(!d)return null;for(let g=1;g<d.length;g++){const b=d[g]||"",P=i[g-1];m[P.name]=b&&P.repeatable?b.split("/"):b}return m}function l(h){let d="",m=!1;for(const g of t){(!m||!d.endsWith("/"))&&(d+="/"),m=!1;for(const b of g)if(b.type===0)d+=b.value;else if(b.type===1){const{value:P,repeatable:N,optional:k}=b,F=P in h?h[P]:"";if(jt(F)&&!N)throw new Error(`Provided param "${P}" is an array but it is not repeatable (* or + modifiers)`);const M=jt(F)?F.join("/"):F;if(!M)if(k)g.length<2&&(d.endsWith("/")?d=d.slice(0,-1):m=!0);else throw new Error(`Missing required param "${P}"`);d+=M}}return d||"/"}return{re:a,score:r,keys:i,parse:c,stringify:l}}function tE(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=e[n]-t[n];if(r)return r;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function nE(t,e){let n=0;const r=t.score,s=e.score;for(;n<r.length&&n<s.length;){const i=tE(r[n],s[n]);if(i)return i;n++}if(Math.abs(s.length-r.length)===1){if(Mh(r))return 1;if(Mh(s))return-1}return s.length-r.length}function Mh(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const rE={type:0,value:""},sE=/[a-zA-Z0-9_]/;function iE(t){if(!t)return[[]];if(t==="/")return[[rE]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(b){throw new Error(`ERR (${n})/"${h}": ${b}`)}let n=0,r=n;const s=[];let i;function a(){i&&s.push(i),i=[]}let c=0,l,h="",d="";function m(){h&&(n===0?i.push({type:0,value:h}):n===1||n===2||n===3?(i.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${h}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:h,regexp:d,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),h="")}function g(){h+=l}for(;c<t.length;){if(l=t[c++],l==="\\"&&n!==2){r=n,n=4;continue}switch(n){case 0:l==="/"?(h&&m(),a()):l===":"?(m(),n=1):g();break;case 4:g(),n=r;break;case 1:l==="("?n=2:sE.test(l)?g():(m(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&c--);break;case 2:l===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+l:n=3:d+=l;break;case 3:m(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&c--,d="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${h}"`),m(),a(),s}function oE(t,e,n){const r=eE(iE(t.path),n),s=ke(r,{record:t,parent:e,children:[],alias:[]});return e&&!s.record.aliasOf==!e.record.aliasOf&&e.children.push(s),s}function aE(t,e){const n=[],r=new Map;e=Fh({strict:!1,end:!0,sensitive:!1},e);function s(d){return r.get(d)}function i(d,m,g){const b=!g,P=cE(d);P.aliasOf=g&&g.record;const N=Fh(e,d),k=[P];if("alias"in d){const Q=typeof d.alias=="string"?[d.alias]:d.alias;for(const z of Q)k.push(ke({},P,{components:g?g.record.components:P.components,path:z,aliasOf:g?g.record:P}))}let F,M;for(const Q of k){const{path:z}=Q;if(m&&z[0]!=="/"){const he=m.record.path,me=he[he.length-1]==="/"?"":"/";Q.path=m.record.path+(z&&me+z)}if(F=oE(Q,m,N),g?g.alias.push(F):(M=M||F,M!==F&&M.alias.push(F),b&&d.name&&!Uh(F)&&a(d.name)),P.children){const he=P.children;for(let me=0;me<he.length;me++)i(he[me],F,g&&g.children[me])}g=g||F,(F.record.components&&Object.keys(F.record.components).length||F.record.name||F.record.redirect)&&l(F)}return M?()=>{a(M)}:js}function a(d){if(hp(d)){const m=r.get(d);m&&(r.delete(d),n.splice(n.indexOf(m),1),m.children.forEach(a),m.alias.forEach(a))}else{const m=n.indexOf(d);m>-1&&(n.splice(m,1),d.record.name&&r.delete(d.record.name),d.children.forEach(a),d.alias.forEach(a))}}function c(){return n}function l(d){let m=0;for(;m<n.length&&nE(d,n[m])>=0&&(d.record.path!==n[m].record.path||!fp(d,n[m]));)m++;n.splice(m,0,d),d.record.name&&!Uh(d)&&r.set(d.record.name,d)}function h(d,m){let g,b={},P,N;if("name"in d&&d.name){if(g=r.get(d.name),!g)throw Wr(1,{location:d});N=g.record.name,b=ke(Lh(m.params,g.keys.filter(M=>!M.optional).map(M=>M.name)),d.params&&Lh(d.params,g.keys.map(M=>M.name))),P=g.stringify(b)}else if("path"in d)P=d.path,g=n.find(M=>M.re.test(P)),g&&(b=g.parse(P),N=g.record.name);else{if(g=m.name?r.get(m.name):n.find(M=>M.re.test(m.path)),!g)throw Wr(1,{location:d,currentLocation:m});N=g.record.name,b=ke({},m.params,d.params),P=g.stringify(b)}const k=[];let F=g;for(;F;)k.unshift(F.record),F=F.parent;return{name:N,path:P,params:b,matched:k,meta:uE(k)}}return t.forEach(d=>i(d)),{addRoute:i,resolve:h,removeRoute:a,getRoutes:c,getRecordMatcher:s}}function Lh(t,e){const n={};for(const r of e)r in t&&(n[r]=t[r]);return n}function cE(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:lE(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function lE(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const r in t.components)e[r]=typeof n=="object"?n[r]:n;return e}function Uh(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function uE(t){return t.reduce((e,n)=>ke(e,n.meta),{})}function Fh(t,e){const n={};for(const r in t)n[r]=r in e?e[r]:t[r];return n}function fp(t,e){return e.children.some(n=>n===t||fp(t,n))}const pp=/#/g,hE=/&/g,dE=/\//g,fE=/=/g,pE=/\?/g,mp=/\+/g,mE=/%5B/g,gE=/%5D/g,gp=/%5E/g,_E=/%60/g,_p=/%7B/g,yE=/%7C/g,yp=/%7D/g,vE=/%20/g;function ll(t){return encodeURI(""+t).replace(yE,"|").replace(mE,"[").replace(gE,"]")}function EE(t){return ll(t).replace(_p,"{").replace(yp,"}").replace(gp,"^")}function fc(t){return ll(t).replace(mp,"%2B").replace(vE,"+").replace(pp,"%23").replace(hE,"%26").replace(_E,"`").replace(_p,"{").replace(yp,"}").replace(gp,"^")}function IE(t){return fc(t).replace(fE,"%3D")}function TE(t){return ll(t).replace(pp,"%23").replace(pE,"%3F")}function wE(t){return t==null?"":TE(t).replace(dE,"%2F")}function bo(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function AE(t){const e={};if(t===""||t==="?")return e;const r=(t[0]==="?"?t.slice(1):t).split("&");for(let s=0;s<r.length;++s){const i=r[s].replace(mp," "),a=i.indexOf("="),c=bo(a<0?i:i.slice(0,a)),l=a<0?null:bo(i.slice(a+1));if(c in e){let h=e[c];jt(h)||(h=e[c]=[h]),h.push(l)}else e[c]=l}return e}function Bh(t){let e="";for(let n in t){const r=t[n];if(n=IE(n),r==null){r!==void 0&&(e+=(e.length?"&":"")+n);continue}(jt(r)?r.map(i=>i&&fc(i)):[r&&fc(r)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function bE(t){const e={};for(const n in t){const r=t[n];r!==void 0&&(e[n]=jt(r)?r.map(s=>s==null?null:""+s):r==null?r:""+r)}return e}const RE=Symbol(""),jh=Symbol(""),ul=Symbol(""),vp=Symbol(""),pc=Symbol("");function Ns(){let t=[];function e(r){return t.push(r),()=>{const s=t.indexOf(r);s>-1&&t.splice(s,1)}}function n(){t=[]}return{add:e,list:()=>t.slice(),reset:n}}function Pn(t,e,n,r,s){const i=r&&(r.enterCallbacks[s]=r.enterCallbacks[s]||[]);return()=>new Promise((a,c)=>{const l=m=>{m===!1?c(Wr(4,{from:n,to:e})):m instanceof Error?c(m):Yv(m)?c(Wr(2,{from:e,to:m})):(i&&r.enterCallbacks[s]===i&&typeof m=="function"&&i.push(m),a())},h=t.call(r&&r.instances[s],e,n,l);let d=Promise.resolve(h);t.length<3&&(d=d.then(l)),d.catch(m=>c(m))})}function Ua(t,e,n,r){const s=[];for(const i of t)for(const a in i.components){let c=i.components[a];if(!(e!=="beforeRouteEnter"&&!i.instances[a]))if(SE(c)){const h=(c.__vccOpts||c)[e];h&&s.push(Pn(h,n,r,i,a))}else{let l=c();s.push(()=>l.then(h=>{if(!h)return Promise.reject(new Error(`Couldn't resolve component "${a}" at "${i.path}"`));const d=Dv(h)?h.default:h;i.components[a]=d;const g=(d.__vccOpts||d)[e];return g&&Pn(g,n,r,i,a)()}))}}return s}function SE(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function $h(t){const e=Qt(ul),n=Qt(vp),r=ge(()=>e.resolve(De(t.to))),s=ge(()=>{const{matched:l}=r.value,{length:h}=l,d=l[h-1],m=n.matched;if(!d||!m.length)return-1;const g=m.findIndex(Kr.bind(null,d));if(g>-1)return g;const b=Hh(l[h-2]);return h>1&&Hh(d)===b&&m[m.length-1].path!==b?m.findIndex(Kr.bind(null,l[h-2])):g}),i=ge(()=>s.value>-1&&NE(n.params,r.value.params)),a=ge(()=>s.value>-1&&s.value===n.matched.length-1&&lp(n.params,r.value.params));function c(l={}){return PE(l)?e[De(t.replace)?"replace":"push"](De(t.to)).catch(js):Promise.resolve()}return{route:r,href:ge(()=>r.value.href),isActive:i,isExactActive:a,navigate:c}}const CE=Ge({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:$h,setup(t,{slots:e}){const n=hi($h(t)),{options:r}=Qt(ul),s=ge(()=>({[qh(t.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[qh(t.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&e.default(n);return t.custom?i:rp("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},i)}}}),co=CE;function PE(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function NE(t,e){for(const n in e){const r=e[n],s=t[n];if(typeof r=="string"){if(r!==s)return!1}else if(!jt(s)||s.length!==r.length||r.some((i,a)=>i!==s[a]))return!1}return!0}function Hh(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const qh=(t,e,n)=>t??e??n,OE=Ge({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const r=Qt(pc),s=ge(()=>t.route||r.value),i=Qt(jh,0),a=ge(()=>{let h=De(i);const{matched:d}=s.value;let m;for(;(m=d[h])&&!m.components;)h++;return h}),c=ge(()=>s.value.matched[a.value]);ro(jh,ge(()=>a.value+1)),ro(RE,c),ro(pc,s);const l=vt();return Ls(()=>[l.value,c.value,t.name],([h,d,m],[g,b,P])=>{d&&(d.instances[m]=h,b&&b!==d&&h&&h===g&&(d.leaveGuards.size||(d.leaveGuards=b.leaveGuards),d.updateGuards.size||(d.updateGuards=b.updateGuards))),h&&d&&(!b||!Kr(d,b)||!g)&&(d.enterCallbacks[m]||[]).forEach(N=>N(h))},{flush:"post"}),()=>{const h=s.value,d=t.name,m=c.value,g=m&&m.components[d];if(!g)return Gh(n.default,{Component:g,route:h});const b=m.props[d],P=b?b===!0?h.params:typeof b=="function"?b(h):b:null,k=rp(g,ke({},P,e,{onVnodeUnmounted:F=>{F.component.isUnmounted&&(m.instances[d]=null)},ref:l}));return Gh(n.default,{Component:k,route:h})||k}}});function Gh(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const Ep=OE;function kE(t){const e=aE(t.routes,t),n=t.parseQuery||AE,r=t.stringifyQuery||Bh,s=t.history,i=Ns(),a=Ns(),c=Ns(),l=k_(bn);let h=bn;Sr&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Ma.bind(null,x=>""+x),m=Ma.bind(null,wE),g=Ma.bind(null,bo);function b(x,X){let G,ee;return hp(x)?(G=e.getRecordMatcher(x),ee=X):ee=x,e.addRoute(ee,G)}function P(x){const X=e.getRecordMatcher(x);X&&e.removeRoute(X)}function N(){return e.getRoutes().map(x=>x.record)}function k(x){return!!e.getRecordMatcher(x)}function F(x,X){if(X=ke({},X||l.value),typeof x=="string"){const C=La(n,x,X.path),D=e.resolve({path:C.path},X),V=s.createHref(C.fullPath);return ke(C,D,{params:g(D.params),hash:bo(C.hash),redirectedFrom:void 0,href:V})}let G;if("path"in x)G=ke({},x,{path:La(n,x.path,X.path).path});else{const C=ke({},x.params);for(const D in C)C[D]==null&&delete C[D];G=ke({},x,{params:m(C)}),X.params=m(X.params)}const ee=e.resolve(G,X),ye=x.hash||"";ee.params=d(g(ee.params));const v=Mv(r,ke({},x,{hash:EE(ye),path:ee.path})),I=s.createHref(v);return ke({fullPath:v,hash:ye,query:r===Bh?bE(x.query):x.query||{}},ee,{redirectedFrom:void 0,href:I})}function M(x){return typeof x=="string"?La(n,x,l.value.path):ke({},x)}function Q(x,X){if(h!==x)return Wr(8,{from:X,to:x})}function z(x){return w(x)}function he(x){return z(ke(M(x),{replace:!0}))}function me(x){const X=x.matched[x.matched.length-1];if(X&&X.redirect){const{redirect:G}=X;let ee=typeof G=="function"?G(x):G;return typeof ee=="string"&&(ee=ee.includes("?")||ee.includes("#")?ee=M(ee):{path:ee},ee.params={}),ke({query:x.query,hash:x.hash,params:"path"in ee?{}:x.params},ee)}}function w(x,X){const G=h=F(x),ee=l.value,ye=x.state,v=x.force,I=x.replace===!0,C=me(G);if(C)return w(ke(M(C),{state:typeof C=="object"?ke({},ye,C.state):ye,force:v,replace:I}),X||G);const D=G;D.redirectedFrom=X;let V;return!v&&Lv(r,ee,G)&&(V=Wr(16,{to:D,from:ee}),kt(ee,ee,!0,!1)),(V?Promise.resolve(V):T(D,ee)).catch(L=>sn(L)?sn(L,2)?L:xt(L):_e(L,D,ee)).then(L=>{if(L){if(sn(L,2))return w(ke({replace:I},M(L.to),{state:typeof L.to=="object"?ke({},ye,L.to.state):ye,force:v}),X||D)}else L=R(D,ee,!0,I,ye);return A(D,ee,L),L})}function _(x,X){const G=Q(x,X);return G?Promise.reject(G):Promise.resolve()}function y(x){const X=En.values().next().value;return X&&typeof X.runWithContext=="function"?X.runWithContext(x):x()}function T(x,X){let G;const[ee,ye,v]=DE(x,X);G=Ua(ee.reverse(),"beforeRouteLeave",x,X);for(const C of ee)C.leaveGuards.forEach(D=>{G.push(Pn(D,x,X))});const I=_.bind(null,x,X);return G.push(I),et(G).then(()=>{G=[];for(const C of i.list())G.push(Pn(C,x,X));return G.push(I),et(G)}).then(()=>{G=Ua(ye,"beforeRouteUpdate",x,X);for(const C of ye)C.updateGuards.forEach(D=>{G.push(Pn(D,x,X))});return G.push(I),et(G)}).then(()=>{G=[];for(const C of v)if(C.beforeEnter)if(jt(C.beforeEnter))for(const D of C.beforeEnter)G.push(Pn(D,x,X));else G.push(Pn(C.beforeEnter,x,X));return G.push(I),et(G)}).then(()=>(x.matched.forEach(C=>C.enterCallbacks={}),G=Ua(v,"beforeRouteEnter",x,X),G.push(I),et(G))).then(()=>{G=[];for(const C of a.list())G.push(Pn(C,x,X));return G.push(I),et(G)}).catch(C=>sn(C,8)?C:Promise.reject(C))}function A(x,X,G){c.list().forEach(ee=>y(()=>ee(x,X,G)))}function R(x,X,G,ee,ye){const v=Q(x,X);if(v)return v;const I=X===bn,C=Sr?history.state:{};G&&(ee||I?s.replace(x.fullPath,ke({scroll:I&&C&&C.scroll},ye)):s.push(x.fullPath,ye)),l.value=x,kt(x,X,G,I),xt()}let E;function rt(){E||(E=s.listen((x,X,G)=>{if(!Ht.listening)return;const ee=F(x),ye=me(ee);if(ye){w(ke(ye,{replace:!0}),ee).catch(js);return}h=ee;const v=l.value;Sr&&Gv(kh(v.fullPath,G.delta),Jo()),T(ee,v).catch(I=>sn(I,12)?I:sn(I,2)?(w(I.to,ee).then(C=>{sn(C,20)&&!G.delta&&G.type===ti.pop&&s.go(-1,!1)}).catch(js),Promise.reject()):(G.delta&&s.go(-G.delta,!1),_e(I,ee,v))).then(I=>{I=I||R(ee,v,!1),I&&(G.delta&&!sn(I,8)?s.go(-G.delta,!1):G.type===ti.pop&&sn(I,20)&&s.go(-1,!1)),A(ee,v,I)}).catch(js)}))}let Ze=Ns(),Ie=Ns(),Te;function _e(x,X,G){xt(x);const ee=Ie.list();return ee.length?ee.forEach(ye=>ye(x,X,G)):console.error(x),Promise.reject(x)}function Pt(){return Te&&l.value!==bn?Promise.resolve():new Promise((x,X)=>{Ze.add([x,X])})}function xt(x){return Te||(Te=!x,rt(),Ze.list().forEach(([X,G])=>x?G(x):X()),Ze.reset()),x}function kt(x,X,G,ee){const{scrollBehavior:ye}=t;if(!Sr||!ye)return Promise.resolve();const v=!G&&zv(kh(x.fullPath,0))||(ee||!G)&&history.state&&history.state.scroll||null;return nl().then(()=>ye(x,X,v)).then(I=>I&&qv(I)).catch(I=>_e(I,x,X))}const Fe=x=>s.go(x);let Be;const En=new Set,Ht={currentRoute:l,listening:!0,addRoute:b,removeRoute:P,hasRoute:k,getRoutes:N,resolve:F,options:t,push:z,replace:he,go:Fe,back:()=>Fe(-1),forward:()=>Fe(1),beforeEach:i.add,beforeResolve:a.add,afterEach:c.add,onError:Ie.add,isReady:Pt,install(x){const X=this;x.component("RouterLink",co),x.component("RouterView",Ep),x.config.globalProperties.$router=X,Object.defineProperty(x.config.globalProperties,"$route",{enumerable:!0,get:()=>De(l)}),Sr&&!Be&&l.value===bn&&(Be=!0,z(s.location).catch(ye=>{}));const G={};for(const ye in bn)Object.defineProperty(G,ye,{get:()=>l.value[ye],enumerable:!0});x.provide(ul,X),x.provide(vp,bf(G)),x.provide(pc,l);const ee=x.unmount;En.add(x),x.unmount=function(){En.delete(x),En.size<1&&(h=bn,E&&E(),E=null,l.value=bn,Be=!1,Te=!1),ee()}}};function et(x){return x.reduce((X,G)=>X.then(()=>y(G)),Promise.resolve())}return Ht}function DE(t,e){const n=[],r=[],s=[],i=Math.max(e.matched.length,t.matched.length);for(let a=0;a<i;a++){const c=e.matched[a];c&&(t.matched.find(h=>Kr(h,c))?r.push(c):n.push(c));const l=t.matched[a];l&&(e.matched.find(h=>Kr(h,l))||s.push(l))}return[n,r,s]}const xE=t=>(di("data-v-2bb0cbed"),t=t(),fi(),t),VE={class:"headerClass"},ME={class:"headerNav"},LE={class:"headerIconTitle"},UE=xE(()=>W("img",{src:Nv,type:"image/svg+xml",alt:"icon"},null,-1)),FE={class:"appView"},BE=Ge({__name:"App",setup(t){return(e,n)=>(ce(),Oe(Xe,null,[W("header",VE,[W("nav",ME,[Pe(De(co),{to:"/"},{default:to(()=>[oo("HOME")]),_:1}),Pe(De(co),{to:"/about"},{default:to(()=>[oo("ABOUT")]),_:1}),Pe(De(co),{to:"/contact"},{default:to(()=>[oo("CONTACT")]),_:1})]),W("div",LE,[UE,W("p",null,at(De(hc).appName)+" v"+at(De(hc).version),1)])]),W("div",FE,[Pe(De(Ep))])],64))}});const Je=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},jE=Je(BE,[["__scopeId","data-v-2bb0cbed"]]),$E="modulepreload",HE=function(t){return"/webscraper_tl/"+t},zh={},Kh=function(e,n,r){if(!n||n.length===0)return e();const s=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=HE(i),i in zh)return;zh[i]=!0;const a=i.endsWith(".css"),c=a?'[rel="stylesheet"]':"";if(!!r)for(let d=s.length-1;d>=0;d--){const m=s[d];if(m.href===i&&(!a||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${c}`))return;const h=document.createElement("link");if(h.rel=a?"stylesheet":$E,a||(h.as="script",h.crossOrigin=""),h.href=i,document.head.appendChild(h),a)return new Promise((d,m)=>{h.addEventListener("load",d),h.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e()).catch(i=>{const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=i,window.dispatchEvent(a),!a.defaultPrevented)throw i})},qE={},GE={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512"},zE=W("g",null,[W("path",{d:`M449.803,62.197C408.443,20.807,353.85-0.037,299.646-0.006C245.428-0.037,190.85,20.807,149.49,62.197
		...
		c22.225,0,40.252-18.019,40.252-40.252C80.504,435.026,62.477,417.007,40.252,417.007z"></path><rect x="148.122" y="417.007" class="st0" width="363.878" height="80.504"></rect></g>`,1),E0=[v0];function I0(t,e){return ce(),Oe("svg",y0,E0)}const T0=Je(_0,[["render",I0]]),w0=Ge({__name:"MenuButton",props:{width:{type:Number,default:20},height:{type:Number,default:20},iconColor:{type:String,default:Ce.gray2}},emits:["click"],setup(t,{emit:e}){const n=t,r=e;return(s,i)=>(ce(),Ct(T0,{class:"menuButton",onClick:i[0]||(i[0]=a=>r("click")),width:n.width,height:n.height,fill:t.iconColor},null,8,["width","height","fill"]))}}),A0={},b0={version:"1.1",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 512 512"},R0=W("g",null,[W("path",{class:"st0",d:`M512,255.996l-63.305-51.631l29.002-76.362l-80.633-13.07L383.993,34.3l-76.361,29.002L256,0.004
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tp=function(t){const e=[];let n=0;for(let r=0;r<t.length;r++){let s=t.charCodeAt(r);s<128?e[n++]=s:s<2048?(e[n++]=s>>6|192,e[n++]=s&63|128):(s&64512)===55296&&r+1<t.length&&(t.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(t.charCodeAt(++r)&1023),e[n++]=s>>18|240,e[n++]=s>>12&63|128,e[n++]=s>>6&63|128,e[n++]=s&63|128):(e[n++]=s>>12|224,e[n++]=s>>6&63|128,e[n++]=s&63|128)}return e},U0=function(t){const e=[];let n=0,r=0;for(;n<t.length;){const s=t[n++];if(s<128)e[r++]=String.fromCharCode(s);else if(s>191&&s<224){const i=t[n++];e[r++]=String.fromCharCode((s&31)<<6|i&63)}else if(s>239&&s<365){const i=t[n++],a=t[n++],c=t[n++],l=((s&7)<<18|(i&63)<<12|(a&63)<<6|c&63)-65536;e[r++]=String.fromCharCode(55296+(l>>10)),e[r++]=String.fromCharCode(56320+(l&1023))}else{const i=t[n++],a=t[n++];e[r++]=String.fromCharCode((s&15)<<12|(i&63)<<6|a&63)}}return e.join("")},wp={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(t,e){if(!Array.isArray(t))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<t.length;s+=3){const i=t[s],a=s+1<t.length,c=a?t[s+1]:0,l=s+2<t.length,h=l?t[s+2]:0,d=i>>2,m=(i&3)<<4|c>>4;let g=(c&15)<<2|h>>6,b=h&63;l||(b=64,a||(g=64)),r.push(n[d],n[m],n[g],n[b])}return r.join("")},encodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(t):this.encodeByteArray(Tp(t),e)},decodeString(t,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(t):U0(this.decodeStringToByteArray(t,e))},decodeStringToByteArray(t,e){this.init_();const n=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<t.length;){const i=n[t.charAt(s++)],c=s<t.length?n[t.charAt(s)]:0;++s;const h=s<t.length?n[t.charAt(s)]:64;++s;const m=s<t.length?n[t.charAt(s)]:64;if(++s,i==null||c==null||h==null||m==null)throw new F0;const g=i<<2|c>>4;if(r.push(g),h!==64){const b=c<<4&240|h>>2;if(r.push(b),m!==64){const P=h<<6&192|m;r.push(P)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let t=0;t<this.ENCODED_VALS.length;t++)this.byteToCharMap_[t]=this.ENCODED_VALS.charAt(t),this.charToByteMap_[this.byteToCharMap_[t]]=t,this.byteToCharMapWebSafe_[t]=this.ENCODED_VALS_WEBSAFE.charAt(t),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[t]]=t,t>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(t)]=t,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(t)]=t)}}};class F0 extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const B0=function(t){const e=Tp(t);return wp.encodeByteArray(e,!0)},Ro=function(t){return B0(t).replace(/\./g,"")},Ap=function(t){try{return wp.decodeString(t,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nI="FirebaseError";class yn extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=nI,Object.setPrototypeOf(this,yn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,pi.prototype.create)}}class pi{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?rI(i,r):"Error",c=`${this.serviceName}: ${a} (${s}).`;return new yn(s,c,r)}}function rI(t,e){return t.replace(sI,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const sI=/\{\$([^}]+)}/g;function iI(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function So(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],a=e[s];if(Wh(i)&&Wh(a)){if(!So(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function Wh(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ve;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(ve||(ve={}));const fI={debug:ve.DEBUG,verbose:ve.VERBOSE,info:ve.INFO,warn:ve.WARN,error:ve.ERROR,silent:ve.SILENT},pI=ve.INFO,mI={[ve.DEBUG]:"log",[ve.VERBOSE]:"log",[ve.INFO]:"info",[ve.WARN]:"warn",[ve.ERROR]:"error"},gI=(t,e,...n)=>{if(e<t.logLevel)return;const r=new Date().toISOString(),s=mI[e];if(s)console[s](`[${r}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class hl{constructor(e){this.name=e,this._logLevel=pI,this._logHandler=gI,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ve))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?fI[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ve.DEBUG,...e),this._logHandler(this,ve.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ve.VERBOSE,...e),this._logHandler(this,ve.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ve.INFO,...e),this._logHandler(this,ve.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ve.WARN,...e),this._logHandler(this,ve.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ve.ERROR,...e),this._logHandler(this,ve.ERROR,...e)}}const _I=(t,e)=>e.some(n=>t instanceof n);let Qh,Xh;function yI(){return Qh||(Qh=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function vI(){return Xh||(Xh=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Cp=new WeakMap,mc=new WeakMap,Pp=new WeakMap,Ba=new WeakMap,dl=new WeakMap;function EI(t){const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("success",i),t.removeEventListener("error",a)},i=()=>{n(Bn(t.result)),s()},a=()=>{r(t.error),s()};t.addEventListener("success",i),t.addEventListener("error",a)});return e.then(n=>{n instanceof IDBCursor&&Cp.set(n,t)}).catch(()=>{}),dl.set(e,t),e}function II(t){if(mc.has(t))return;const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("complete",i),t.removeEventListener("error",a),t.removeEventListener("abort",a)},i=()=>{n(),s()},a=()=>{r(t.error||new DOMException("AbortError","AbortError")),s()};t.addEventListener("complete",i),t.addEventListener("error",a),t.addEventListener("abort",a)});mc.set(t,e)}let gc={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return mc.get(t);if(e==="objectStoreNames")return t.objectStoreNames||Pp.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return Bn(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function TI(t){gc=t(gc)}function wI(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(ja(this),e,...n);return Pp.set(r,e.sort?e.sort():[e]),Bn(r)}:vI().includes(t)?function(...e){return t.apply(ja(this),e),Bn(Cp.get(this))}:function(...e){return Bn(t.apply(ja(this),e))}}function AI(t){return typeof t=="function"?wI(t):(t instanceof IDBTransaction&&II(t),_I(t,yI())?new Proxy(t,gc):t)}function Bn(t){if(t instanceof IDBRequest)return EI(t);if(Ba.has(t))return Ba.get(t);const e=AI(t);return e!==t&&(Ba.set(t,e),dl.set(e,t)),e}const ja=t=>dl.get(t);function bI(t,e,{blocked:n,upgrade:r,blocking:s,terminated:i}={}){const a=indexedDB.open(t,e),c=Bn(a);return r&&a.addEventListener("upgradeneeded",l=>{r(Bn(a.result),l.oldVersion,l.newVersion,Bn(a.transaction),l)}),n&&a.addEventListener("blocked",l=>n(l.oldVersion,l.newVersion,l)),c.then(l=>{i&&l.addEventListener("close",()=>i()),s&&l.addEventListener("versionchange",h=>s(h.oldVersion,h.newVersion,h))}).catch(()=>{}),c}const RI=["get","getKey","getAll","getAllKeys","count"],SI=["put","add","delete","clear"],$a=new Map;function Yh(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if($a.get(e))return $a.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,s=SI.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(s||RI.includes(n)))return;const i=async function(a,...c){const l=this.transaction(a,s?"readwrite":"readonly");let h=l.store;return r&&(h=h.index(c.shift())),(await Promise.all([h[n](...c),s&&l.done]))[0]};return $a.set(e,i),i}TI(t=>({...t,get:(e,n,r)=>Yh(e,n)||t.get(e,n,r),has:(e,n)=>!!Yh(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CI{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(PI(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function PI(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const _c="@firebase/app",Jh="0.10.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mr=new hl("@firebase/app"),NI="@firebase/app-compat",OI="@firebase/analytics-compat",kI="@firebase/analytics",DI="@firebase/app-check-compat",xI="@firebase/app-check",VI="@firebase/auth",MI="@firebase/auth-compat",LI="@firebase/database",UI="@firebase/database-compat",FI="@firebase/functions",BI="@firebase/functions-compat",jI="@firebase/installations",$I="@firebase/installations-compat",HI="@firebase/messaging",qI="@firebase/messaging-compat",GI="@firebase/performance",zI="@firebase/performance-compat",KI="@firebase/remote-config",WI="@firebase/remote-config-compat",QI="@firebase/storage",XI="@firebase/storage-compat",YI="@firebase/firestore",JI="@firebase/vertexai-preview",ZI="@firebase/firestore-compat",eT="firebase",tT="10.12.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yc="[DEFAULT]",nT={[_c]:"fire-core",[NI]:"fire-core-compat",[kI]:"fire-analytics",[OI]:"fire-analytics-compat",[xI]:"fire-app-check",[DI]:"fire-app-check-compat",[VI]:"fire-auth",[MI]:"fire-auth-compat",[LI]:"fire-rtdb",[UI]:"fire-rtdb-compat",[FI]:"fire-fn",[BI]:"fire-fn-compat",[jI]:"fire-iid",[$I]:"fire-iid-compat",[HI]:"fire-fcm",[qI]:"fire-fcm-compat",[GI]:"fire-perf",[zI]:"fire-perf-compat",[KI]:"fire-rc",[WI]:"fire-rc-compat",[QI]:"fire-gcs",[XI]:"fire-gcs-compat",[YI]:"fire-fst",[ZI]:"fire-fst-compat",[JI]:"fire-vertex","fire-js":"fire-js",[eT]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Co=new Map,rT=new Map,vc=new Map;function Zh(t,e){try{t.container.addComponent(e)}catch(n){mr.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Qr(t){const e=t.name;if(vc.has(e))return mr.debug(`There were multiple attempts to register component ${e}.`),!1;vc.set(e,t);for(const n of Co.values())Zh(n,t);for(const n of rT.values())Zh(n,t);return!0}function fl(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}function an(t){return t.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const as=tT;function Np(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:yc,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw jn.create("bad-app-name",{appName:String(s)});if(n||(n=Rp()),!n)throw jn.create("no-options");const i=Co.get(s);if(i){if(So(n,i.options)&&So(r,i.config))return i;throw jn.create("duplicate-app",{appName:s})}const a=new dI(s);for(const l of vc.values())a.addComponent(l);const c=new iT(n,r,a);return Co.set(s,c),c}function Op(t=yc){const e=Co.get(t);if(!e&&t===yc&&Rp())return Np();if(!e)throw jn.create("no-app",{appName:t});return e}function $n(t,e,n){var r;let s=(r=nT[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),a=e.match(/\s|\//);if(i||a){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&a&&c.push("and"),a&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),mr.warn(c.join(" "));return}Qr(new pr(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oT="firebase-heartbeat-database",aT=1,ni="firebase-heartbeat-store";let Ha=null;function kp(){return Ha||(Ha=bI(oT,aT,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ni)}catch(n){console.warn(n)}}}}).catch(t=>{throw jn.create("idb-open",{originalErrorMessage:t.message})})),Ha}async function cT(t){try{const n=(await kp()).transaction(ni),r=await n.objectStore(ni).get(Dp(t));return await n.done,r}catch(e){if(e instanceof yn)mr.warn(e.message);else{const n=jn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});mr.warn(n.message)}}}async function ed(t,e){try{const r=(await kp()).transaction(ni,"readwrite");await r.objectStore(ni).put(e,Dp(t)),await r.done}catch(n){if(n instanceof yn)mr.warn(n.message);else{const r=jn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});mr.warn(r.message)}}}function Dp(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lT=1024,uT=30*24*60*60*1e3;class hT{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new fT(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,n;const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=td();if(!(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null))&&!(this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(a=>a.date===i)))return this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(a=>{const c=new Date(a.date).valueOf();return Date.now()-c<=uT}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){var e;if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=td(),{heartbeatsToSend:r,unsentEntries:s}=dT(this._heartbeatsCache.heartbeats),i=Ro(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function td(){return new Date().toISOString().substring(0,10)}function dT(t,e=lT){const n=[];let r=t.slice();for(const s of t){const i=n.find(a=>a.agent===s.agent);if(i){if(i.dates.push(s.date),nd(n)>e){i.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),nd(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class fT{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return eI()?tI().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await cT(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const s=await this.read();return ed(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const s=await this.read();return ed(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function nd(t){return Ro(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pT(t){Qr(new pr("platform-logger",e=>new CI(e),"PRIVATE")),Qr(new pr("heartbeat",e=>new hT(e),"PRIVATE")),$n(_c,Jh,t),$n(_c,Jh,"esm2017"),$n("fire-js","")}pT("");var mT="firebase",gT="10.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */$n(mT,gT,"app");var rd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var lr,xp;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(w,_){function y(){}y.prototype=_.prototype,w.D=_.prototype,w.prototype=new y,w.prototype.constructor=w,w.C=function(T,A,R){for(var E=Array(arguments.length-2),rt=2;rt<arguments.length;rt++)E[rt-2]=arguments[rt];return _.prototype[A].apply(T,E)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(w,_,y){y||(y=0);var T=Array(16);if(typeof _=="string")for(var A=0;16>A;++A)T[A]=_.charCodeAt(y++)|_.charCodeAt(y++)<<8|_.charCodeAt(y++)<<16|_.charCodeAt(y++)<<24;else for(A=0;16>A;++A)T[A]=_[y++]|_[y++]<<8|_[y++]<<16|_[y++]<<24;_=w.g[0],y=w.g[1],A=w.g[2];var R=w.g[3],E=_+(R^y&(A^R))+T[0]+3614090360&4294967295;_=y+(E<<7&4294967295|E>>>25),E=R+(A^_&(y^A))+T[1]+3905402710&4294967295,R=_+(E<<12&4294967295|E>>>20),E=A+(y^R&(_^y))+T[2]+606105819&4294967295,A=R+(E<<17&4294967295|E>>>15),E=y+(_^A&(R^_))+T[3]+3250441966&4294967295,y=A+(E<<22&4294967295|E>>>10),E=_+(R^y&(A^R))+T[4]+4118548399&4294967295,_=y+(E<<7&4294967295|E>>>25),E=R+(A^_&(y^A))+T[5]+1200080426&4294967295,R=_+(E<<12&4294967295|E>>>20),E=A+(y^R&(_^y))+T[6]+2821735955&4294967295,A=R+(E<<17&4294967295|E>>>15),E=y+(_^A&(R^_))+T[7]+4249261313&4294967295,y=A+(E<<22&4294967295|E>>>10),E=_+(R^y&(A^R))+T[8]+1770035416&4294967295,_=y+(E<<7&4294967295|E>>>25),E=R+(A^_&(y^A))+T[9]+2336552879&4294967295,R=_+(E<<12&4294967295|E>>>20),E=A+(y^R&(_^y))+T[10]+4294925233&4294967295,A=R+(E<<17&4294967295|E>>>15),E=y+(_^A&(R^_))+T[11]+2304563134&4294967295,y=A+(E<<22&4294967295|E>>>10),E=_+(R^y&(A^R))+T[12]+1804603682&4294967295,_=y+(E<<7&4294967295|E>>>25),E=R+(A^_&(y^A))+T[13]+4254626195&4294967295,R=_+(E<<12&4294967295|E>>>20),E=A+(y^R&(_^y))+T[14]+2792965006&4294967295,A=R+(E<<17&4294967295|E>>>15),E=y+(_^A&(R^_))+T[15]+1236535329&4294967295,y=A+(E<<22&4294967295|E>>>10),E=_+(A^R&(y^A))+T[1]+4129170786&4294967295,_=y+(E<<5&4294967295|E>>>27),E=R+(y^A&(_^y))+T[6]+3225465664&4294967295,R=_+(E<<9&4294967295|E>>>23),E=A+(_^y&(R^_))+T[11]+643717713&4294967295,A=R+(E<<14&4294967295|E>>>18),E=y+(R^_&(A^R))+T[0]+3921069994&4294967295,y=A+(E<<20&4294967295|E>>>12),E=_+(A^R&(y^A))+T[5]+3593408605&4294967295,_=y+(E<<5&4294967295|E>>>27),E=R+(y^A&(_^y))+T[10]+38016083&4294967295,R=_+(E<<9&4294967295|E>>>23),E=A+(_^y&(R^_))+T[15]+3634488961&4294967295,A=R+(E<<14&4294967295|E>>>18),E=y+(R^_&(A^R))+T[4]+3889429448&4294967295,y=A+(E<<20&4294967295|E>>>12),E=_+(A^R&(y^A))+T[9]+568446438&4294967295,_=y+(E<<5&4294967295|E>>>27),E=R+(y^A&(_^y))+T[14]+3275163606&4294967295,R=_+(E<<9&4294967295|E>>>23),E=A+(_^y&(R^_))+T[3]+4107603335&4294967295,A=R+(E<<14&4294967295|E>>>18),E=y+(R^_&(A^R))+T[8]+1163531501&4294967295,y=A+(E<<20&4294967295|E>>>12),E=_+(A^R&(y^A))+T[13]+2850285829&4294967295,_=y+(E<<5&4294967295|E>>>27),E=R+(y^A&(_^y))+T[2]+4243563512&4294967295,R=_+(E<<9&4294967295|E>>>23),E=A+(_^y&(R^_))+T[7]+1735328473&4294967295,A=R+(E<<14&4294967295|E>>>18),E=y+(R^_&(A^R))+T[12]+2368359562&4294967295,y=A+(E<<20&4294967295|E>>>12),E=_+(y^A^R)+T[5]+4294588738&4294967295,_=y+(E<<4&4294967295|E>>>28),E=R+(_^y^A)+T[8]+2272392833&4294967295,R=_+(E<<11&4294967295|E>>>21),E=A+(R^_^y)+T[11]+1839030562&4294967295,A=R+(E<<16&4294967295|E>>>16),E=y+(A^R^_)+T[14]+4259657740&4294967295,y=A+(E<<23&4294967295|E>>>9),E=_+(y^A^R)+T[1]+2763975236&4294967295,_=y+(E<<4&4294967295|E>>>28),E=R+(_^y^A)+T[4]+1272893353&4294967295,R=_+(E<<11&4294967295|E>>>21),E=A+(R^_^y)+T[7]+4139469664&4294967295,A=R+(E<<16&4294967295|E>>>16),E=y+(A^R^_)+T[10]+3200236656&4294967295,y=A+(E<<23&4294967295|E>>>9),E=_+(y^A^R)+T[13]+681279174&4294967295,_=y+(E<<4&4294967295|E>>>28),E=R+(_^y^A)+T[0]+3936430074&4294967295,R=_+(E<<11&4294967295|E>>>21),E=A+(R^_^y)+T[3]+3572445317&4294967295,A=R+(E<<16&4294967295|E>>>16),E=y+(A^R^_)+T[6]+76029189&4294967295,y=A+(E<<23&4294967295|E>>>9),E=_+(y^A^R)+T[9]+3654602809&4294967295,_=y+(E<<4&4294967295|E>>>28),E=R+(_^y^A)+T[12]+3873151461&4294967295,R=_+(E<<11&4294967295|E>>>21),E=A+(R^_^y)+T[15]+530742520&4294967295,A=R+(E<<16&4294967295|E>>>16),E=y+(A^R^_)+T[2]+3299628645&4294967295,y=A+(E<<23&4294967295|E>>>9),E=_+(A^(y|~R))+T[0]+4096336452&4294967295,_=y+(E<<6&4294967295|E>>>26),E=R+(y^(_|~A))+T[7]+1126891415&4294967295,R=_+(E<<10&4294967295|E>>>22),E=A+(_^(R|~y))+T[14]+2878612391&4294967295,A=R+(E<<15&4294967295|E>>>17),E=y+(R^(A|~_))+T[5]+4237533241&4294967295,y=A+(E<<21&4294967295|E>>>11),E=_+(A^(y|~R))+T[12]+1700485571&4294967295,_=y+(E<<6&4294967295|E>>>26),E=R+(y^(_|~A))+T[3]+2399980690&4294967295,R=_+(E<<10&4294967295|E>>>22),E=A+(_^(R|~y))+T[10]+4293915773&4294967295,A=R+(E<<15&4294967295|E>>>17),E=y+(R^(A|~_))+T[1]+2240044497&4294967295,y=A+(E<<21&4294967295|E>>>11),E=_+(A^(y|~R))+T[8]+1873313359&4294967295,_=y+(E<<6&4294967295|E>>>26),E=R+(y^(_|~A))+T[15]+4264355552&4294967295,R=_+(E<<10&4294967295|E>>>22),E=A+(_^(R|~y))+T[6]+2734768916&4294967295,A=R+(E<<15&4294967295|E>>>17),E=y+(R^(A|~_))+T[13]+1309151649&4294967295,y=A+(E<<21&4294967295|E>>>11),E=_+(A^(y|~R))+T[4]+4149444226&4294967295,_=y+(E<<6&4294967295|E>>>26),E=R+(y^(_|~A))+T[11]+3174756917&4294967295,R=_+(E<<10&4294967295|E>>>22),E=A+(_^(R|~y))+T[2]+718787259&4294967295,A=R+(E<<15&4294967295|E>>>17),E=y+(R^(A|~_))+T[9]+3951481745&4294967295,w.g[0]=w.g[0]+_&4294967295,w.g[1]=w.g[1]+(A+(E<<21&4294967295|E>>>11))&4294967295,w.g[2]=w.g[2]+A&4294967295,w.g[3]=w.g[3]+R&4294967295}r.prototype.u=function(w,_){_===void 0&&(_=w.length);for(var y=_-this.blockSize,T=this.B,A=this.h,R=0;R<_;){if(A==0)for(;R<=y;)s(this,w,R),R+=this.blockSize;if(typeof w=="string"){for(;R<_;)if(T[A++]=w.charCodeAt(R++),A==this.blockSize){s(this,T),A=0;break}}else for(;R<_;)if(T[A++]=w[R++],A==this.blockSize){s(this,T),A=0;break}}this.h=A,this.o+=_},r.prototype.v=function(){var w=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);w[0]=128;for(var _=1;_<w.length-8;++_)w[_]=0;var y=8*this.o;for(_=w.length-8;_<w.length;++_)w[_]=y&255,y/=256;for(this.u(w),w=Array(16),_=y=0;4>_;++_)for(var T=0;32>T;T+=8)w[y++]=this.g[_]>>>T&255;return w};function i(w,_){var y=c;return Object.prototype.hasOwnProperty.call(y,w)?y[w]:y[w]=_(w)}function a(w,_){this.h=_;for(var y=[],T=!0,A=w.length-1;0<=A;A--){var R=w[A]|0;T&&R==_||(y[A]=R,T=!1)}this.g=y}var c={};function l(w){return-128<=w&&128>w?i(w,function(_){return new a([_|0],0>_?-1:0)}):new a([w|0],0>w?-1:0)}function h(w){if(isNaN(w)||!isFinite(w))return m;if(0>w)return k(h(-w));for(var _=[],y=1,T=0;w>=y;T++)_[T]=w/y|0,y*=4294967296;return new a(_,0)}function d(w,_){if(w.length==0)throw Error("number format error: empty string");if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(w.charAt(0)=="-")return k(d(w.substring(1),_));if(0<=w.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=h(Math.pow(_,8)),T=m,A=0;A<w.length;A+=8){var R=Math.min(8,w.length-A),E=parseInt(w.substring(A,A+R),_);8>R?(R=h(Math.pow(_,R)),T=T.j(R).add(h(E))):(T=T.j(y),T=T.add(h(E)))}return T}var m=l(0),g=l(1),b=l(16777216);t=a.prototype,t.m=function(){if(N(this))return-k(this).m();for(var w=0,_=1,y=0;y<this.g.length;y++){var T=this.i(y);w+=(0<=T?T:4294967296+T)*_,_*=4294967296}return w},t.toString=function(w){if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(P(this))return"0";if(N(this))return"-"+k(this).toString(w);for(var _=h(Math.pow(w,6)),y=this,T="";;){var A=z(y,_).g;y=F(y,A.j(_));var R=((0<y.g.length?y.g[0]:y.h)>>>0).toString(w);if(y=A,P(y))return R+T;for(;6>R.length;)R="0"+R;T=R+T}},t.i=function(w){return 0>w?0:w<this.g.length?this.g[w]:this.h};function P(w){if(w.h!=0)return!1;for(var _=0;_<w.g.length;_++)if(w.g[_]!=0)return!1;return!0}function N(w){return w.h==-1}t.l=function(w){return w=F(this,w),N(w)?-1:P(w)?0:1};function k(w){for(var _=w.g.length,y=[],T=0;T<_;T++)y[T]=~w.g[T];return new a(y,~w.h).add(g)}t.abs=function(){return N(this)?k(this):this},t.add=function(w){for(var _=Math.max(this.g.length,w.g.length),y=[],T=0,A=0;A<=_;A++){var R=T+(this.i(A)&65535)+(w.i(A)&65535),E=(R>>>16)+(this.i(A)>>>16)+(w.i(A)>>>16);T=E>>>16,R&=65535,E&=65535,y[A]=E<<16|R}return new a(y,y[y.length-1]&-2147483648?-1:0)};function F(w,_){return w.add(k(_))}t.j=function(w){if(P(this)||P(w))return m;if(N(this))return N(w)?k(this).j(k(w)):k(k(this).j(w));if(N(w))return k(this.j(k(w)));if(0>this.l(b)&&0>w.l(b))return h(this.m()*w.m());for(var _=this.g.length+w.g.length,y=[],T=0;T<2*_;T++)y[T]=0;for(T=0;T<this.g.length;T++)for(var A=0;A<w.g.length;A++){var R=this.i(T)>>>16,E=this.i(T)&65535,rt=w.i(A)>>>16,Ze=w.i(A)&65535;y[2*T+2*A]+=E*Ze,M(y,2*T+2*A),y[2*T+2*A+1]+=R*Ze,M(y,2*T+2*A+1),y[2*T+2*A+1]+=E*rt,M(y,2*T+2*A+1),y[2*T+2*A+2]+=R*rt,M(y,2*T+2*A+2)}for(T=0;T<_;T++)y[T]=y[2*T+1]<<16|y[2*T];for(T=_;T<2*_;T++)y[T]=0;return new a(y,0)};function M(w,_){for(;(w[_]&65535)!=w[_];)w[_+1]+=w[_]>>>16,w[_]&=65535,_++}function Q(w,_){this.g=w,this.h=_}function z(w,_){if(P(_))throw Error("division by zero");if(P(w))return new Q(m,m);if(N(w))return _=z(k(w),_),new Q(k(_.g),k(_.h));if(N(_))return _=z(w,k(_)),new Q(k(_.g),_.h);if(30<w.g.length){if(N(w)||N(_))throw Error("slowDivide_ only works with positive integers.");for(var y=g,T=_;0>=T.l(w);)y=he(y),T=he(T);var A=me(y,1),R=me(T,1);for(T=me(T,2),y=me(y,2);!P(T);){var E=R.add(T);0>=E.l(w)&&(A=A.add(y),R=E),T=me(T,1),y=me(y,1)}return _=F(w,A.j(_)),new Q(A,_)}for(A=m;0<=w.l(_);){for(y=Math.max(1,Math.floor(w.m()/_.m())),T=Math.ceil(Math.log(y)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),R=h(y),E=R.j(_);N(E)||0<E.l(w);)y-=T,R=h(y),E=R.j(_);P(R)&&(R=g),A=A.add(R),w=F(w,E)}return new Q(A,w)}t.A=function(w){return z(this,w).h},t.and=function(w){for(var _=Math.max(this.g.length,w.g.length),y=[],T=0;T<_;T++)y[T]=this.i(T)&w.i(T);return new a(y,this.h&w.h)},t.or=function(w){for(var _=Math.max(this.g.length,w.g.length),y=[],T=0;T<_;T++)y[T]=this.i(T)|w.i(T);return new a(y,this.h|w.h)},t.xor=function(w){for(var _=Math.max(this.g.length,w.g.length),y=[],T=0;T<_;T++)y[T]=this.i(T)^w.i(T);return new a(y,this.h^w.h)};function he(w){for(var _=w.g.length+1,y=[],T=0;T<_;T++)y[T]=w.i(T)<<1|w.i(T-1)>>>31;return new a(y,w.h)}function me(w,_){var y=_>>5;_%=32;for(var T=w.g.length-y,A=[],R=0;R<T;R++)A[R]=0<_?w.i(R+y)>>>_|w.i(R+y+1)<<32-_:w.i(R+y);return new a(A,w.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,xp=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=h,a.fromString=d,lr=a}).apply(typeof rd<"u"?rd:typeof self<"u"?self:typeof window<"u"?window:{});var Ki=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Vp,Mp,xs,Lp,lo,Ec,Up,Fp,Bp;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(o,u,f){return o==Array.prototype||o==Object.prototype||(o[u]=f.value),o};function n(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof Ki=="object"&&Ki];for(var u=0;u<o.length;++u){var f=o[u];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var r=n(this);function s(o,u){if(u)e:{var f=r;o=o.split(".");for(var p=0;p<o.length-1;p++){var S=o[p];if(!(S in f))break e;f=f[S]}o=o[o.length-1],p=f[o],u=u(p),u!=p&&u!=null&&e(f,o,{configurable:!0,writable:!0,value:u})}}function i(o,u){o instanceof String&&(o+="");var f=0,p=!1,S={next:function(){if(!p&&f<o.length){var O=f++;return{value:u(O,o[O]),done:!1}}return p=!0,{done:!0,value:void 0}}};return S[Symbol.iterator]=function(){return S},S}s("Array.prototype.values",function(o){return o||function(){return i(this,function(u,f){return f})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},c=this||self;function l(o){var u=typeof o;return u=u!="object"?u:o?Array.isArray(o)?"array":u:"null",u=="array"||u=="object"&&typeof o.length=="number"}function h(o){var u=typeof o;return u=="object"&&o!=null||u=="function"}function d(o,u,f){return o.call.apply(o.bind,arguments)}function m(o,u,f){if(!o)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var S=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(S,p),o.apply(u,S)}}return function(){return o.apply(u,arguments)}}function g(o,u,f){return g=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?d:m,g.apply(null,arguments)}function b(o,u){var f=Array.prototype.slice.call(arguments,1);return function(){var p=f.slice();return p.push.apply(p,arguments),o.apply(this,p)}}function P(o,u){function f(){}f.prototype=u.prototype,o.aa=u.prototype,o.prototype=new f,o.prototype.constructor=o,o.Qb=function(p,S,O){for(var H=Array(arguments.length-2),xe=2;xe<arguments.length;xe++)H[xe-2]=arguments[xe];return u.prototype[S].apply(p,H)}}function N(o){const u=o.length;if(0<u){const f=Array(u);for(let p=0;p<u;p++)f[p]=o[p];return f}return[]}function k(o,u){for(let f=1;f<arguments.length;f++){const p=arguments[f];if(l(p)){const S=o.length||0,O=p.length||0;o.length=S+O;for(let H=0;H<O;H++)o[S+H]=p[H]}else o.push(p)}}class F{constructor(u,f){this.i=u,this.j=f,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function M(o){return/^[\s\xa0]*$/.test(o)}function Q(){var o=c.navigator;return o&&(o=o.userAgent)?o:""}function z(o){return z[" "](o),o}z[" "]=function(){};var he=Q().indexOf("Gecko")!=-1&&!(Q().toLowerCase().indexOf("webkit")!=-1&&Q().indexOf("Edge")==-1)&&!(Q().indexOf("Trident")!=-1||Q().indexOf("MSIE")!=-1)&&Q().indexOf("Edge")==-1;function me(o,u,f){for(const p in o)u.call(f,o[p],p,o)}function w(o,u){for(const f in o)u.call(void 0,o[f],f,o)}function _(o){const u={};for(const f in o)u[f]=o[f];return u}const y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function T(o,u){let f,p;for(let S=1;S<arguments.length;S++){p=arguments[S];for(f in p)o[f]=p[f];for(let O=0;O<y.length;O++)f=y[O],Object.prototype.hasOwnProperty.call(p,f)&&(o[f]=p[f])}}function A(o){var u=1;o=o.split(":");const f=[];for(;0<u&&o.length;)f.push(o.shift()),u--;return o.length&&f.push(o.join(":")),f}function R(o){c.setTimeout(()=>{throw o},0)}function E(){var o=Pt;let u=null;return o.g&&(u=o.g,o.g=o.g.next,o.g||(o.h=null),u.next=null),u}class rt{constructor(){this.h=this.g=null}add(u,f){const p=Ze.get();p.set(u,f),this.h?this.h.next=p:this.g=p,this.h=p}}var Ze=new F(()=>new Ie,o=>o.reset());class Ie{constructor(){this.next=this.g=this.h=null}set(u,f){this.h=u,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let Te,_e=!1,Pt=new rt,xt=()=>{const o=c.Promise.resolve(void 0);Te=()=>{o.then(kt)}};var kt=()=>{for(var o;o=E();){try{o.h.call(o.g)}catch(f){R(f)}var u=Ze;u.j(o),100>u.h&&(u.h++,o.next=u.g,u.g=o)}_e=!1};function Fe(){this.s=this.s,this.C=this.C}Fe.prototype.s=!1,Fe.prototype.ma=function(){this.s||(this.s=!0,this.N())},Fe.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Be(o,u){this.type=o,this.g=this.target=u,this.defaultPrevented=!1}Be.prototype.h=function(){this.defaultPrevented=!0};var En=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var o=!1,u=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const f=()=>{};c.addEventListener("test",f,u),c.removeEventListener("test",f,u)}catch{}return o}();function Ht(o,u){if(Be.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o){var f=this.type=o.type,p=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;if(this.target=o.target||o.srcElement,this.g=u,u=o.relatedTarget){if(he){e:{try{z(u.nodeName);var S=!0;break e}catch{}S=!1}S||(u=null)}}else f=="mouseover"?u=o.fromElement:f=="mouseout"&&(u=o.toElement);this.relatedTarget=u,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=typeof o.pointerType=="string"?o.pointerType:et[o.pointerType]||"",this.state=o.state,this.i=o,o.defaultPrevented&&Ht.aa.h.call(this)}}P(Ht,Be);var et={2:"touch",3:"pen",4:"mouse"};Ht.prototype.h=function(){Ht.aa.h.call(this);var o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var x="closure_listenable_"+(1e6*Math.random()|0),X=0;function G(o,u,f,p,S){this.listener=o,this.proxy=null,this.src=u,this.type=f,this.capture=!!p,this.ha=S,this.key=++X,this.da=this.fa=!1}function ee(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function ye(o){this.src=o,this.g={},this.h=0}ye.prototype.add=function(o,u,f,p,S){var O=o.toString();o=this.g[O],o||(o=this.g[O]=[],this.h++);var H=I(o,u,p,S);return-1<H?(u=o[H],f||(u.fa=!1)):(u=new G(u,this.src,O,!!p,S),u.fa=f,o.push(u)),u};function v(o,u){var f=u.type;if(f in o.g){var p=o.g[f],S=Array.prototype.indexOf.call(p,u,void 0),O;(O=0<=S)&&Array.prototype.splice.call(p,S,1),O&&(ee(u),o.g[f].length==0&&(delete o.g[f],o.h--))}}function I(o,u,f,p){for(var S=0;S<o.length;++S){var O=o[S];if(!O.da&&O.listener==u&&O.capture==!!f&&O.ha==p)return S}return-1}var C="closure_lm_"+(1e6*Math.random()|0),D={};function V(o,u,f,p,S){if(p&&p.once)return $(o,u,f,p,S);if(Array.isArray(u)){for(var O=0;O<u.length;O++)V(o,u[O],f,p,S);return null}return f=pe(f),o&&o[x]?o.K(u,f,h(p)?!!p.capture:!!p,S):L(o,u,f,!1,p,S)}function L(o,u,f,p,S,O){if(!u)throw Error("Invalid event type");var H=h(S)?!!S.capture:!!S,xe=te(o);if(xe||(o[C]=xe=new ye(o)),f=xe.add(u,f,p,H,O),f.proxy)return f;if(p=K(),f.proxy=p,p.src=o,p.listener=f,o.addEventListener)En||(S=H),S===void 0&&(S=!1),o.addEventListener(u.toString(),p,S);else if(o.attachEvent)o.attachEvent(ne(u.toString()),p);else if(o.addListener&&o.removeListener)o.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return f}function K(){function o(f){return u.call(o.src,o.listener,f)}const u=Y;return o}function $(o,u,f,p,S){if(Array.isArray(u)){for(var O=0;O<u.length;O++)$(o,u[O],f,p,S);return null}return f=pe(f),o&&o[x]?o.L(u,f,h(p)?!!p.capture:!!p,S):L(o,u,f,!0,p,S)}function q(o,u,f,p,S){if(Array.isArray(u))for(var O=0;O<u.length;O++)q(o,u[O],f,p,S);else p=h(p)?!!p.capture:!!p,f=pe(f),o&&o[x]?(o=o.i,u=String(u).toString(),u in o.g&&(O=o.g[u],f=I(O,f,p,S),-1<f&&(ee(O[f]),Array.prototype.splice.call(O,f,1),O.length==0&&(delete o.g[u],o.h--)))):o&&(o=te(o))&&(u=o.g[u.toString()],o=-1,u&&(o=I(u,f,p,S)),(f=-1<o?u[o]:null)&&U(f))}function U(o){if(typeof o!="number"&&o&&!o.da){var u=o.src;if(u&&u[x])v(u.i,o);else{var f=o.type,p=o.proxy;u.removeEventListener?u.removeEventListener(f,p,o.capture):u.detachEvent?u.detachEvent(ne(f),p):u.addListener&&u.removeListener&&u.removeListener(p),(f=te(u))?(v(f,o),f.h==0&&(f.src=null,u[C]=null)):ee(o)}}}function ne(o){return o in D?D[o]:D[o]="on"+o}function Y(o,u){if(o.da)o=!0;else{u=new Ht(u,this);var f=o.listener,p=o.ha||o.src;o.fa&&U(o),o=f.call(p,u)}return o}function te(o){return o=o[C],o instanceof ye?o:null}var ie="__closure_events_fn_"+(1e9*Math.random()>>>0);function pe(o){return typeof o=="function"?o:(o[ie]||(o[ie]=function(u){return o.handleEvent(u)}),o[ie])}function le(){Fe.call(this),this.i=new ye(this),this.M=this,this.F=null}P(le,Fe),le.prototype[x]=!0,le.prototype.removeEventListener=function(o,u,f,p){q(this,o,u,f,p)};function ae(o,u){var f,p=o.F;if(p)for(f=[];p;p=p.F)f.push(p);if(o=o.M,p=u.type||u,typeof u=="string")u=new Be(u,o);else if(u instanceof Be)u.target=u.target||o;else{var S=u;u=new Be(p,o),T(u,S)}if(S=!0,f)for(var O=f.length-1;0<=O;O--){var H=u.g=f[O];S=Me(H,p,!0,u)&&S}if(H=u.g=o,S=Me(H,p,!0,u)&&S,S=Me(H,p,!1,u)&&S,f)for(O=0;O<f.length;O++)H=u.g=f[O],S=Me(H,p,!1,u)&&S}le.prototype.N=function(){if(le.aa.N.call(this),this.i){var o=this.i,u;for(u in o.g){for(var f=o.g[u],p=0;p<f.length;p++)ee(f[p]);delete o.g[u],o.h--}}this.F=null},le.prototype.K=function(o,u,f,p){return this.i.add(String(o),u,!1,f,p)},le.prototype.L=function(o,u,f,p){return this.i.add(String(o),u,!0,f,p)};function Me(o,u,f,p){if(u=o.i.g[String(u)],!u)return!0;u=u.concat();for(var S=!0,O=0;O<u.length;++O){var H=u[O];if(H&&!H.da&&H.capture==f){var xe=H.listener,st=H.ha||H.src;H.fa&&v(o.i,H),S=xe.call(st,p)!==!1&&S}}return S&&!p.defaultPrevented}function At(o,u,f){if(typeof o=="function")f&&(o=g(o,f));else if(o&&typeof o.handleEvent=="function")o=g(o.handleEvent,o);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:c.setTimeout(o,u||0)}function tn(o){o.g=At(()=>{o.g=null,o.i&&(o.i=!1,tn(o))},o.l);const u=o.h;o.h=null,o.m.apply(null,u)}class bi extends Fe{constructor(u,f){super(),this.m=u,this.l=f,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:tn(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Vt(o){Fe.call(this),this.h=o,this.g={}}P(Vt,Fe);var ps=[];function ht(o){me(o.g,function(u,f){this.g.hasOwnProperty(f)&&U(u)},o),o.g={}}Vt.prototype.N=function(){Vt.aa.N.call(this),ht(this)},Vt.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var bt=c.JSON.stringify,Ri=c.JSON.parse,Rg=class{stringify(o){return c.JSON.stringify(o,void 0)}parse(o){return c.JSON.parse(o,void 0)}};function ga(){}ga.prototype.h=null;function tu(o){return o.h||(o.h=o.i())}function nu(){}var ms={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function _a(){Be.call(this,"d")}P(_a,Be);function ya(){Be.call(this,"c")}P(ya,Be);var Xn={},ru=null;function Si(){return ru=ru||new le}Xn.La="serverreachability";function su(o){Be.call(this,Xn.La,o)}P(su,Be);function gs(o){const u=Si();ae(u,new su(u))}Xn.STAT_EVENT="statevent";function iu(o,u){Be.call(this,Xn.STAT_EVENT,o),this.stat=u}P(iu,Be);function Tt(o){const u=Si();ae(u,new iu(u,o))}Xn.Ma="timingevent";function ou(o,u){Be.call(this,Xn.Ma,o),this.size=u}P(ou,Be);function _s(o,u){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){o()},u)}function ys(){this.g=!0}ys.prototype.xa=function(){this.g=!1};function Sg(o,u,f,p,S,O){o.info(function(){if(o.g)if(O)for(var H="",xe=O.split("&"),st=0;st<xe.length;st++){var Se=xe[st].split("=");if(1<Se.length){var dt=Se[0];Se=Se[1];var ft=dt.split("_");H=2<=ft.length&&ft[1]=="type"?H+(dt+"="+Se+"&"):H+(dt+"=redacted&")}}else H=null;else H=O;return"XMLHTTP REQ ("+p+") [attempt "+S+"]: "+u+`
`+f+`
`+H})}function Cg(o,u,f,p,S,O,H){o.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+S+"]: "+u+`
`+f+`
`+O+" "+H})}function Ir(o,u,f,p){o.info(function(){return"XMLHTTP TEXT ("+u+"): "+Ng(o,f)+(p?" "+p:"")})}function Pg(o,u){o.info(function(){return"TIMEOUT: "+u})}ys.prototype.info=function(){};function Ng(o,u){if(!o.g)return u;if(!u)return null;try{var f=JSON.parse(u);if(f){for(o=0;o<f.length;o++)if(Array.isArray(f[o])){var p=f[o];if(!(2>p.length)){var S=p[1];if(Array.isArray(S)&&!(1>S.length)){var O=S[0];if(O!="noop"&&O!="stop"&&O!="close")for(var H=1;H<S.length;H++)S[H]=""}}}}return bt(f)}catch{return u}}var Ci={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},au={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},va;function Pi(){}P(Pi,ga),Pi.prototype.g=function(){return new XMLHttpRequest},Pi.prototype.i=function(){return{}},va=new Pi;function In(o,u,f,p){this.j=o,this.i=u,this.l=f,this.R=p||1,this.U=new Vt(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new cu}function cu(){this.i=null,this.g="",this.h=!1}var lu={},Ea={};function Ia(o,u,f){o.L=1,o.v=Di(nn(u)),o.m=f,o.P=!0,uu(o,null)}function uu(o,u){o.F=Date.now(),Ni(o),o.A=nn(o.v);var f=o.A,p=o.R;Array.isArray(p)||(p=[String(p)]),Au(f.i,"t",p),o.C=0,f=o.j.J,o.h=new cu,o.g=$u(o.j,f?u:null,!o.m),0<o.O&&(o.M=new bi(g(o.Y,o,o.g),o.O)),u=o.U,f=o.g,p=o.ca;var S="readystatechange";Array.isArray(S)||(S&&(ps[0]=S.toString()),S=ps);for(var O=0;O<S.length;O++){var H=V(f,S[O],p||u.handleEvent,!1,u.h||u);if(!H)break;u.g[H.key]=H}u=o.H?_(o.H):{},o.m?(o.u||(o.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.A,o.u,o.m,u)):(o.u="GET",o.g.ea(o.A,o.u,null,u)),gs(),Sg(o.i,o.u,o.A,o.l,o.R,o.m)}In.prototype.ca=function(o){o=o.target;const u=this.M;u&&rn(o)==3?u.j():this.Y(o)},In.prototype.Y=function(o){try{if(o==this.g)e:{const ft=rn(this.g);var u=this.g.Ba();const Ar=this.g.Z();if(!(3>ft)&&(ft!=3||this.g&&(this.h.h||this.g.oa()||Ou(this.g)))){this.J||ft!=4||u==7||(u==8||0>=Ar?gs(3):gs(2)),Ta(this);var f=this.g.Z();this.X=f;t:if(hu(this)){var p=Ou(this.g);o="";var S=p.length,O=rn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Yn(this),vs(this);var H="";break t}this.h.i=new c.TextDecoder}for(u=0;u<S;u++)this.h.h=!0,o+=this.h.i.decode(p[u],{stream:!(O&&u==S-1)});p.length=0,this.h.g+=o,this.C=0,H=this.h.g}else H=this.g.oa();if(this.o=f==200,Cg(this.i,this.u,this.A,this.l,this.R,ft,f),this.o){if(this.T&&!this.K){t:{if(this.g){var xe,st=this.g;if((xe=st.g?st.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!M(xe)){var Se=xe;break t}}Se=null}if(f=Se)Ir(this.i,this.l,f,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,wa(this,f);else{this.o=!1,this.s=3,Tt(12),Yn(this),vs(this);break e}}if(this.P){f=!0;let Mt;for(;!this.J&&this.C<H.length;)if(Mt=Og(this,H),Mt==Ea){ft==4&&(this.s=4,Tt(14),f=!1),Ir(this.i,this.l,null,"[Incomplete Response]");break}else if(Mt==lu){this.s=4,Tt(15),Ir(this.i,this.l,H,"[Invalid Chunk]"),f=!1;break}else Ir(this.i,this.l,Mt,null),wa(this,Mt);if(hu(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ft!=4||H.length!=0||this.h.h||(this.s=1,Tt(16),f=!1),this.o=this.o&&f,!f)Ir(this.i,this.l,H,"[Invalid Chunked Response]"),Yn(this),vs(this);else if(0<H.length&&!this.W){this.W=!0;var dt=this.j;dt.g==this&&dt.ba&&!dt.M&&(dt.j.info("Great, no buffering proxy detected. Bytes received: "+H.length),Pa(dt),dt.M=!0,Tt(11))}}else Ir(this.i,this.l,H,null),wa(this,H);ft==4&&Yn(this),this.o&&!this.J&&(ft==4?Uu(this.j,this):(this.o=!1,Ni(this)))}else Wg(this.g),f==400&&0<H.indexOf("Unknown SID")?(this.s=3,Tt(12)):(this.s=0,Tt(13)),Yn(this),vs(this)}}}catch{}finally{}};function hu(o){return o.g?o.u=="GET"&&o.L!=2&&o.j.Ca:!1}function Og(o,u){var f=o.C,p=u.indexOf(`
`,f);return p==-1?Ea:(f=Number(u.substring(f,p)),isNaN(f)?lu:(p+=1,p+f>u.length?Ea:(u=u.slice(p,p+f),o.C=p+f,u)))}In.prototype.cancel=function(){this.J=!0,Yn(this)};function Ni(o){o.S=Date.now()+o.I,du(o,o.I)}function du(o,u){if(o.B!=null)throw Error("WatchDog timer not null");o.B=_s(g(o.ba,o),u)}function Ta(o){o.B&&(c.clearTimeout(o.B),o.B=null)}In.prototype.ba=function(){this.B=null;const o=Date.now();0<=o-this.S?(Pg(this.i,this.A),this.L!=2&&(gs(),Tt(17)),Yn(this),this.s=2,vs(this)):du(this,this.S-o)};function vs(o){o.j.G==0||o.J||Uu(o.j,o)}function Yn(o){Ta(o);var u=o.M;u&&typeof u.ma=="function"&&u.ma(),o.M=null,ht(o.U),o.g&&(u=o.g,o.g=null,u.abort(),u.ma())}function wa(o,u){try{var f=o.j;if(f.G!=0&&(f.g==o||Aa(f.h,o))){if(!o.K&&Aa(f.h,o)&&f.G==3){try{var p=f.Da.g.parse(u)}catch{p=null}if(Array.isArray(p)&&p.length==3){var S=p;if(S[0]==0){e:if(!f.u){if(f.g)if(f.g.F+3e3<o.F)Ui(f),Mi(f);else break e;Ca(f),Tt(18)}}else f.za=S[1],0<f.za-f.T&&37500>S[2]&&f.F&&f.v==0&&!f.C&&(f.C=_s(g(f.Za,f),6e3));if(1>=mu(f.h)&&f.ca){try{f.ca()}catch{}f.ca=void 0}}else Zn(f,11)}else if((o.K||f.g==o)&&Ui(f),!M(u))for(S=f.Da.g.parse(u),u=0;u<S.length;u++){let Se=S[u];if(f.T=Se[0],Se=Se[1],f.G==2)if(Se[0]=="c"){f.K=Se[1],f.ia=Se[2];const dt=Se[3];dt!=null&&(f.la=dt,f.j.info("VER="+f.la));const ft=Se[4];ft!=null&&(f.Aa=ft,f.j.info("SVER="+f.Aa));const Ar=Se[5];Ar!=null&&typeof Ar=="number"&&0<Ar&&(p=1.5*Ar,f.L=p,f.j.info("backChannelRequestTimeoutMs_="+p)),p=f;const Mt=o.g;if(Mt){const Bi=Mt.g?Mt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Bi){var O=p.h;O.g||Bi.indexOf("spdy")==-1&&Bi.indexOf("quic")==-1&&Bi.indexOf("h2")==-1||(O.j=O.l,O.g=new Set,O.h&&(ba(O,O.h),O.h=null))}if(p.D){const Na=Mt.g?Mt.g.getResponseHeader("X-HTTP-Session-Id"):null;Na&&(p.ya=Na,Le(p.I,p.D,Na))}}f.G=3,f.l&&f.l.ua(),f.ba&&(f.R=Date.now()-o.F,f.j.info("Handshake RTT: "+f.R+"ms")),p=f;var H=o;if(p.qa=ju(p,p.J?p.ia:null,p.W),H.K){gu(p.h,H);var xe=H,st=p.L;st&&(xe.I=st),xe.B&&(Ta(xe),Ni(xe)),p.g=H}else Mu(p);0<f.i.length&&Li(f)}else Se[0]!="stop"&&Se[0]!="close"||Zn(f,7);else f.G==3&&(Se[0]=="stop"||Se[0]=="close"?Se[0]=="stop"?Zn(f,7):Sa(f):Se[0]!="noop"&&f.l&&f.l.ta(Se),f.v=0)}}gs(4)}catch{}}var kg=class{constructor(o,u){this.g=o,this.map=u}};function fu(o){this.l=o||10,c.PerformanceNavigationTiming?(o=c.performance.getEntriesByType("navigation"),o=0<o.length&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function pu(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function mu(o){return o.h?1:o.g?o.g.size:0}function Aa(o,u){return o.h?o.h==u:o.g?o.g.has(u):!1}function ba(o,u){o.g?o.g.add(u):o.h=u}function gu(o,u){o.h&&o.h==u?o.h=null:o.g&&o.g.has(u)&&o.g.delete(u)}fu.prototype.cancel=function(){if(this.i=_u(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function _u(o){if(o.h!=null)return o.i.concat(o.h.D);if(o.g!=null&&o.g.size!==0){let u=o.i;for(const f of o.g.values())u=u.concat(f.D);return u}return N(o.i)}function Dg(o){if(o.V&&typeof o.V=="function")return o.V();if(typeof Map<"u"&&o instanceof Map||typeof Set<"u"&&o instanceof Set)return Array.from(o.values());if(typeof o=="string")return o.split("");if(l(o)){for(var u=[],f=o.length,p=0;p<f;p++)u.push(o[p]);return u}u=[],f=0;for(p in o)u[f++]=o[p];return u}function xg(o){if(o.na&&typeof o.na=="function")return o.na();if(!o.V||typeof o.V!="function"){if(typeof Map<"u"&&o instanceof Map)return Array.from(o.keys());if(!(typeof Set<"u"&&o instanceof Set)){if(l(o)||typeof o=="string"){var u=[];o=o.length;for(var f=0;f<o;f++)u.push(f);return u}u=[],f=0;for(const p in o)u[f++]=p;return u}}}function yu(o,u){if(o.forEach&&typeof o.forEach=="function")o.forEach(u,void 0);else if(l(o)||typeof o=="string")Array.prototype.forEach.call(o,u,void 0);else for(var f=xg(o),p=Dg(o),S=p.length,O=0;O<S;O++)u.call(void 0,p[O],f&&f[O],o)}var vu=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Vg(o,u){if(o){o=o.split("&");for(var f=0;f<o.length;f++){var p=o[f].indexOf("="),S=null;if(0<=p){var O=o[f].substring(0,p);S=o[f].substring(p+1)}else O=o[f];u(O,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function Jn(o){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,o instanceof Jn){this.h=o.h,Oi(this,o.j),this.o=o.o,this.g=o.g,ki(this,o.s),this.l=o.l;var u=o.i,f=new Ts;f.i=u.i,u.g&&(f.g=new Map(u.g),f.h=u.h),Eu(this,f),this.m=o.m}else o&&(u=String(o).match(vu))?(this.h=!1,Oi(this,u[1]||"",!0),this.o=Es(u[2]||""),this.g=Es(u[3]||"",!0),ki(this,u[4]),this.l=Es(u[5]||"",!0),Eu(this,u[6]||"",!0),this.m=Es(u[7]||"")):(this.h=!1,this.i=new Ts(null,this.h))}Jn.prototype.toString=function(){var o=[],u=this.j;u&&o.push(Is(u,Iu,!0),":");var f=this.g;return(f||u=="file")&&(o.push("//"),(u=this.o)&&o.push(Is(u,Iu,!0),"@"),o.push(encodeURIComponent(String(f)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),f=this.s,f!=null&&o.push(":",String(f))),(f=this.l)&&(this.g&&f.charAt(0)!="/"&&o.push("/"),o.push(Is(f,f.charAt(0)=="/"?Ug:Lg,!0))),(f=this.i.toString())&&o.push("?",f),(f=this.m)&&o.push("#",Is(f,Bg)),o.join("")};function nn(o){return new Jn(o)}function Oi(o,u,f){o.j=f?Es(u,!0):u,o.j&&(o.j=o.j.replace(/:$/,""))}function ki(o,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);o.s=u}else o.s=null}function Eu(o,u,f){u instanceof Ts?(o.i=u,jg(o.i,o.h)):(f||(u=Is(u,Fg)),o.i=new Ts(u,o.h))}function Le(o,u,f){o.i.set(u,f)}function Di(o){return Le(o,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),o}function Es(o,u){return o?u?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function Is(o,u,f){return typeof o=="string"?(o=encodeURI(o).replace(u,Mg),f&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function Mg(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var Iu=/[#\/\?@]/g,Lg=/[#\?:]/g,Ug=/[#\?]/g,Fg=/[#\?@]/g,Bg=/#/g;function Ts(o,u){this.h=this.g=null,this.i=o||null,this.j=!!u}function Tn(o){o.g||(o.g=new Map,o.h=0,o.i&&Vg(o.i,function(u,f){o.add(decodeURIComponent(u.replace(/\+/g," ")),f)}))}t=Ts.prototype,t.add=function(o,u){Tn(this),this.i=null,o=Tr(this,o);var f=this.g.get(o);return f||this.g.set(o,f=[]),f.push(u),this.h+=1,this};function Tu(o,u){Tn(o),u=Tr(o,u),o.g.has(u)&&(o.i=null,o.h-=o.g.get(u).length,o.g.delete(u))}function wu(o,u){return Tn(o),u=Tr(o,u),o.g.has(u)}t.forEach=function(o,u){Tn(this),this.g.forEach(function(f,p){f.forEach(function(S){o.call(u,S,p,this)},this)},this)},t.na=function(){Tn(this);const o=Array.from(this.g.values()),u=Array.from(this.g.keys()),f=[];for(let p=0;p<u.length;p++){const S=o[p];for(let O=0;O<S.length;O++)f.push(u[p])}return f},t.V=function(o){Tn(this);let u=[];if(typeof o=="string")wu(this,o)&&(u=u.concat(this.g.get(Tr(this,o))));else{o=Array.from(this.g.values());for(let f=0;f<o.length;f++)u=u.concat(o[f])}return u},t.set=function(o,u){return Tn(this),this.i=null,o=Tr(this,o),wu(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[u]),this.h+=1,this},t.get=function(o,u){return o?(o=this.V(o),0<o.length?String(o[0]):u):u};function Au(o,u,f){Tu(o,u),0<f.length&&(o.i=null,o.g.set(Tr(o,u),N(f)),o.h+=f.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],u=Array.from(this.g.keys());for(var f=0;f<u.length;f++){var p=u[f];const O=encodeURIComponent(String(p)),H=this.V(p);for(p=0;p<H.length;p++){var S=O;H[p]!==""&&(S+="="+encodeURIComponent(String(H[p]))),o.push(S)}}return this.i=o.join("&")};function Tr(o,u){return u=String(u),o.j&&(u=u.toLowerCase()),u}function jg(o,u){u&&!o.j&&(Tn(o),o.i=null,o.g.forEach(function(f,p){var S=p.toLowerCase();p!=S&&(Tu(this,p),Au(this,S,f))},o)),o.j=u}function $g(o,u){const f=new ys;if(c.Image){const p=new Image;p.onload=b(wn,f,"TestLoadImage: loaded",!0,u,p),p.onerror=b(wn,f,"TestLoadImage: error",!1,u,p),p.onabort=b(wn,f,"TestLoadImage: abort",!1,u,p),p.ontimeout=b(wn,f,"TestLoadImage: timeout",!1,u,p),c.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=o}else u(!1)}function Hg(o,u){const f=new ys,p=new AbortController,S=setTimeout(()=>{p.abort(),wn(f,"TestPingServer: timeout",!1,u)},1e4);fetch(o,{signal:p.signal}).then(O=>{clearTimeout(S),O.ok?wn(f,"TestPingServer: ok",!0,u):wn(f,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(S),wn(f,"TestPingServer: error",!1,u)})}function wn(o,u,f,p,S){try{S&&(S.onload=null,S.onerror=null,S.onabort=null,S.ontimeout=null),p(f)}catch{}}function qg(){this.g=new Rg}function Gg(o,u,f){const p=f||"";try{yu(o,function(S,O){let H=S;h(S)&&(H=bt(S)),u.push(p+O+"="+encodeURIComponent(H))})}catch(S){throw u.push(p+"type="+encodeURIComponent("_badmap")),S}}function ws(o){this.l=o.Ub||null,this.j=o.eb||!1}P(ws,ga),ws.prototype.g=function(){return new xi(this.l,this.j)},ws.prototype.i=function(o){return function(){return o}}({});function xi(o,u){le.call(this),this.D=o,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}P(xi,le),t=xi.prototype,t.open=function(o,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=o,this.A=u,this.readyState=1,bs(this)},t.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};o&&(u.body=o),(this.D||c).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,As(this)),this.readyState=0},t.Sa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,bs(this)),this.g&&(this.readyState=3,bs(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;bu(this)}else o.text().then(this.Ra.bind(this),this.ga.bind(this))};function bu(o){o.j.read().then(o.Pa.bind(o)).catch(o.ga.bind(o))}t.Pa=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var u=o.value?o.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!o.done}))&&(this.response=this.responseText+=u)}o.done?As(this):bs(this),this.readyState==3&&bu(this)}},t.Ra=function(o){this.g&&(this.response=this.responseText=o,As(this))},t.Qa=function(o){this.g&&(this.response=o,As(this))},t.ga=function(){this.g&&As(this)};function As(o){o.readyState=4,o.l=null,o.j=null,o.v=null,bs(o)}t.setRequestHeader=function(o,u){this.u.append(o,u)},t.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],u=this.h.entries();for(var f=u.next();!f.done;)f=f.value,o.push(f[0]+": "+f[1]),f=u.next();return o.join(`\r
...
`}),u}function Ra(o,u,f){e:{for(p in f){var p=!1;break e}p=!0}p||(f=Ru(f),typeof o=="string"?f!=null&&encodeURIComponent(String(f)):Le(o,u,f))}function $e(o){le.call(this),this.headers=new Map,this.o=o||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}P($e,le);var zg=/^https?$/i,Kg=["POST","PUT"];t=$e.prototype,t.Ha=function(o){this.J=o},t.ea=function(o,u,f,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);u=u?u.toUpperCase():"GET",this.D=o,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():va.g(),this.v=this.o?tu(this.o):tu(va),this.g.onreadystatechange=g(this.Ea,this);try{this.B=!0,this.g.open(u,String(o),!0),this.B=!1}catch(O){Su(this,O);return}if(o=f||"",f=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var S in p)f.set(S,p[S]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const O of p.keys())f.set(O,p.get(O));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(f.keys()).find(O=>O.toLowerCase()=="content-type"),S=c.FormData&&o instanceof c.FormData,!(0<=Array.prototype.indexOf.call(Kg,u,void 0))||p||S||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[O,H]of f)this.g.setRequestHeader(O,H);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Nu(this),this.u=!0,this.g.send(o),this.u=!1}catch(O){Su(this,O)}};function Su(o,u){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=u,o.m=5,Cu(o),Vi(o)}function Cu(o){o.A||(o.A=!0,ae(o,"complete"),ae(o,"error"))}t.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=o||7,ae(this,"complete"),ae(this,"abort"),Vi(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Vi(this,!0)),$e.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?Pu(this):this.bb())},t.bb=function(){Pu(this)};function Pu(o){if(o.h&&typeof a<"u"&&(!o.v[1]||rn(o)!=4||o.Z()!=2)){if(o.u&&rn(o)==4)At(o.Ea,0,o);else if(ae(o,"readystatechange"),rn(o)==4){o.h=!1;try{const H=o.Z();e:switch(H){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var f;if(!(f=u)){var p;if(p=H===0){var S=String(o.D).match(vu)[1]||null;!S&&c.self&&c.self.location&&(S=c.self.location.protocol.slice(0,-1)),p=!zg.test(S?S.toLowerCase():"")}f=p}if(f)ae(o,"complete"),ae(o,"success");else{o.m=6;try{var O=2<rn(o)?o.g.statusText:""}catch{O=""}o.l=O+" ["+o.Z()+"]",Cu(o)}}finally{Vi(o)}}}}function Vi(o,u){if(o.g){Nu(o);const f=o.g,p=o.v[0]?()=>{}:null;o.g=null,o.v=null,u||ae(o,"ready");try{f.onreadystatechange=p}catch{}}}function Nu(o){o.I&&(c.clearTimeout(o.I),o.I=null)}t.isActive=function(){return!!this.g};function rn(o){return o.g?o.g.readyState:0}t.Z=function(){try{return 2<rn(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(o){if(this.g){var u=this.g.responseText;return o&&u.indexOf(o)==0&&(u=u.substring(o.length)),Ri(u)}};function Ou(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.H){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function Wg(o){const u={};o=(o.g&&2<=rn(o)&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<o.length;p++){if(M(o[p]))continue;var f=A(o[p]);const S=f[0];if(f=f[1],typeof f!="string")continue;f=f.trim();const O=u[S]||[];u[S]=O,O.push(f)}w(u,function(p){return p.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Rs(o,u,f){return f&&f.internalChannelParams&&f.internalChannelParams[o]||u}function ku(o){this.Aa=0,this.i=[],this.j=new ys,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Rs("failFast",!1,o),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Rs("baseRetryDelayMs",5e3,o),this.cb=Rs("retryDelaySeedMs",1e4,o),this.Wa=Rs("forwardChannelMaxRetries",2,o),this.wa=Rs("forwardChannelRequestTimeoutMs",2e4,o),this.pa=o&&o.xmlHttpFactory||void 0,this.Xa=o&&o.Tb||void 0,this.Ca=o&&o.useFetchStreams||!1,this.L=void 0,this.J=o&&o.supportsCrossDomainXhr||!1,this.K="",this.h=new fu(o&&o.concurrentRequestLimit),this.Da=new qg,this.P=o&&o.fastHandshake||!1,this.O=o&&o.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=o&&o.Rb||!1,o&&o.xa&&this.j.xa(),o&&o.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&o&&o.detectBufferingProxy||!1,this.ja=void 0,o&&o.longPollingTimeout&&0<o.longPollingTimeout&&(this.ja=o.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=ku.prototype,t.la=8,t.G=1,t.connect=function(o,u,f,p){Tt(0),this.W=o,this.H=u||{},f&&p!==void 0&&(this.H.OSID=f,this.H.OAID=p),this.F=this.X,this.I=ju(this,null,this.W),Li(this)};function Sa(o){if(Du(o),o.G==3){var u=o.U++,f=nn(o.I);if(Le(f,"SID",o.K),Le(f,"RID",u),Le(f,"TYPE","terminate"),Ss(o,f),u=new In(o,o.j,u),u.L=2,u.v=Di(nn(f)),f=!1,c.navigator&&c.navigator.sendBeacon)try{f=c.navigator.sendBeacon(u.v.toString(),"")}catch{}!f&&c.Image&&(new Image().src=u.v,f=!0),f||(u.g=$u(u.j,null),u.g.ea(u.v)),u.F=Date.now(),Ni(u)}Bu(o)}function Mi(o){o.g&&(Pa(o),o.g.cancel(),o.g=null)}function Du(o){Mi(o),o.u&&(c.clearTimeout(o.u),o.u=null),Ui(o),o.h.cancel(),o.s&&(typeof o.s=="number"&&c.clearTimeout(o.s),o.s=null)}function Li(o){if(!pu(o.h)&&!o.s){o.s=!0;var u=o.Ga;Te||xt(),_e||(Te(),_e=!0),Pt.add(u,o),o.B=0}}function Qg(o,u){return mu(o.h)>=o.h.j-(o.s?1:0)?!1:o.s?(o.i=u.D.concat(o.i),!0):o.G==1||o.G==2||o.B>=(o.Va?0:o.Wa)?!1:(o.s=_s(g(o.Ga,o,u),Fu(o,o.B)),o.B++,!0)}t.Ga=function(o){if(this.s)if(this.s=null,this.G==1){if(!o){this.U=Math.floor(1e5*Math.random()),o=this.U++;const S=new In(this,this.j,o);let O=this.o;if(this.S&&(O?(O=_(O),T(O,this.S)):O=this.S),this.m!==null||this.O||(S.H=O,O=null),this.P)e:{for(var u=0,f=0;f<this.i.length;f++){t:{var p=this.i[f];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(u+=p,4096<u){u=f;break e}if(u===4096||f===this.i.length-1){u=f+1;break e}}u=1e3}else u=1e3;u=Vu(this,S,u),f=nn(this.I),Le(f,"RID",o),Le(f,"CVER",22),this.D&&Le(f,"X-HTTP-Session-Id",this.D),Ss(this,f),O&&(this.O?u="headers="+encodeURIComponent(String(Ru(O)))+"&"+u:this.m&&Ra(f,this.m,O)),ba(this.h,S),this.Ua&&Le(f,"TYPE","init"),this.P?(Le(f,"$req",u),Le(f,"SID","null"),S.T=!0,Ia(S,f,null)):Ia(S,f,u),this.G=2}}else this.G==3&&(o?xu(this,o):this.i.length==0||pu(this.h)||xu(this))};function xu(o,u){var f;u?f=u.l:f=o.U++;const p=nn(o.I);Le(p,"SID",o.K),Le(p,"RID",f),Le(p,"AID",o.T),Ss(o,p),o.m&&o.o&&Ra(p,o.m,o.o),f=new In(o,o.j,f,o.B+1),o.m===null&&(f.H=o.o),u&&(o.i=u.D.concat(o.i)),u=Vu(o,f,1e3),f.I=Math.round(.5*o.wa)+Math.round(.5*o.wa*Math.random()),ba(o.h,f),Ia(f,p,u)}function Ss(o,u){o.H&&me(o.H,function(f,p){Le(u,p,f)}),o.l&&yu({},function(f,p){Le(u,p,f)})}function Vu(o,u,f){f=Math.min(o.i.length,f);var p=o.l?g(o.l.Na,o.l,o):null;e:{var S=o.i;let O=-1;for(;;){const H=["count="+f];O==-1?0<f?(O=S[0].g,H.push("ofs="+O)):O=0:H.push("ofs="+O);let xe=!0;for(let st=0;st<f;st++){let Se=S[st].g;const dt=S[st].map;if(Se-=O,0>Se)O=Math.max(0,S[st].g-100),xe=!1;else try{Gg(dt,H,"req"+Se+"_")}catch{p&&p(dt)}}if(xe){p=H.join("&");break e}}}return o=o.i.splice(0,f),u.D=o,p}function Mu(o){if(!o.g&&!o.u){o.Y=1;var u=o.Fa;Te||xt(),_e||(Te(),_e=!0),Pt.add(u,o),o.v=0}}function Ca(o){return o.g||o.u||3<=o.v?!1:(o.Y++,o.u=_s(g(o.Fa,o),Fu(o,o.v)),o.v++,!0)}t.Fa=function(){if(this.u=null,Lu(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var o=2*this.R;this.j.info("BP detection timer enabled: "+o),this.A=_s(g(this.ab,this),o)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Tt(10),Mi(this),Lu(this))};function Pa(o){o.A!=null&&(c.clearTimeout(o.A),o.A=null)}function Lu(o){o.g=new In(o,o.j,"rpc",o.Y),o.m===null&&(o.g.H=o.o),o.g.O=0;var u=nn(o.qa);Le(u,"RID","rpc"),Le(u,"SID",o.K),Le(u,"AID",o.T),Le(u,"CI",o.F?"0":"1"),!o.F&&o.ja&&Le(u,"TO",o.ja),Le(u,"TYPE","xmlhttp"),Ss(o,u),o.m&&o.o&&Ra(u,o.m,o.o),o.L&&(o.g.I=o.L);var f=o.g;o=o.ia,f.L=1,f.v=Di(nn(u)),f.m=null,f.P=!0,uu(f,o)}t.Za=function(){this.C!=null&&(this.C=null,Mi(this),Ca(this),Tt(19))};function Ui(o){o.C!=null&&(c.clearTimeout(o.C),o.C=null)}function Uu(o,u){var f=null;if(o.g==u){Ui(o),Pa(o),o.g=null;var p=2}else if(Aa(o.h,u))f=u.D,gu(o.h,u),p=1;else return;if(o.G!=0){if(u.o)if(p==1){f=u.m?u.m.length:0,u=Date.now()-u.F;var S=o.B;p=Si(),ae(p,new ou(p,f)),Li(o)}else Mu(o);else if(S=u.s,S==3||S==0&&0<u.X||!(p==1&&Qg(o,u)||p==2&&Ca(o)))switch(f&&0<f.length&&(u=o.h,u.i=u.i.concat(f)),S){case 1:Zn(o,5);break;case 4:Zn(o,10);break;case 3:Zn(o,6);break;default:Zn(o,2)}}}function Fu(o,u){let f=o.Ta+Math.floor(Math.random()*o.cb);return o.isActive()||(f*=2),f*u}function Zn(o,u){if(o.j.info("Error code "+u),u==2){var f=g(o.fb,o),p=o.Xa;const S=!p;p=new Jn(p||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Oi(p,"https"),Di(p),S?$g(p.toString(),f):Hg(p.toString(),f)}else Tt(2);o.G=0,o.l&&o.l.sa(u),Bu(o),Du(o)}t.fb=function(o){o?(this.j.info("Successfully pinged google.com"),Tt(2)):(this.j.info("Failed to ping google.com"),Tt(1))};function Bu(o){if(o.G=0,o.ka=[],o.l){const u=_u(o.h);(u.length!=0||o.i.length!=0)&&(k(o.ka,u),k(o.ka,o.i),o.h.i.length=0,N(o.i),o.i.length=0),o.l.ra()}}function ju(o,u,f){var p=f instanceof Jn?nn(f):new Jn(f);if(p.g!="")u&&(p.g=u+"."+p.g),ki(p,p.s);else{var S=c.location;p=S.protocol,u=u?u+"."+S.hostname:S.hostname,S=+S.port;var O=new Jn(null);p&&Oi(O,p),u&&(O.g=u),S&&ki(O,S),f&&(O.l=f),p=O}return f=o.D,u=o.ya,f&&u&&Le(p,f,u),Le(p,"VER",o.la),Ss(o,p),p}function $u(o,u,f){if(u&&!o.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=o.Ca&&!o.pa?new $e(new ws({eb:f})):new $e(o.pa),u.Ha(o.J),u}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function Hu(){}t=Hu.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Fi(){}Fi.prototype.g=function(o,u){return new Nt(o,u)};function Nt(o,u){le.call(this),this.g=new ku(u),this.l=o,this.h=u&&u.messageUrlParams||null,o=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(o?o["X-WebChannel-Content-Type"]=u.messageContentType:o={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(o?o["X-WebChannel-Client-Profile"]=u.va:o={"X-WebChannel-Client-Profile":u.va}),this.g.S=o,(o=u&&u.Sb)&&!M(o)&&(this.g.m=o),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!M(u)&&(this.g.D=u,o=this.h,o!==null&&u in o&&(o=this.h,u in o&&delete o[u])),this.j=new wr(this)}P(Nt,le),Nt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Nt.prototype.close=function(){Sa(this.g)},Nt.prototype.o=function(o){var u=this.g;if(typeof o=="string"){var f={};f.__data__=o,o=f}else this.u&&(f={},f.__data__=bt(o),o=f);u.i.push(new kg(u.Ya++,o)),u.G==3&&Li(u)},Nt.prototype.N=function(){this.g.l=null,delete this.j,Sa(this.g),delete this.g,Nt.aa.N.call(this)};function qu(o){_a.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var u=o.__sm__;if(u){e:{for(const f in u){o=f;break e}o=void 0}(this.i=o)&&(o=this.i,u=u!==null&&o in u?u[o]:void 0),this.data=u}else this.data=o}P(qu,_a);function Gu(){ya.call(this),this.status=1}P(Gu,ya);function wr(o){this.g=o}P(wr,Hu),wr.prototype.ua=function(){ae(this.g,"a")},wr.prototype.ta=function(o){ae(this.g,new qu(o))},wr.prototype.sa=function(o){ae(this.g,new Gu)},wr.prototype.ra=function(){ae(this.g,"b")},Fi.prototype.createWebChannel=Fi.prototype.g,Nt.prototype.send=Nt.prototype.o,Nt.prototype.open=Nt.prototype.m,Nt.prototype.close=Nt.prototype.close,Bp=function(){return new Fi},Fp=function(){return Si()},Up=Xn,Ec={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Ci.NO_ERROR=0,Ci.TIMEOUT=8,Ci.HTTP_ERROR=6,lo=Ci,au.COMPLETE="complete",Lp=au,nu.EventType=ms,ms.OPEN="a",ms.CLOSE="b",ms.ERROR="c",ms.MESSAGE="d",le.prototype.listen=le.prototype.K,xs=nu,Mp=ws,$e.prototype.listenOnce=$e.prototype.L,$e.prototype.getLastError=$e.prototype.Ka,$e.prototype.getLastErrorCode=$e.prototype.Ba,$e.prototype.getStatus=$e.prototype.Z,$e.prototype.getResponseJson=$e.prototype.Oa,$e.prototype.getResponseText=$e.prototype.oa,$e.prototype.send=$e.prototype.ea,$e.prototype.setWithCredentials=$e.prototype.Ha,Vp=$e}).apply(typeof Ki<"u"?Ki:typeof self<"u"?self:typeof window<"u"?window:{});const sd="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gr=new hl("@firebase/firestore");function Os(){return gr.logLevel}function Z(t,...e){if(gr.logLevel<=ve.DEBUG){const n=e.map(pl);gr.debug(`Firestore (${cs}): ${t}`,...n)}}function pn(t,...e){if(gr.logLevel<=ve.ERROR){const n=e.map(pl);gr.error(`Firestore (${cs}): ${t}`,...n)}}function Xr(t,...e){if(gr.logLevel<=ve.WARN){const n=e.map(pl);gr.warn(`Firestore (${cs}): ${t}`,...n)}}function pl(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jp{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class _T{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(mt.UNAUTHENTICATED))}shutdown(){}}class yT{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class vT{constructor(e){this.t=e,this.currentUser=mt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let r=this.i;const s=l=>this.i!==r?(r=this.i,n(l)):Promise.resolve();let i=new ur;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new ur,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const l=i;e.enqueueRetryable(async()=>{await l.promise,await s(this.currentUser)})},c=l=>{Z("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),a()};this.t.onInit(l=>c(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?c(l):(Z("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new ur)}},0),a()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(Z("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Qe(typeof r.accessToken=="string"),new jp(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return Qe(e===null||typeof e=="string"),new mt(e)}}class ET{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=mt.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class IT{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new ET(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(mt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class TT{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class wT{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,n){const r=i=>{i.error!=null&&Z("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.R;return this.R=i.token,Z("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?n(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{Z("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?s(i):Z("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(Qe(typeof n.token=="string"),this.R=n.token,new TT(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ml(t){if(t.code!==j.FAILED_PRECONDITION||t.message!==NT)throw t;Z("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gl{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.ie(r),this.se=r=>n.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}gl.oe=-1;function ea(t){return t==null}function Po(t){return t===0&&1/t==-1/0}function DT(t){return typeof t=="number"&&Number.isInteger(t)&&!Po(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new Hp("Invalid base64 string: "+i):i}}(e);return new It(n)}static fromUint8Array(e){const n=function(s){let i="";for(let a=0;a<s.length;++a)i+=String.fromCharCode(s[a]);return i}(e);return new It(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let s=0;s<n.length;s++)r[s]=n.charCodeAt(s);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Ne(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}It.EMPTY_BYTE_STRING=new It("");const xT=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function zn(t){if(Qe(!!t),typeof t=="string"){let e=0;const n=xT.exec(t);if(Qe(!!n),n[1]){let s=n[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Ke(t.seconds),nanos:Ke(t.nanos)}}function Ke(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function _r(t){return typeof t=="string"?It.fromBase64String(t):It.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _l(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function yl(t){const e=t.mapValue.fields.__previous_value__;return _l(e)?yl(e):e}function si(t){const e=zn(t.mapValue.fields.__local_write_time__.timestampValue);return new nt(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ai{constructor(e,n="asc"){this.field=e,this.dir=n}}function LT(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qp{}class We extends qp{constructor(e,n,r){super(),this.field=e,this.op=n,this.value=r}static create(e,n,r){return e.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(e,n,r):new FT(e,n,r):n==="array-contains"?new $T(e,r):n==="in"?new HT(e,r):n==="not-in"?new qT(e,r):n==="array-contains-any"?new GT(e,r):new We(e,n,r)}static createKeyFieldInFilter(e,n,r){return n==="in"?new BT(e,r):new jT(e,r)}matches(e){const n=e.data.field(this.field);return this.op==="!="?n!==null&&this.matchesComparison(Jr(n,this.value)):n!==null&&yr(this.value)===yr(n)&&this.matchesComparison(Jr(n,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return de()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class $t extends qp{constructor(e,n){super(),this.filters=e,this.op=n,this.ae=null}static create(e,n){return new $t(e,n)}matches(e){return Gp(this)?this.filters.find(n=>!n.matches(e))===void 0:this.filters.find(n=>n.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,n)=>e.concat(n.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Gp(t){return t.op==="and"}function zp(t){return UT(t)&&Gp(t)}function UT(t){for(const e of t.filters)if(e instanceof $t)return!1;return!0}function wc(t){if(t instanceof We)return t.field.canonicalString()+t.op.toString()+Zr(t.value);if(zp(t))return t.filters.map(e=>wc(e)).join(",");{const e=t.filters.map(n=>wc(n)).join(",");return`${t.op}(${e})`}}function Kp(t,e){return t instanceof We?function(r,s){return s instanceof We&&r.op===s.op&&r.field.isEqual(s.field)&&en(r.value,s.value)}(t,e):t instanceof $t?function(r,s){return s instanceof $t&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce((i,a,c)=>i&&Kp(a,s.filters[c]),!0):!1}(t,e):void de()}function Wp(t){return t instanceof We?function(n){return`${n.field.canonicalString()} ${n.op} ${Zr(n.value)}`}(t):t instanceof $t?function(n){return n.op.toString()+" {"+n.getFilters().map(Wp).join(" ,")+"}"}(t):"Filter"}class FT extends We{constructor(e,n,r){super(e,n,r),this.key=se.fromName(r.referenceValue)}matches(e){const n=se.comparator(e.key,this.key);return this.matchesComparison(n)}}class BT extends We{constructor(e,n){super(e,"in",n),this.keys=Qp("in",n)}matches(e){return this.keys.some(n=>n.isEqual(e.key))}}class jT extends We{constructor(e,n){super(e,"not-in",n),this.keys=Qp("not-in",n)}matches(e){return!this.keys.some(n=>n.isEqual(e.key))}}function Qp(t,e){var n;return(((n=e.arrayValue)===null||n===void 0?void 0:n.values)||[]).map(r=>se.fromName(r.referenceValue))}class $T extends We{constructor(e,n){super(e,"array-contains",n)}matches(e){const n=e.data.field(this.field);return vl(n)&&oi(n.arrayValue,this.value)}}class HT extends We{constructor(e,n){super(e,"in",n)}matches(e){const n=e.data.field(this.field);return n!==null&&oi(this.value.arrayValue,n)}}class qT extends We{constructor(e,n){super(e,"not-in",n)}matches(e){if(oi(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=e.data.field(this.field);return n!==null&&!oi(this.value.arrayValue,n)}}class GT extends We{constructor(e,n){super(e,"array-contains-any",n)}matches(e){const n=e.data.field(this.field);return!(!vl(n)||!n.arrayValue.values)&&n.arrayValue.values.some(r=>oi(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YT=new qe(se.comparator);function Kn(){return YT}const em=new qe(se.comparator);function Vs(...t){let e=em;for(const n of t)e=e.insert(n.key,n);return e}function JT(t){let e=em;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function or(){return Gs()}function tm(){return Gs()}function Gs(){return new us(t=>t.toString(),(t,e)=>t.isEqual(e))}const ZT=new ct(se.comparator);function Ae(...t){let e=ZT;for(const n of t)e=e.add(n);return e}const ew=new ct(Ne);function tw(){return ew}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nm(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Po(e)?"-0":e}}function rm(t){return{integerValue:""+t}}function nw(t,e){return DT(e)?rm(e):nm(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jw{constructor(e,n){this.Br={},this.overlays={},this.kr=new gl(0),this.qr=!1,this.qr=!0,this.referenceDelegate=e(this),this.Qr=new Bw(this),this.indexManager=new Nw,this.remoteDocumentCache=function(s){return new Uw(s)}(r=>this.referenceDelegate.Kr(r)),this.serializer=new Cw(n),this.$r=new Vw(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.qr=!1,Promise.resolve()}get started(){return this.qr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let n=this.overlays[e.toKey()];return n||(n=new Mw,this.overlays[e.toKey()]=n),n}getMutationQueue(e,n){let r=this.Br[e.toKey()];return r||(r=new Lw(n,this.referenceDelegate),this.Br[e.toKey()]=r),r}getTargetCache(){return this.Qr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.$r}runTransaction(e,n,r){Z("MemoryPersistence","Starting transaction:",e);const s=new $w(this.kr.next());return this.referenceDelegate.Ur(),r(s).next(i=>this.referenceDelegate.Wr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Gr(e,n){return B.or(Object.values(this.Br).map(r=>()=>r.containsKey(e,n)))}}class $w extends OT{constructor(e){super(),this.currentSequenceNumber=e}}class Rl{constructor(e){this.persistence=e,this.zr=new bl,this.jr=null}static Hr(e){return new Rl(e)}get Jr(){if(this.jr)return this.jr;throw de()}addReference(e,n,r){return this.zr.addReference(r,n),this.Jr.delete(r.toString()),B.resolve()}removeReference(e,n,r){return this.zr.removeReference(r,n),this.Jr.add(r.toString()),B.resolve()}markPotentiallyOrphaned(e,n){return this.Jr.add(n.toString()),B.resolve()}removeTarget(e,n){this.zr.Vr(n.targetId).forEach(s=>this.Jr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,n.targetId).next(s=>{s.forEach(i=>this.Jr.add(i.toString()))}).next(()=>r.removeTargetData(e,n))}Ur(){this.jr=new Set}Wr(e){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return B.forEach(this.Jr,r=>{const s=se.fromPath(r);return this.Yr(e,s).next(i=>{i||n.removeEntry(s,ue.min())})}).next(()=>(this.jr=null,n.apply(e)))}updateLimboDocument(e,n){return this.Yr(e,n).next(r=>{r?this.Jr.delete(n.toString()):this.Jr.add(n.toString())})}Kr(e){return 0}Yr(e,n){return B.or([()=>B.resolve(this.zr.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(e,n),()=>this.persistence.Gr(e,n)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qw{constructor(){this.$i=!1,this.Ui=!1,this.Wi=100,this.Gi=function(){return Z0()?8:kT(ut())>0?6:4}()}initialize(e,n){this.zi=e,this.indexManager=n,this.$i=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.ji(e,n).next(a=>{i.result=a}).next(()=>{if(!i.result)return this.Hi(e,n,s,r).next(a=>{i.result=a})}).next(()=>{if(i.result)return;const a=new Hw;return this.Ji(e,n,a).next(c=>{if(i.result=c,this.Ui)return this.Yi(e,n,a,c.size)})}).next(()=>i.result)}Yi(e,n,r,s){return r.documentReadCount<this.Wi?(Os()<=ve.DEBUG&&Z("QueryEngine","SDK will not create cache indexes for query:",Cr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Wi,"documents"),B.resolve()):(Os()<=ve.DEBUG&&Z("QueryEngine","Query:",Cr(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Gi*s?(Os()<=ve.DEBUG&&Z("QueryEngine","The SDK decides to create cache indexes for query:",Cr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Xt(n))):B.resolve())}ji(e,n){if(pd(n))return B.resolve(null);let r=Xt(n);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Oo(n,null,"F"),r=Xt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const a=Ae(...i);return this.zi.getDocuments(e,a).next(c=>this.indexManager.getMinOffset(e,r).next(l=>{const h=this.Zi(n,c);return this.Xi(n,h,a,l.readTime)?this.ji(e,Oo(n,null,"F")):this.es(e,h,n,l)}))})))}Hi(e,n,r,s){return pd(n)||s.isEqual(ue.min())?B.resolve(null):this.zi.getDocuments(e,r).next(i=>{const a=this.Zi(n,i);return this.Xi(n,a,r,s)?B.resolve(null):(Os()<=ve.DEBUG&&Z("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Cr(n)),this.es(e,a,n,ST(s,-1)).next(c=>c))})}Zi(e,n){let r=new ct(Zp(e));return n.forEach((s,i)=>{na(e,i)&&(r=r.add(i))}),r}Xi(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Ji(e,n,r){return Os()<=ve.DEBUG&&Z("QueryEngine","Using full collection scan to execute query:",Cr(n)),this.zi.getDocumentsMatchingQuery(e,n,Gn.min(),r)}es(e,n,r,s){return this.zi.getDocumentsMatchingQuery(e,r,s).next(i=>(n.forEach(a=>{i=i.insert(a.key,a)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o1{constructor(e,n,r,s,i){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.v_=[],this.F_=new Map,this.M_=new Set,this.x_=[],this.O_=i,this.O_.io(a=>{r.enqueueAndForget(async()=>{Ei(this)&&(Z("RemoteStore","Restarting streams for network reachability change."),await async function(l){const h=Re(l);h.M_.add(4),await vi(h),h.N_.set("Unknown"),h.M_.delete(4),await aa(h)}(this))})}),this.N_=new i1(r,s)}}async function aa(t){if(Ei(t))for(const e of t.x_)await e(!0)}async function vi(t){for(const e of t.x_)await e(!1)}function wm(t,e){const n=Re(t);n.F_.has(e.targetId)||(n.F_.set(e.targetId,e),Ol(n)?Nl(n):hs(n).Xo()&&Pl(n,e))}function Cl(t,e){const n=Re(t),r=hs(n);n.F_.delete(e),r.Xo()&&Am(n,e),n.F_.size===0&&(r.Xo()?r.n_():Ei(n)&&n.N_.set("Unknown"))}function Pl(t,e){if(t.L_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(ue.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}hs(t).P_(e)}function Am(t,e){t.L_.xe(e),hs(t).I_(e)}function Nl(t){t.L_=new pw({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>t.F_.get(e)||null,tt:()=>t.datastore.serializer.databaseId}),hs(t).start(),t.N_.w_()}function Ol(t){return Ei(t)&&!hs(t).Zo()&&t.F_.size>0}function Ei(t){return Re(t).M_.size===0}function bm(t){t.L_=void 0}async function a1(t){t.N_.set("Online")}async function c1(t){t.F_.forEach((e,n)=>{Pl(t,e)})}async function l1(t,e){bm(t),Ol(t)?(t.N_.D_(e),Nl(t)):t.N_.set("Unknown")}async function u1(t,e,n){if(t.N_.set("Online"),e instanceof hm&&e.state===2&&e.cause)try{await async function(s,i){const a=i.cause;for(const c of i.targetIds)s.F_.has(c)&&(await s.remoteSyncer.rejectListen(c,a),s.F_.delete(c),s.L_.removeTarget(c))}(t,e)}catch(r){Z("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Cd(t,r)}else if(e instanceof ho?t.L_.Ke(e):e instanceof um?t.L_.He(e):t.L_.We(e),!n.isEqual(ue.min()))try{const r=await Im(t.localStore);n.compareTo(r)>=0&&await function(i,a){const c=i.L_.rt(a);return c.targetChanges.forEach((l,h)=>{if(l.resumeToken.approximateByteSize()>0){const d=i.F_.get(h);d&&i.F_.set(h,d.withResumeToken(l.resumeToken,a))}}),c.targetMismatches.forEach((l,h)=>{const d=i.F_.get(l);if(!d)return;i.F_.set(l,d.withResumeToken(It.EMPTY_BYTE_STRING,d.snapshotVersion)),Am(i,l);const m=new Mn(d.target,l,h,d.sequenceNumber);Pl(i,m)}),i.remoteSyncer.applyRemoteEvent(c)}(t,n)}catch(r){Z("RemoteStore","Failed to raise snapshot:",r),await Cd(t,r)}}async function Cd(t,e,n){if(!gi(e))throw e;t.M_.add(1),await vi(t),t.N_.set("Offline"),n||(n=()=>Im(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{Z("RemoteStore","Retrying IndexedDB access"),await n(),t.M_.delete(1),await aa(t)})}async function Pd(t,e){const n=Re(t);n.asyncQueue.verifyOperationInProgress(),Z("RemoteStore","RemoteStore received new credentials");const r=Ei(n);n.M_.add(3),await vi(n),r&&n.N_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.M_.delete(3),await aa(n)}async function h1(t,e){const n=Re(t);e?(n.M_.delete(2),await aa(n)):e||(n.M_.add(2),await vi(n),n.N_.set("Unknown"))}function hs(t){return t.B_||(t.B_=function(n,r,s){const i=Re(n);return i.f_(),new r1(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{Po:a1.bind(null,t),To:c1.bind(null,t),Ao:l1.bind(null,t),h_:u1.bind(null,t)}),t.x_.push(async e=>{e?(t.B_.t_(),Ol(t)?Nl(t):t.N_.set("Unknown")):(await t.B_.stop(),bm(t))})),t.B_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class d1{constructor(){this.K_=void 0,this.U_=[]}W_(){return this.U_.some(e=>e.G_())}}class f1{constructor(){this.queries=new us(e=>Jp(e),ta),this.onlineState="Unknown",this.z_=new Set}}async function p1(t,e){const n=Re(t);let r=3;const s=e.query;let i=n.queries.get(s);i?!i.W_()&&e.G_()&&(r=2):(i=new d1,r=e.G_()?0:1);try{switch(r){case 0:i.K_=await n.onListen(s,!0);break;case 1:i.K_=await n.onListen(s,!1);break;case 2:await n.onFirstRemoteStoreListen(s)}}catch(a){const c=Rm(a,`Initialization of query '${Cr(e.query)}' failed`);return void e.onError(c)}n.queries.set(s,i),i.U_.push(e),e.j_(n.onlineState),i.K_&&e.H_(i.K_)&&Dl(n)}async function m1(t,e){const n=Re(t),r=e.query;let s=3;const i=n.queries.get(r);if(i){const a=i.U_.indexOf(e);a>=0&&(i.U_.splice(a,1),i.U_.length===0?s=e.G_()?0:1:!i.W_()&&e.G_()&&(s=2))}switch(s){case 0:return n.queries.delete(r),n.onUnlisten(r,!0);case 1:return n.queries.delete(r),n.onUnlisten(r,!1);case 2:return n.onLastRemoteStoreUnlisten(r);default:return}}function g1(t,e){const n=Re(t);let r=!1;for(const s of e){const i=s.query,a=n.queries.get(i);if(a){for(const c of a.U_)c.H_(s)&&(r=!0);a.K_=s}}r&&Dl(n)}function _1(t,e,n){const r=Re(t),s=r.queries.get(e);if(s)for(const i of s.U_)i.onError(n);r.queries.delete(e)}function Dl(t){t.z_.forEach(e=>{e.next()})}var kc,Od;(Od=kc||(kc={})).J_="default",Od.Cache="cache";class y1{constructor(e,n,r){this.query=e,this.Y_=n,this.Z_=!1,this.X_=null,this.onlineState="Unknown",this.options=r||{}}H_(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new ts(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.Z_?this.ea(e)&&(this.Y_.next(e),n=!0):this.ta(e,this.onlineState)&&(this.na(e),n=!0),this.X_=e,n}onError(e){this.Y_.error(e)}j_(e){this.onlineState=e;let n=!1;return this.X_&&!this.Z_&&this.ta(this.X_,e)&&(this.na(this.X_),n=!0),n}ta(e,n){if(!e.fromCache||!this.G_())return!0;const r=n!=="Offline";return(!this.options.ra||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}ea(e){if(e.docChanges.length>0)return!0;const n=this.X_&&this.X_.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}na(e){e=ts.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Z_=!0,this.Y_.next(e)}G_(){return this.options.source!==kc.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sm{constructor(e){this.key=e}}class Cm{constructor(e){this.key=e}}class v1{constructor(e,n){this.query=e,this.la=n,this.ha=null,this.hasCachedResults=!1,this.current=!1,this.Pa=Ae(),this.mutatedKeys=Ae(),this.Ia=Zp(e),this.Ta=new Mr(this.Ia)}get Ea(){return this.la}da(e,n){const r=n?n.Aa:new Nd,s=n?n.Ta:this.Ta;let i=n?n.mutatedKeys:this.mutatedKeys,a=s,c=!1;const l=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,h=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((d,m)=>{const g=s.get(d),b=na(this.query,m)?m:null,P=!!g&&this.mutatedKeys.has(g.key),N=!!b&&(b.hasLocalMutations||this.mutatedKeys.has(b.key)&&b.hasCommittedMutations);let k=!1;g&&b?g.data.isEqual(b.data)?P!==N&&(r.track({type:3,doc:b}),k=!0):this.Ra(g,b)||(r.track({type:2,doc:b}),k=!0,(l&&this.Ia(b,l)>0||h&&this.Ia(b,h)<0)&&(c=!0)):!g&&b?(r.track({type:0,doc:b}),k=!0):g&&!b&&(r.track({type:1,doc:g}),k=!0,(l||h)&&(c=!0)),k&&(b?(a=a.add(b),i=N?i.add(d):i.delete(d)):(a=a.delete(d),i=i.delete(d)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const d=this.query.limitType==="F"?a.last():a.first();a=a.delete(d.key),i=i.delete(d.key),r.track({type:1,doc:d})}return{Ta:a,Aa:r,Xi:c,mutatedKeys:i}}Ra(e,n){return e.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(e,n,r,s){const i=this.Ta;this.Ta=e.Ta,this.mutatedKeys=e.mutatedKeys;const a=e.Aa.Q_();a.sort((d,m)=>function(b,P){const N=k=>{switch(k){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return de()}};return N(b)-N(P)}(d.type,m.type)||this.Ia(d.doc,m.doc)),this.Va(r),s=s!=null&&s;const c=n&&!s?this.ma():[],l=this.Pa.size===0&&this.current&&!s?1:0,h=l!==this.ha;return this.ha=l,a.length!==0||h?{snapshot:new ts(this.query,e.Ta,i,a,e.mutatedKeys,l===0,h,!1,!!r&&r.resumeToken.approximateByteSize()>0),fa:c}:{fa:c}}j_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ta:this.Ta,Aa:new Nd,mutatedKeys:this.mutatedKeys,Xi:!1},!1)):{fa:[]}}ga(e){return!this.la.has(e)&&!!this.Ta.has(e)&&!this.Ta.get(e).hasLocalMutations}Va(e){e&&(e.addedDocuments.forEach(n=>this.la=this.la.add(n)),e.modifiedDocuments.forEach(n=>{}),e.removedDocuments.forEach(n=>this.la=this.la.delete(n)),this.current=e.current)}ma(){if(!this.current)return[];const e=this.Pa;this.Pa=Ae(),this.Ta.forEach(r=>{this.ga(r.key)&&(this.Pa=this.Pa.add(r.key))});const n=[];return e.forEach(r=>{this.Pa.has(r)||n.push(new Cm(r))}),this.Pa.forEach(r=>{e.has(r)||n.push(new Sm(r))}),n}pa(e){this.la=e.hs,this.Pa=Ae();const n=this.da(e.documents);return this.applyChanges(n,!0)}ya(){return ts.fromInitialDocuments(this.query,this.Ta,this.mutatedKeys,this.ha===0,this.hasCachedResults)}}class E1{constructor(e,n,r){this.query=e,this.targetId=n,this.view=r}}class I1{constructor(e){this.key=e,this.wa=!1}}class T1{constructor(e,n,r,s,i,a){this.localStore=e,this.remoteStore=n,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.Sa={},this.ba=new us(c=>Jp(c),ta),this.Da=new Map,this.Ca=new Set,this.va=new qe(se.comparator),this.Fa=new Map,this.Ma=new bl,this.xa={},this.Oa=new Map,this.Na=es.Ln(),this.onlineState="Unknown",this.La=void 0}get isPrimaryClient(){return this.La===!0}}async function w1(t,e,n=!0){const r=Dm(t);let s;const i=r.ba.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.ya()):s=await Pm(r,e,n,!0),s}async function A1(t,e){const n=Dm(t);await Pm(n,e,!0,!1)}async function Pm(t,e,n,r){const s=await Qw(t.localStore,Xt(e)),i=s.targetId,a=n?t.sharedClientState.addLocalQueryTarget(i):"not-current";let c;return r&&(c=await b1(t,e,i,a==="current",s.resumeToken)),t.isPrimaryClient&&n&&wm(t.remoteStore,s),c}async function b1(t,e,n,r,s){t.Ba=(m,g,b)=>async function(N,k,F,M){let Q=k.view.da(F);Q.Xi&&(Q=await bd(N.localStore,k.query,!1).then(({documents:w})=>k.view.da(w,Q)));const z=M&&M.targetChanges.get(k.targetId),he=M&&M.targetMismatches.get(k.targetId)!=null,me=k.view.applyChanges(Q,N.isPrimaryClient,z,he);return Dd(N,k.targetId,me.fa),me.snapshot}(t,m,g,b);const i=await bd(t.localStore,e,!0),a=new v1(e,i.hs),c=a.da(i.documents),l=yi.createSynthesizedTargetChangeForCurrentChange(n,r&&t.onlineState!=="Offline",s),h=a.applyChanges(c,t.isPrimaryClient,l);Dd(t,n,h.fa);const d=new E1(e,n,a);return t.ba.set(e,d),t.Da.has(n)?t.Da.get(n).push(e):t.Da.set(n,[e]),h.snapshot}async function R1(t,e,n){const r=Re(t),s=r.ba.get(e),i=r.Da.get(s.targetId);if(i.length>1)return r.Da.set(s.targetId,i.filter(a=>!ta(a,e))),void r.ba.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await Oc(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),n&&Cl(r.remoteStore,s.targetId),Dc(r,s.targetId)}).catch(ml)):(Dc(r,s.targetId),await Oc(r.localStore,s.targetId,!0))}async function S1(t,e){const n=Re(t),r=n.ba.get(e),s=n.Da.get(r.targetId);n.isPrimaryClient&&s.length===1&&(n.sharedClientState.removeLocalQueryTarget(r.targetId),Cl(n.remoteStore,r.targetId))}async function Nm(t,e){const n=Re(t);try{const r=await Kw(n.localStore,e);e.targetChanges.forEach((s,i)=>{const a=n.Fa.get(i);a&&(Qe(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1),s.addedDocuments.size>0?a.wa=!0:s.modifiedDocuments.size>0?Qe(a.wa):s.removedDocuments.size>0&&(Qe(a.wa),a.wa=!1))}),await km(n,r,e)}catch(r){await ml(r)}}function kd(t,e,n){const r=Re(t);if(r.isPrimaryClient&&n===0||!r.isPrimaryClient&&n===1){const s=[];r.ba.forEach((i,a)=>{const c=a.view.j_(e);c.snapshot&&s.push(c.snapshot)}),function(a,c){const l=Re(a);l.onlineState=c;let h=!1;l.queries.forEach((d,m)=>{for(const g of m.U_)g.j_(c)&&(h=!0)}),h&&Dl(l)}(r.eventManager,e),s.length&&r.Sa.h_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function C1(t,e,n){const r=Re(t);r.sharedClientState.updateQueryState(e,"rejected",n);const s=r.Fa.get(e),i=s&&s.key;if(i){let a=new qe(se.comparator);a=a.insert(i,gt.newNoDocument(i,ue.min()));const c=Ae().add(i),l=new ia(ue.min(),new Map,new qe(Ne),a,c);await Nm(r,l),r.va=r.va.remove(i),r.Fa.delete(e),xl(r)}else await Oc(r.localStore,e,!1).then(()=>Dc(r,e,n)).catch(ml)}function Dc(t,e,n=null){t.sharedClientState.removeLocalQueryTarget(e);for(const r of t.Da.get(e))t.ba.delete(r),n&&t.Sa.ka(r,n);t.Da.delete(e),t.isPrimaryClient&&t.Ma.Vr(e).forEach(r=>{t.Ma.containsKey(r)||Om(t,r)})}function Om(t,e){t.Ca.delete(e.path.canonicalString());const n=t.va.get(e);n!==null&&(Cl(t.remoteStore,n),t.va=t.va.remove(e),t.Fa.delete(n),xl(t))}function Dd(t,e,n){for(const r of n)r instanceof Sm?(t.Ma.addReference(r.key,e),P1(t,r)):r instanceof Cm?(Z("SyncEngine","Document no longer in limbo: "+r.key),t.Ma.removeReference(r.key,e),t.Ma.containsKey(r.key)||Om(t,r.key)):de()}function P1(t,e){const n=e.key,r=n.path.canonicalString();t.va.get(n)||t.Ca.has(r)||(Z("SyncEngine","New document in limbo: "+n),t.Ca.add(r),xl(t))}function xl(t){for(;t.Ca.size>0&&t.va.size<t.maxConcurrentLimboResolutions;){const e=t.Ca.values().next().value;t.Ca.delete(e);const n=new se(je.fromString(e)),r=t.Na.next();t.Fa.set(r,new I1(n)),t.va=t.va.insert(n,r),wm(t.remoteStore,new Mn(Xt(Xp(n.path)),r,"TargetPurposeLimboResolution",gl.oe))}}async function km(t,e,n){const r=Re(t),s=[],i=[],a=[];r.ba.isEmpty()||(r.ba.forEach((c,l)=>{a.push(r.Ba(l,e,n).then(h=>{if((h||n)&&r.isPrimaryClient){const d=h&&!h.fromCache;r.sharedClientState.updateQueryState(l.targetId,d?"current":"not-current")}if(h){s.push(h);const d=Sl.Ki(l.targetId,h);i.push(d)}}))}),await Promise.all(a),r.Sa.h_(s),await async function(l,h){const d=Re(l);try{await d.persistence.runTransaction("notifyLocalViewChanges","readwrite",m=>B.forEach(h,g=>B.forEach(g.qi,b=>d.persistence.referenceDelegate.addReference(m,g.targetId,b)).next(()=>B.forEach(g.Qi,b=>d.persistence.referenceDelegate.removeReference(m,g.targetId,b)))))}catch(m){if(!gi(m))throw m;Z("LocalStore","Failed to update sequence numbers: "+m)}for(const m of h){const g=m.targetId;if(!m.fromCache){const b=d.ns.get(g),P=b.snapshotVersion,N=b.withLastLimboFreeSnapshotVersion(P);d.ns=d.ns.insert(g,N)}}}(r.localStore,i))}async function N1(t,e){const n=Re(t);if(!n.currentUser.isEqual(e)){Z("SyncEngine","User change. New user:",e.toKey());const r=await Em(n.localStore,e);n.currentUser=e,function(i,a){i.Oa.forEach(c=>{c.forEach(l=>{l.reject(new J(j.CANCELLED,a))})}),i.Oa.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await km(n,r.us)}}function O1(t,e){const n=Re(t),r=n.Fa.get(e);if(r&&r.wa)return Ae().add(r.key);{let s=Ae();const i=n.Da.get(e);if(!i)return s;for(const a of i){const c=n.ba.get(a);s=s.unionWith(c.view.Ea)}return s}}function Dm(t){const e=Re(t);return e.remoteStore.remoteSyncer.applyRemoteEvent=Nm.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=O1.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=C1.bind(null,e),e.Sa.h_=g1.bind(null,e.eventManager),e.Sa.ka=_1.bind(null,e.eventManager),e}class xd{constructor(){this.synchronizeTabs=!1}async initialize(e){this.serializer=oa(e.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(e),this.persistence=this.createPersistence(e),await this.persistence.start(),this.localStore=this.createLocalStore(e),this.gcScheduler=this.createGarbageCollectionScheduler(e,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(e,this.localStore)}createGarbageCollectionScheduler(e,n){return null}createIndexBackfillerScheduler(e,n){return null}createLocalStore(e){return zw(this.persistence,new qw,e.initialUser,this.serializer)}createPersistence(e){return new jw(Rl.Hr,this.serializer)}createSharedClientState(e){return new Yw}async terminate(){var e,n;(e=this.gcScheduler)===null||e===void 0||e.stop(),(n=this.indexBackfillerScheduler)===null||n===void 0||n.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class k1{async initialize(e,n){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>kd(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=N1.bind(null,this.syncEngine),await h1(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new f1}()}createDatastore(e){const n=oa(e.databaseInfo.databaseId),r=function(i){return new t1(i)}(e.databaseInfo);return function(i,a,c,l){return new s1(i,a,c,l)}(e.authCredentials,e.appCheckCredentials,r,n)}createRemoteStore(e){return function(r,s,i,a,c){return new o1(r,s,i,a,c)}(this.localStore,this.datastore,e.asyncQueue,n=>kd(this.syncEngine,n,0),function(){return Sd.D()?new Sd:new Jw}())}createSyncEngine(e,n){return function(s,i,a,c,l,h,d){const m=new T1(s,i,a,c,l,h);return d&&(m.La=!0),m}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,n)}async terminate(){var e;await async function(r){const s=Re(r);Z("RemoteStore","RemoteStore shutting down."),s.M_.add(5),await vi(s),s.O_.shutdown(),s.N_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D1{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.Ka(this.observer.next,e)}error(e){this.observer.error?this.Ka(this.observer.error,e):pn("Uncaught Error in snapshot listener:",e.toString())}$a(){this.muted=!0}Ka(e,n){this.muted||setTimeout(()=>{this.muted||e(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ns{constructor(e){this._byteString=e}static fromBase64String(e){try{return new ns(It.fromBase64String(e))}catch(n){throw new J(j.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new ns(It.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const K1=/^__.*__$/;function Fm(t){switch(t){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw de()}}class Ll{constructor(e,n,r,s,i,a){this.settings=e,this.databaseId=n,this.serializer=r,this.ignoreUndefinedProperties=s,i===void 0&&this.mu(),this.fieldTransforms=i||[],this.fieldMask=a||[]}get path(){return this.settings.path}get fu(){return this.settings.fu}gu(e){return new Ll(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}pu(e){var n;const r=(n=this.path)===null||n===void 0?void 0:n.child(e),s=this.gu({path:r,yu:!1});return s.wu(e),s}Su(e){var n;const r=(n=this.path)===null||n===void 0?void 0:n.child(e),s=this.gu({path:r,yu:!1});return s.mu(),s}bu(e){return this.gu({path:void 0,yu:!0})}Du(e){return Mc(e,this.settings.methodName,this.settings.Cu||!1,this.path,this.settings.vu)}contains(e){return this.fieldMask.find(n=>e.isPrefixOf(n))!==void 0||this.fieldTransforms.find(n=>e.isPrefixOf(n.field))!==void 0}mu(){if(this.path)for(let e=0;e<this.path.length;e++)this.wu(this.path.get(e))}wu(e){if(e.length===0)throw this.Du("Document fields must not be empty");if(Fm(this.fu)&&K1.test(e))throw this.Du('Document fields cannot begin and end with "__"')}}class W1{constructor(e,n,r){this.databaseId=e,this.ignoreUndefinedProperties=n,this.serializer=r||oa(e)}Fu(e,n,r,s=!1){return new Ll({fu:e,methodName:n,vu:r,path:yt.emptyPath(),yu:!1,Cu:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Q1(t){const e=t._freezeSettings(),n=oa(t._databaseId);return new W1(t._databaseId,!!e.ignoreUndefinedProperties,n)}function X1(t,e,n,r=!1){return Ul(n,t.Fu(r?4:3,e))}function Ul(t,e){if(Bm(t=Zt(t)))return J1("Unsupported field value:",e,t),Y1(t,e);if(t instanceof Um)return function(r,s){if(!Fm(s.fu))throw s.Du(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.Du(`${r._methodName}() is not currently supported inside arrays`);const i=r._toFieldTransform(s);i&&s.fieldTransforms.push(i)}(t,e),null;if(t===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),t instanceof Array){if(e.settings.yu&&e.fu!==4)throw e.Du("Nested arrays are not supported");return function(r,s){const i=[];let a=0;for(const c of r){let l=Ul(c,s.bu(a));l==null&&(l={nullValue:"NULL_VALUE"}),i.push(l),a++}return{arrayValue:{values:i}}}(t,e)}return function(r,s){if((r=Zt(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return nw(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const i=nt.fromDate(r);return{timestampValue:Pc(s.serializer,i)}}if(r instanceof nt){const i=new nt(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:Pc(s.serializer,i)}}if(r instanceof Ml)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof ns)return{bytesValue:dm(s.serializer,r._byteString)};if(r instanceof vn){const i=s.databaseId,a=r.firestore._databaseId;if(!a.isEqual(i))throw s.Du(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:fm(r.firestore._databaseId||s.databaseId,r._key.path)}}throw s.Du(`Unsupported field value: ${ca(r)}`)}(t,e)}function Y1(t,e){const n={};return $p(t)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):_i(t,(r,s)=>{const i=Ul(s,e.pu(r));i!=null&&(n[r]=i)}),{mapValue:{fields:n}}}function Bm(t){return!(typeof t!="object"||t===null||t instanceof Array||t instanceof Date||t instanceof nt||t instanceof Ml||t instanceof ns||t instanceof vn||t instanceof Um)}function J1(t,e,n){if(!Bm(n)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(n)){const r=ca(n);throw r==="an object"?e.Du(t+" a custom object"):e.Du(t+" "+r)}}const Z1=new RegExp("[~\\*/\\[\\]]");function eA(t,e,n){if(e.search(Z1)>=0)throw Mc(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,t,!1,void 0,n);try{return new Lm(...e.split("."))._internalPath}catch{throw Mc(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,t,!1,void 0,n)}}function Mc(t,e,n,r,s){const i=r&&!r.isEmpty(),a=s!==void 0;let c=`Function ${e}() called with invalid data`;n&&(c+=" (via `toFirestore()`)"),c+=". ";let l="";return(i||a)&&(l+=" (found",i&&(l+=` in field ${r}`),a&&(l+=` in document ${s}`),l+=")"),new J(j.INVALID_ARGUMENT,c+t+l)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nA(t){if(t.limitType==="L"&&t.explicitOrderBy.length===0)throw new J(j.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Bl{}class jl extends Bl{}function Lc(t,e,...n){let r=[];e instanceof Bl&&r.push(e),r=r.concat(n),function(i){const a=i.filter(l=>l instanceof Hl).length,c=i.filter(l=>l instanceof $l).length;if(a>1||a>0&&c>0)throw new J(j.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const s of r)t=s._apply(t);return t}class $l extends jl{constructor(e,n,r){super(),this._field=e,this._op=n,this._value=r,this.type="where"}static _create(e,n,r){return new $l(e,n,r)}_apply(e){const n=this._parse(e);return $m(e._query,n),new Qn(e.firestore,e.converter,bc(e._query,n))}_parse(e){const n=Q1(e.firestore);return function(i,a,c,l,h,d,m){let g;if(h.isKeyField()){if(d==="array-contains"||d==="array-contains-any")throw new J(j.INVALID_ARGUMENT,`Invalid Query. You can't perform '${d}' queries on documentId().`);if(d==="in"||d==="not-in"){Bd(m,d);const b=[];for(const P of m)b.push(Fd(l,i,P));g={arrayValue:{values:b}}}else g=Fd(l,i,m)}else d!=="in"&&d!=="not-in"&&d!=="array-contains-any"||Bd(m,d),g=X1(c,a,m,d==="in"||d==="not-in");return We.create(h,d,g)}(e._query,"where",n,e.firestore._databaseId,this._field,this._op,this._value)}}class Hl extends Bl{constructor(e,n){super(),this.type=e,this._queryConstraints=n}static _create(e,n){return new Hl(e,n)}_parse(e){const n=this._queryConstraints.map(r=>r._parse(e)).filter(r=>r.getFilters().length>0);return n.length===1?n[0]:$t.create(n,this._getOperator())}_apply(e){const n=this._parse(e);return n.getFilters().length===0?e:(function(s,i){let a=s;const c=i.getFlattenedFilters();for(const l of c)$m(a,l),a=bc(a,l)}(e._query,n),new Qn(e.firestore,e.converter,bc(e._query,n)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class ql extends jl{constructor(e,n){super(),this._field=e,this._direction=n,this.type="orderBy"}static _create(e,n){return new ql(e,n)}_apply(e){const n=function(s,i,a){if(s.startAt!==null)throw new J(j.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(s.endAt!==null)throw new J(j.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new ai(i,a)}(e._query,this._field,this._direction);return new Qn(e.firestore,e.converter,function(s,i){const a=s.explicitOrderBy.concat([i]);return new ls(s.path,s.collectionGroup,a,s.filters.slice(),s.limit,s.limitType,s.startAt,s.endAt)}(e._query,n))}}function Uc(t,e="asc"){const n=e,r=Fl("orderBy",t);return ql._create(r,n)}class Gl extends jl{constructor(e,n,r){super(),this.type=e,this._limit=n,this._limitType=r}static _create(e,n,r){return new Gl(e,n,r)}_apply(e){return new Qn(e.firestore,e.converter,Oo(e._query,this._limit,this._limitType))}}function rA(t){return $1("limit",t),Gl._create("limit",t,"F")}function Fd(t,e,n){if(typeof(n=Zt(n))=="string"){if(n==="")throw new J(j.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Yp(e)&&n.indexOf("/")!==-1)throw new J(j.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);const r=e.path.child(je.fromString(n));if(!se.isDocumentKey(r))throw new J(j.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return cd(t,new se(r))}if(n instanceof vn)return cd(t,n._key);throw new J(j.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${ca(n)}.`)}function Bd(t,e){if(!Array.isArray(t)||t.length===0)throw new J(j.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function $m(t,e){const n=function(s,i){for(const a of s)for(const c of a.getFlattenedFilters())if(i.indexOf(c.op)>=0)return c.op;return null}(t.filters,function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(n!==null)throw n===e.op?new J(j.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new J(j.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`)}class sA{convertValue(e,n="none"){switch(yr(e)){case 0:return null;case 1:return e.booleanValue;case 2:return Ke(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,n);case 5:return e.stringValue;case 6:return this.convertBytes(_r(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,n);case 10:return this.convertObject(e.mapValue,n);default:throw de()}}convertObject(e,n){return this.convertObjectMap(e.fields,n)}convertObjectMap(e,n="none"){const r={};return _i(e,(s,i)=>{r[s]=this.convertValue(i,n)}),r}convertGeoPoint(e){return new Ml(Ke(e.latitude),Ke(e.longitude))}convertArray(e,n){return(e.values||[]).map(r=>this.convertValue(r,n))}convertServerTimestamp(e,n){switch(n){case"previous":const r=yl(e);return r==null?null:this.convertValue(r,n);case"estimate":return this.convertTimestamp(si(e));default:return null}}convertTimestamp(e){const n=zn(e);return new nt(n.seconds,n.nanos)}convertDocumentKey(e,n){const r=je.fromString(e);Qe(vm(r));const s=new ii(r.get(1),r.get(3)),i=new se(r.popFirst(5));return s.isEqual(n)||pn(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${n.projectId}/${n.database}) instead.`),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{constructor(e,n){this.hasPendingWrites=e,this.fromCache=n}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class iA extends jm{constructor(e,n,r,s,i,a){super(e,n,r,s,a),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const n=new fo(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,n={}){if(this._document){const r=this._document.data.field(Fl("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,n.serverTimestamps)}}}class fo extends iA{data(e={}){return super.data(e)}}class oA{constructor(e,n,r,s){this._firestore=e,this._userDataWriter=n,this._snapshot=s,this.metadata=new Yi(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach(n=>e.push(n)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,n){this._snapshot.docs.forEach(r=>{e.call(n,new fo(this._firestore,this._userDataWriter,r.key,r,new Yi(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const n=!!e.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new J(j.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(c=>{const l=new fo(s._firestore,s._userDataWriter,c.doc.key,c.doc,new Yi(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);return c.doc,{type:"added",doc:l,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(c=>i||c.type!==3).map(c=>{const l=new fo(s._firestore,s._userDataWriter,c.doc.key,c.doc,new Yi(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);let h=-1,d=-1;return c.type!==0&&(h=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),d=a.indexOf(c.doc.key)),{type:aA(c.type),doc:l,oldIndex:h,newIndex:d}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function aA(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return de()}}class cA extends sA{constructor(e){super(),this.firestore=e}convertBytes(e){return new ns(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new vn(this.firestore,null,n)}}function Fc(t){t=xc(t,Qn);const e=xc(t.firestore,Vm),n=z1(e),r=new cA(e);return nA(t._query),F1(n,t._query).then(s=>new oA(e,r,t,s))}(function(e,n=!0){(function(s){cs=s})(as),Qr(new pr("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),c=new Vm(new vT(r.getProvider("auth-internal")),new wT(r.getProvider("app-check-internal")),function(h,d){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new J(j.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ii(h.options.projectId,d)}(a,s),a);return i=Object.assign({useFetchStreams:n},i),c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),$n(sd,"4.6.3",e),$n(sd,"4.6.3","esm2017")})();function zl(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(t);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(t,r[s])&&(n[r[s]]=t[r[s]]);return n}function Hm(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const lA=Hm,qm=new pi("auth","Firebase",Hm());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xo=new hl("@firebase/auth");function uA(t,...e){xo.logLevel<=ve.WARN&&xo.warn(`Auth (${as}): ${t}`,...e)}function po(t,...e){xo.logLevel<=ve.ERROR&&xo.error(`Auth (${as}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bc(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function hA(){return jd()==="http:"||jd()==="https:"}function jd(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dA(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(hA()||X0()||"connection"in navigator)?navigator.onLine:!0}function fA(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ii{constructor(e,n){this.shortDelay=e,this.longDelay=n,gn(n>e,"Short delay should be less than long delay!"),this.isMobile=W0()||Y0()}get(){return dA()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _A(t,e){return ds(t,"POST","/v1/accounts:delete",e)}async function Xm(t,e){return ds(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ks(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function yA(t,e=!1){const n=Zt(t),r=await n.getIdToken(e),s=Ql(r);oe(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,a=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:Ks(Qa(s.auth_time)),issuedAtTime:Ks(Qa(s.iat)),expirationTime:Ks(Qa(s.exp)),signInProvider:a||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function Qa(t){return Number(t)*1e3}function Ql(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return po("JWT malformed, contained fewer than 3 sections"),null;try{const s=Ap(n);return s?JSON.parse(s):(po("Failed to decode base64 JWT payload"),null)}catch(s){return po("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function $d(t){const e=Ql(t);return oe(e,"internal-error"),oe(typeof e.exp<"u","internal-error"),oe(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ci(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof yn&&vA(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function vA({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vo(t){var e;const n=t.auth,r=await t.getIdToken(),s=await ci(t,Xm(n,{idToken:r}));oe(s==null?void 0:s.users.length,n,"internal-error");const i=s.users[0];t._notifyReloadListener(i);const a=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?Ym(i.providerUserInfo):[],c=TA(t.providerData,a),l=t.isAnonymous,h=!(t.email&&i.passwordHash)&&!(c!=null&&c.length),d=l?h:!1,m={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:c,metadata:new jc(i.createdAt,i.lastLoginAt),isAnonymous:d};Object.assign(t,m)}async function IA(t){const e=Zt(t);await Vo(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function TA(t,e){return[...t.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Ym(t){return t.map(e=>{var{providerId:n}=e,r=zl(e,["providerId"]);return{providerId:n,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class CA{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,n){const r=i=>new Promise((a,c)=>{try{const l=e(i);a(l)}catch(l){c(l)}});r.onAbort=n,this.queue.push(r);const s=this.queue.length-1;return()=>{this.queue[s]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const n=[];try{for(const r of this.queue)await r(e),r.onAbort&&n.push(r.onAbort)}catch(r){n.reverse();for(const s of n)try{s()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:r==null?void 0:r.message})}}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function PA(t,e={}){return ds(t,"GET","/v2/passwordPolicy",la(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yl={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function DA(t){Yl=t}function xA(t){return Yl.loadJS(t)}function VA(){return Yl.gapiScript}function MA(t){return`__${t}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LA(t,e){const n=fl(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(So(i,e??{}))return s;mn(s,"already-initialized")}return n.initialize({options:e})}function UA(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(un);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function FA(t,e,n){const r=ha(t);oe(r._canInitEmulator,r,"emulator-config-failed"),oe(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!!(n!=null&&n.disableWarnings),i=ag(e),{host:a,port:c}=BA(e),l=c===null?"":`:${c}`;r.config.emulator={url:`${i}//${a}${l}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||jA()}function ag(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function BA(t){const e=ag(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Kd(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:Kd(a)}}}function Kd(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function jA(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function HA(t,e){return Wm(t,"POST","/v1/accounts:signUp",la(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zA(t,e,n=!1){const{auth:r}=t;if(an(r.app))return Promise.reject(Hn(r));const s="reauthenticate";try{const i=await ci(t,ug(r,s,e,t),n);oe(i.idToken,r,"internal-error");const a=Ql(i.idToken);oe(a,r,"internal-error");const{sub:c}=a;return oe(t.uid===c,r,"user-mismatch"),Wn._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&mn(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function KA(t,e,n=!1){if(an(t.app))return Promise.reject(Hn(t));const r="signIn",s=await ug(t,r,e),i=await Wn._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}function WA(t,e,n,r){return Zt(t).onIdTokenChanged(e,n,r)}function QA(t,e,n){return Zt(t).beforeAuthStateChanged(e,n)}const Lo="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qb="__/auth/handler",Xb="emulator/auth/handler",Yb=encodeURIComponent("fac");async function ef(t,e,n,r,s,i){oe(t.config.authDomain,t,"auth-domain-config-required"),oe(t.config.apiKey,t,"invalid-api-key");const a={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:as,eventId:s};if(e instanceof lg){e.setDefaultLanguage(t.languageCode),a.providerId=e.providerId||"",iI(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,m]of Object.entries(i||{}))a[d]=m}if(e instanceof Ti){const d=e.getScopes().filter(m=>m!=="");d.length>0&&(a.scopes=d.join(","))}t.tenantId&&(a.tid=t.tenantId);const c=a;for(const d of Object.keys(c))c[d]===void 0&&delete c[d];const l=await t._getAppCheckToken(),h=l?`#${Yb}=${encodeURIComponent(l)}`:"";return`${Jb(t)}?${mi(c).slice(1)}${h}`}function Jb({config:t}){return t.emulator?Wl(t,Xb):`https://${t.authDomain}/${Qb}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
